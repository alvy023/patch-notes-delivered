...
STAKE YOUR CLAIM WITH HOUSING EARLY ACCESS
    ...
    • Players who have purchased any edition of the Midnight expansion can join a neighborhood, purchase a house, and start customizing their new home with Housing Early Access! If you don’t have Midnight yet, don’t worry. You’ll still be able to begin adding to your Housing collection through a variety of activities and achievements, or by purchasing them from vendors throughout Azeroth. [LEARN MORE]

NEW AND RETURNING PLAYER EXPERIENCES

    • Whether you’re a new player or returning after a hiatus, we’ve got you covered. New players will discover a smoother transition to get caught up with an updated New Player Experience. Players seeking to return to Azeroth will find a guided Returning Player Experience to help you remember how to play the game and get you on the path to the next latest content in World of Warcraft. [LEARN MORE]
...
ITEMS
    ...
    • The following legacy currencies can now be losslessly shared between characters within a warband: Apexis Crystals (Warlords of Draenor), Order Resources (Legion), and Veiled Argunite (Legion).
