...
PatchNotesDelivered_Notes_Temp = {
    ...
    Take the next step in thwarting the forces of the Void; hunt down their leaders in two new areas and uncover new sources of power. Players also face a new single-boss raid in Sporefall and Turbulent Timeways returns with Dragonflight dungeons with a new slate of rewards.
...
RITUAL SITES AND VOID ASSAULTS
    ...
    • RITUAL SITES
        ...
        > Added two new achievements:
            ...
            + Pinnacle Ritual Work – Complete each Ritual Site at Tier 6 with all 8 challenges active. Reward: Title - Ritual Breaker
