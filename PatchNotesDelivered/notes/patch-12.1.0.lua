    ...
    gameChangesPatch = {
        {
            date = "2026-08-06",
            text = [=[
Continue the Midnight campaign as the Curse of Ula'tek content update opens the
way to the Coiled Isle, where venomous foes, cursed waters, and long-buried
secrets await. Take on new adventures, including the Venomous Abyss raid, Altar
of Fangs dungeon, new Delves, Season 2 challenges, housing updates, and more.

EXPLORE A NEW OUTDOOR ZONE—THE COILED ISLE

[[img:4]]

Continue the story of Zul'jan as the fog lifts from the island off the east
coast of Zul'Aman. We'll join Zul'jarra as she pursues him to bring her brother
and others home to Zul'Aman. We'll delve into a long-buried history of the
Coiled Isle, learn more about what is locked away, and who was left behind.

ENTER THE MOUNTAIN FOR NEW ADVENTURES

[[img:5]]

Undertake a variety of new activities within the mountain on the Coiled Isle as
you explore this corrupted eco-system filled with poisonous waters and venomous
foes.

Plunge into the Vaults of Atal'Utek primed for challenging group content and
rotating public events. Taking part in these public events will ultimately
build up to a boss fight.

While in the zone players will have access to a custom talent tree that will
provide different perks of player power along with quality-of-life perks.
These perks can include things such as something to reduce the potency of the
venom found around the isle as you explore.
...
Killing a rare elite unlocks Venom Fishing in that location. You'll also
discover a Local story with a tortollan sea captain named Tokka, gain
reputation with his crew, and learn to fish in more cursed waters around the
isle.
...
Introducing Lairs an evolution on world bosses located in instanced encounters
with scaling difficulty up to flexible Mythic with 15-25 players. These will
be found in specific locations similar to Delves and will come complete with a
summoning stone outside the lair.
...
This new three boss dungeon will be available up to Mythic 0 difficulty at the
launch of the content update and will join the Mythic+ rotation once Midnight
Season 2 begins a week after the launch.

DESCEND INTO THE VENOMOUS ABYSS RAID AND CONFRONT ULA'TEK

[[img:12]]

Arriving with the start of Midnight Season 2, players face Ula'tek herself in
the Venomous Abyss. An ancient powerful creature of hatred, corruption, and
venom, Ula'tek has been unleashed by Zul'jan's actions. This new raid dungeon
will feature eight new boss encounters and you'll ultimately face off against
Ula'tek as the final boss.
...
Take on three new Delves with one of these as a new Nemesis Delve. You'll step
into The Ring of Glory, Gnarldor Isle, and the Venomfall Deeps Nemesis Delve
for new rewards (and a little glory). With the start of Midnight Season 2 on
August 18, Bountiful Delves become available and players will be able to push
into the upper tiers to challenge themselves beyond Tier 7 and face the new
Nemesis boss.
...
One week after the content update goes live the new season will begin,
bringing with it a new dungeon rotation for Mythic+, a new raid, new PvP
Season, more Prey, and Bountiful Delves, and keys become available.
...
When Season 2 begins on August 18, players can begin the A Slithering Threat
questline as Nightmare Mode returns with four new serpent-themed targets and
hunts across the Coiled Isle.

In Nightmare Mode on the Coiled Isle, you'll collect Ossified Relics to
activate a Haunted Braziers around the zone to summon Ral'kala and defeat him
for unique rewards. This is meant to be something you work with other players
on.

The Season 2 Prey Journey track offers new decor, cosmetics, and mounts.
You'll also unlock the ability to collect Afflicted and Tormented Souls from
delves, which can accelerate active Nightmare Hunts and grant additional
rewards.

Lastly, The Curse of the Isle introduces a permanent Nightmare Mode that can
be toggled on to increase the danger across the Coiled Isle for players
looking for an even greater challenge!
...
introduction to Battlegrounds versus bots, we're introducing 3v3 Arenas versus
bots to players who want to dip their toes into the Arena and start learning
the ropes. To give this new feature a try, select Training Grounds from the
Player vs. Player tab in the Group Finder.

HOUSING UPDATES

MAKE THE MOST OF HOUSING WITH BLUEPRINTS

For players who want to share their cool builds with others, you'll be able to
export the entirety of your exterior and your interior, or your interior, your
exterior, or a single room alone as you like.

[[img:21]]
[[img:22]]

    • Blueprints let players save their housing creations to swap between or
      share them with other players!
    • Blueprint codes can be shared cross-region (excluding China) with other
      players for them to import as well.
    • Blueprints operate on the entire house (both inside and out), the
      interior only, the exterior only, or a single room.
    • When importing, a list of all required rooms and decor will be shown,
      including the budget needed, what's missing, and so on so players know
      what's about to happen or what they need.
    • Importing will also try to do the right thing for dyed items (using
      correctly dyed items, potentially dyeing items, but NOT replacing
      already dyed items, etc).
    • Players can have up to 50 save slots for their different layouts, as
      well as 10 additional ones for auto-saves.
    • Auto-saves are automatically created when importing a Blueprint so
      players can easily revert.
    • Players now have an additional house permission called Export that
      defaults to no one. Other players visiting a house where they pass this
      permission can choose to import into their own save slots.
    • A Reset button has also been added that will reset the whole house or
      just the interior or exterior if someone wants to start over from
      scratch.
...
Let your pets roam free in your home by adding a Pet Bed decor item which will
let you place your noncombat companion pet inside the house. Your pet will
also be able to wander through your home through some new navigation
technology allowing them to make their way around your decor.

[[img:23]]
[[img:24]]

    • Pet Beds allow players to show off their pets both in and outside their
      house.
    • Players can place up to 100 beds inside and up to 25 beds outside. Once
      a bed is placed, players can select a pet to make its home there.
    • Indoor pets can be set to either Stationary or Roaming while pets
      placed outdoors are only Stationary for the time being.
    • A small number of pets are unavailable to be placed for a variety of
      reasons.
...
Griftah and his travelling troupe of traders would like to visit the
neighborhood to trade their traditional Amani goods. It's fairly obvious that
these are not original Amani items, however the neighborhood residents are
...
Strange wax deposits have started to appear in the neighborhood. Who better to
find a use than the Kobolds of the Ringing Deeps? Seek their counsel on
illumination.
...
Residents of the neighborhood love their pets, but they could use some help
training them. The centaurs of the Ohn'ahran Plains have very strong bonds
with their bakar and they may be willing to pass on some training tips.

[[img:28]]

Tortollans: Vacation Season

The Tortollans are a worldly folk. So worldly, in fact, that they need no
introduction to your neighborhood--they've been vacationing here long before
you put down your roots! Share in their recreational wisdom.

Players may also notice new things in their Neighborhood based on the
Endeavors that have been completed, both old and new.

ADDITIONAL HOUSING UPDATES

    • HOUSES
      > Houses can now reach level 12, unlocking increased limits, large
        exteriors, and more.
      > New Artisanal Rooms can now be purchased from the General Contractor
        NPCs in each neighborhood. Four new rooms each for the orc, human,
        night elf, and blood elf styles are available for Community Coupons.
        Cross-faction room styles will need to be purchased from the
        neighborhood smugglers.
      > Additional new housing items available in neighborhoods for
        Community Coupons.
    • DYES
      > Dye crafting has been streamlined, considerably freeing up bag space
        taken up by dyes.
      > New dye colors have been added, including those that replicate the
        darker appearances from before the 12.0.5 content update.
    • UI
...
With the new updates, the Cooldown Manager will now be able to track trinkets
and potions, helping with consumable management. It can also track racial
ability cooldowns and durations.

[[img:29]]
[[img:30]]

For managing other resources, more updates arrive to the ping system. Players
can ping their action bar or the Cooldown Manager directly providing your
team with the status of your spells.

[[img:31]]

Your own unit frames can also get pinged to convey the status of your health
to the group and players who are acting in a healing role will also share the
status of their mana saving them from needing to say, OOM before the next
pull.

[[img:32]]

Healers can now configure or hide the buffs shown on Raid Frames, so the
healing effects that matter most to you stay visible.
...
Speak with your guildmates both in and out of the game by connecting your
Battle.net and Discord accounts to chat with your guild no matter where they
are. Whether you're coordinating your next raid run, looking for more to join
you in game for PvP, or just hanging out in your neighborhoods together,
you'll be able to send messages between the two quickly and easily.

CONTINUE THE HUNT FOR XAL'ATATH WITH ARATOR

[[img:35]]

After the start of Season 2, join Arator once more as he deals with the
fallout from the Voidspire and also investigate the resurgence of the
Twilight's Blade with him as we continue the hunt for Xal'atath.

CHARACTERS

    • EARTHEN
      > Developers' note: In Curse of Ula'tek, we are revisiting the amount
        of experience points gained when exploring zones. This will
        particularly impact the leveling speed for Earthen characters, who
        receive significantly more exploration experience via their
        Wide-Eyed Wonder racial ability. To compensate for the decrease in
        experience gains from exploring zones, we are increasing the
        benefits of Ingest Minerals for Earthen.
      > Baseline experience gained from exploring zones reduced by 60%.
      > Experience gained from exploring low-level zones is no longer
        reduced from baseline.
      > Effectiveness of Well Fed gained from Ingest Minerals increased by
        30%.

EVENTS

    • RITUAL SITES
      > Ritual Site tiers 1-6 vault rewards have been updated to match the
        Season 2 Delve tiers 1-6 vault rewards.
      > Ritual Sites now reward Season 2 crests equivalent to Delves at
        these tiers.
      ...
      > New recommended item levels for tiers 4-6:
        ...
        + Tier 5 – 268 (was 264)
        + Tier 6 – 275 (was 274)
      > The Tier 6 Advanced Ritual Studies quests will no longer offer a
        Nebulous Voidcore bonus roll reward. The quests remain available to
        complete for the relevant achievement.
    • VOID ASSAULTS
      > Void Strikes, Void Incursions, and the Weekly Quest will now give
        Season 2 Adventurer crests.
    • VOID-TOUCHED CACHES
      > New Season 2 Adventurer Warbound caches available for 200 Field
        Accolades.
      > New Season 2 Veteran Bind-on-Pickup caches available for 500 Field
        Accolades for a random slot, and 750 Field Accolades for a slot
        specific item.
      > The Season 1 gear caches have been removed.
    • VAL AND NAIGTAL
      > World Quests, Rares, and Elites will now grant Season 2 Adventurer
        crests in both Normal and Heroic World Tiers.
      > Rare equipment drops will remain Warbound Until Equipped and will
        now drop at Season 2 Adventurer 1/6 (Normal) and Adventurer 4/6
        (Heroic).
      > The World Boss and Weekly Quests will offer Season 2 Adventurer
        crests in Normal World Tier and Season 2 Veteran crests in Heroic
        World Tier.
      > The World Boss drops will remain as Season 1 drops and can no
        longer be upgraded.
      > The Mythic quest rewards from Knocking off the Top (Heroic) will
        also remain as Season 1 rewards and can no longer be upgraded.

ITEMS

    • Class set vendor Kirana has relocated from near the March on
      Quel'danas raid entrance to near the Catalyst in Silvermoon and has
      expanded her stock to include Midnight Season 2 class set armor in
      exchange for Slumbering Coil Curios.
    • THE CATALYST
      > Class set armor now inherits the secondary and tertiary stats as
        well as certain special cantrip effects of items when converted
        with the Catalyst.
    • RAID REWARDS
      > Raid Finder, Normal, and Heroic raid Great Vault rewards are now
        awarded at the first step of the next harder difficulty's upgrade
        track; for example, all Heroic raid vault rewards will be Myth 1/6.
      > Mythic raid Great Vault rewards are now awarded at Myth 6/6 apart
        from Very Rare items and loot from the penultimate and final
        bosses.
      > Mythic raid Very Rare items and loot from the penultimate and final
        bosses will be acquired at the equivalent of Myth 9 regardless of
        whether acquired directly from a boss drop or the Great Vault.
    • NEBULOUS VOIDCORES
      > Nebulous Voidcores acquired in Season 1 will be converted to gold
        upon the end of Season 1, and they may no longer be used in Season
        1 content.
      > Nebulous Voidcores will be available as a Great Vault reward from
        the start of Season 2.
      > The cost to roll for a raid item is reduced to 1 Nebulous Voidcores
        (was 2).
      > As in Season 1, items acquired using Nebulous Voidcores will
        continue to be equivalent to a Great Vault reward in terms of item
        level.
      > Orin Straylight has begun learning the basics of weaving Nebulous
        Voidcores from void energy and has relocated near the Catalyst in
        Silvermoon. He will be able to provide one additional Nebulous
        Voidcore per week starting the eighth week of Season 2.
    • Ranged weapons (bows, crossbows, and guns) can now use a variety of
      illusions in transmog.
    • Adjusted delve Coffer Key Shard amounts from multiple sources.
      > Developers' notes: We have tuned Coffer Key Shard acquisition to
        reflect the addition of more sources with the Curse of Ula'tek
        update. Our goal is to reward players who choose to spend their
        time engaging with new content in the Coiled Isles, while still
        providing players the ability to earn Coffer Key Shards from all
        sorts of outdoor features throughout Midnight. These adjustments
        are still ongoing and are a work in progress.
    • New wild pets to collect on the Coiled Isle.
    • Added Pet Battler achievements for Outland and Cataclysm.
    • Substantially reduced the Anguish costs for housing items purchased
      from Prey vendors for Season 1 and Season 2.

PLAYER VERSUS PLAYER

    • Players will no longer be affected by knockback effects while under
      the effects of Fear and Disorient crowd control.
    • Gladiator's Distinction (PvP Trinket Set Bonus) now increases primary
      stat by 15% (was 12%) and Stamina by 5% (was 10%) for tank and damage
      dealer roles.
    • Gladiator's Distinction (PvP Trinket Set Bonus) now increases Stamina
      by 10% (was 15%) for the healer role.
    • BATTLEGROUNDS
      > Developers' notes: We've observed player survivability in
        battlegrounds making combat less enjoyable, so we're making a
        change to reduce healing received which should allow for healers
        and off-healing abilities to be less powerful.
      > Players will now receive 20% less healing in Battlegrounds.
    • SOLO SHUFFLE AND BATTLEGROUND BLITZ
      > To reduce win trading and queue manipulation, now when a player
        misses a Solo Shuffle or Battleground Blitz queue, a 1-minute
        debuff prevents further queueing. The debuff stacks for consecutive
        missed queues within a window of time and is account-wide.
    • Spoils of War will grant 50% increased Conquest once Conquest has
      been uncapped for the season (was 30%).
      > Developers' notes: We would like to speed up gearing for players
        who are participating late in the PvP season, so we are increasing
        Conquest gains from Spoils of War.
    • Developers' notes: In Curse of Ula'tek, we've decided to reduce the
      effectiveness of a large number of movement speed reductions in PvP.
      We have found in the past that when players have access to strong
      snares with a high uptime, there are less opportunities for enemies
      to use positioning and escape tactics. Our primary target has been
      strong snares that are auto applied during normal combat rotations,
      with some of the activated reductions retaining their strength. In
      general, we've reduced movement speed reductions a tier down, with
      70% reduced to 50%, 50% to 30%, and so on.

QUESTS

    • Explore new stories in the Arcantina.
    • The Omnium Folio introduction questline can now be skipped across
      characters on the account once it has been completed by at least one
      character.
...
USER INTERFACE AND ACCESSIBILITY
    ...
    • In Group Finder, the refresh button no longer overlaps with the
      filter reset button.
    • Added a Back button to the Achievements pane.
    • The World Map can now show map coordinates of the player and the
      cursor. Settings can be found under Gameplay > Interface.
    • Shift-clicking a map pin now also copies a slash command to your
      clipboard. The slash command (/mappin) can be shared outside the game
      and entered in chat to create the pin and open your map to it.
    • The Friends List has been updated with World of Warcraft Friends,
      Recent Allies, additional filtering options, and improved social
      management tools.
    • COOLDOWN MANAGER
      > Now tracks trinkets, potions, and racial ability cooldowns and
        durations.
      > Buff and debuff icons displayed on raid and party frames can now
        have independent sizes and border scales.
      > Healers can now assign visual alerts to specific group buff spells
        through the Group Buff Filter UI.
      > Added a new category of Short sounds to use for Cooldown Manager.
      > Sounds from the Cooldown Manager are now available to be used for
        the Combat Audio Assist accessibility feature.
    • PING SYSTEM
      > Added the ability to ping the action bar and spells on the
        Cooldown Manager.
      > Added the ability to ping certain items.
      > Added the ability to ping player resources (such as health bars or
        health and mana bars for healers), displaying the information as a
        chat bubble.
      > Ping icons will now show on certain unit frames (target, focus, and
        raid) when that unit is pinged.
      > Ping System now has a new option to target the environment only,
        units only, or both.
      > Updated ping macros to support pinging spells or items. Added the
        following slash commands: /pingspell:1234 (or spell name) and
        /pingitem:1234 (or item name)
      > Adding the ability to use the [@cursor] target for ping macros.
        Using this will have the ping ignore all UI and units, and
        explicitly attempt to ping the environment wherever the cursor
        currently is.
      > Trinkets, health potions, combat potions, and healthstones can now
        be pinged on the Cooldown Manager.
    • NAMEPLATES
      > New options added in Friendly Nameplates settings to show only the
        name, use class color for names, and hide realm name.
      > For the Enemy Player Buffs/Debuffs nameplates option, Big Debuff is
        now enabled by default.
    • EDIT MODE
      > Raid Warnings can now be moved.
      > Raid and party frames now support the Frame Size setting that has
        been available for other unit frames. These frames can now be
        scaled up by 100%.
      > The Loss of Control display can now be moved.
    • ADDONS
      > Added new APIs that allow addons to display filtered sets of auras
        in customized ways, without exposing the underlying aura
        information that could be used for automation.
      > New UI texture filenames will no longer be published to the
        ManifestInterfaceData DB. Existing filenames will remain available,
        and this change will not affect players. Addons will still be able
        to use these textures.

WORLD

    • The Amani Pass between Eversong Woods and Zul'Aman should no longer
      dismount players that pass through it.
    • Fixed several creature spawns across the entire game that could
      cause players to get stuck in combat.
            ]=],
        images = {
    ...
    • Arcane
        ...
        > New Apex Talent: Prismatic Bolt
            + Rank 1: Arcane Barrage has a 1% chance per Arcane Salvo stack consumed to
              ...
              damage to nearby enemies. Damage reduced beyond 5 targets. Generates 4 Arcane
...
• Developers' notes: Rend is an iconic and core Warrior ability with a different
    ...
    • Fury
        ...
        > Bloodbath initial damaged reduced by 12% and bleed damage increased by 300%.
            + Developers' notes: The intent behind Bloodbath is that the majority of the damage
