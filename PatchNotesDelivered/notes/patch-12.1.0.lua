...
• Developers' notes: Frost Death Knight has performed under our expectations at
    ...
    • Resolved an issue causing Army of the Dead Epidemic Orders to cast from the
      Death Knight instead of the Lesser Ghoul.
    • Blood
        > Developers' notes: San'layn is dealing quite a bit more damage in AoE than
          our intended target for tanks. We will be reducing their overall damage to
          reduce the disparity. However, we will be increasing Death Strike's damage
          and reducing its cleave effectiveness to buff Blood's single target which is
          a little on the lower end of tanks. In addition, we are making some
          Deathbringer specific targeted buffs to counter the overall aura nerf and be
          a small net positive buff to both their AoE and single target damage.
        > All ability and minion damage reduced by 6%.
        > Death Strike damage increased by 15%.
        > Deadly Reach now causes Death Strike now to deal 60% of its damage to 2
          nearby enemies (was 75%).
        ...
        > Resolved an issue causing Grip of the Dead from Death and Decay to
          permanently be active on targets.
        > Deathbringer: Resolved an issue causing Echoing Fury to grant Exterminate
          stacks on Reaper's Mark casts.
        > San'layn: Visceral Strength now grants 6% strength (was 10%).
        > San'layn: Transfusion increases Dancing Rune Weapon damage by 5% (was 10%).
            + Developers' notes: The tooltip will be updated at a later date to
    ...
    • Frost
        ...
        > Venomous Abyss 2-piece set bonus updated - Now grants 1% attack speed per
          stack (was 2%), and now increases Icy Death Torrent damage by 2% per
          stack (was 4%).
    • Unholy
        > Developers' notes: We're looking to increase Unholy Death Knight's damage
    ...
    • Player versus Player
        > Unholy
            + San'layn
                - Developers' notes: We would like to push for the San'layn hero
                  talent tree to be a more viable option for Unholy Death Knights
                  in PvP.
                - Inevitable now causes plagues to deal up to 60% increased damage
                  based on the target's missing health (was 30%) in PvP combat.
                - Vampiric Strike damage increased by 100% in PvP combat.
...
• Fixed an issue that allowed Blur's recent PvP adjustments to affect PvE
    ...
    • Devourer
        ...
        > Venomous Abyss 4-piece set bonus updated - Now generates 2 soul fragments
          (was 8 soul fragments) and increases Reap damage by 10% (was 20%).
    • Havoc
        > Aldrachi Reaver
            + Developers' notes: Aldrachi Reaver has fallen well behind the alternative
              hero talent options for both specs it is available to. We are
              improving some of its core effects for both specs, and for Havoc
              specifically the soul fragment generation from Broken Spirit is
              increasing to give a small boost to Fury generation and hasten the
              cycle of Reaver's Glaive and its bonuses.
            + Art of the Glaive now increases the damage of enhanced strikes by 15%
    ...
    • Vengeance
        > Aldrachi Reaver
            + Developers' notes: Aldrachi Reaver has fallen well behind the alternative
              hero talent options for both specs it is available to. We are
              improving some of its core effects for both specs.
            + Art of the Glaive now increases the damage of enhanced strikes by 15%
              (was 10%) and 30% (was 20%).
            + Reaver's Glaive damage increased by 25%.
            + Reaver's Mark now increases your damage to the target by 8% (was 7%).
    ...
    • Player versus Player
        ...
        > Devourer
            ...
            + Blur now reduces damage taken by 15% in PvP combat (was 25%).
            + Armor of Souls now increases Armor by 65% (was 100%).
            + Developers' notes: Devourer Demon Hunters are both very threatening and
              very defensible during Void Metamorphosis and Surrender to the Void has
              provided the opportunity to increase the duration of those windows too
              significantly, so its Fury generation effect is being reduced.
            + Surrender to the Void now increases Fury generated by 60% (was 100%).
        > Havoc
            + Blur now reduces damage taken by 15% in PvP combat (was 25%).
            + Desperate Instincts now reduces damage taken by 5% while below 35% health
...
• Shred damage increased by 10%.
    ...
    • Feral
        > Wildstalker
            + Patient Custodian increases bleed damage by 10% (was 8%). Does not apply to
              PvP combat.
        ...
        > Developers' notes: Feral is performing below expectations, particularly in raid
          encounters, so we're providing both an overall lift as well as some specific
          buffs to single-target abilities.
        > All ability damage increased by 5%. Does not apply to PvP combat.
        > Auto-attack damage increased by 10%.
        > Ferocious Bite damage increased by 10%.
    • Guardian
        > Fixed an issue where Wild Guardian was incorrectly increasing Thrash and Mangle
          damage regardless of whether Rank 3 was selected.
    • Restoration
        > All healing increased by 4%. Does not apply to PvP combat.
        > Fixed an issue where Photosynthesis could trigger from other players' heal over
          time effects.
        > All healing increased by 4%.
        > Fixed an issue where Grove Guardians were not prioritizing healing the target of
          your Swiftmend or Wild Growth.
        ...
        > Developers' notes: These changes are intended to address Rejuvenation and Wild
          ...
          the power of the 4-piece class set to make sure it's an impactful and
          noticeable set bonus. These changes are accompanied by slight nerfs to their
          raid healing to keep them around the same power in raid while increasing
    ...
    • Player versus Player
        ...
        > Feral
            ...
            + Developers' notes: We're increasing Feral's general damage, especially for
              Druid of the Claw, and nudging down their defensiveness to speed up the
              pace of combat for Feral.
            + Ravage (Druid of the Claw) damage increased by 15% in PvP combat.
            + Survival Instincts reduces damage taken by 40% in PvP combat (was 50%).
        ...
        > Restoration
            ...
            + Developers' notes: We're increasing Restoration's overall healing while at the
              same time reducing the power of Swiftmend and some of their mana
              regeneration talents. The goal is to better balance Restoration's healing kit
              to not be so reliant on Swiftmend to top up allies.
    ...
    evokerChangesPatch = [=[
• Fixed an issue preventing Unravel from activating when Fire Breath was cast with Tip
      the Scales.
    • Fixed an issue where Unravel may not hit all targets struck by Fire Breath.
    ...
    • Augmentation
        > Developers' notes: We're making some targeted adjustments to parts of
          Augmentation's kit that have lower representation in their breakdown than they
          should be relative to their intended strength or time spent performing them.
        > Eruption damage increased by 15%.
        > Fire Breath damage increased by 60%.
        > Upheaval damage increased by 40%.
        > Blistering Scales damage increased by 100%.
    ...
    • Preservation
        > Fixed an issue where Emerald Communion would loop its visual even after the
          effect had ended.
        > Developers' notes: We're further increasing some of the Preservation triage heals
          to help them keep up with other healers in dungeons.
        > Verdant Embrace healing increased by 25%. Does not apply to PvP combat.
        > Living Flame healing increased by 20%. Does not apply to PvP combat.
        > Dream Simulacrum increases healing of Verdant Embrace by 40% (was 30%).
    • Player versus Player
        ...
        > Augmentation
            + Ebon Might grants 12% primary stat in PvP combat (was 10%).
            + Developers' notes: Augmentation has been underplayed in PvP, especially arenas,
              for some time. We're increasing both their damage support capabilities and
              their personal damage to increase their viability.
            + Damage increased by 10% in PvP combat.
            + Ebon Might grants 10% primary stat in PvP combat (was 8%).
            + Inferno's Blessing damage increased by 25% in PvP combat.
        > Devastation
            + Developers' notes: The Devastation Flameshaper build is not being utilized much
              compared to Scalecommander. We're increasing the power of some Flameshaper
              focused spells to open up more options for them.
            + Disintegrate triggers Consume Flame at 200% effectiveness in PvP combat
              (was 150%).
            + Enkindle damage increased to 30% in PvP combat (was 20%).
            + Expanded Lungs increases damage of Fire Breath's periodic by 40% in PvP
        ...
        > Preservation
            + Flameshaper
                - Consume Flame healing reduced by 30% in PvP combat.
            + Fixed an issue where Stasis could be used in the starting room of
              arenas and battlegrounds to store spells for after the gates opened.
            + Mana regeneration is now reduced by 35% in PvP combat (was 30%).
    ]=],
    hunterChangesPatch = [=[
• Reduced the size of several Hydra creatures after they have been tamed.
    • Marksmanship
        ...
        > Corrected an issue where Rapid Fire fired fewer shots than intended when
          hitting a second target with the Aspect of the Hydra talent.
    • Survival
        > Developers' notes: We're increasing the damage that Wildfire Bomb deals to
          all targets, but reducing the bonus damage to the primary target. This should
          be a neutral change against a single target, but an increase to area damage
        ...
        > Corrected an issue where the initial damage of Wildfire Bomb would not happen
          ...
          the target.
        > Corrected an issue where Strike As One would not deal damage with a Raptor
          Swipe that benefit from Tip of the Spear if Aspect of the Eagle is
          active.
        > All damage dealt by you and your pet increased by 7%. This increase is
          only 3% while engaged in PvP combat.
        > All damage dealt by you and your pets increased by 4%.
    • Beast Mastery
        > All damage dealt by you and your pets increased by 7%.
        > Resolved an issue causing Wild Thrash to not take target bounding radius
          into account.
        > Developers' notes: We're looking to increase Beast Mastery area damage and
          cleave capabilities.
        > Wild Thrash now deals 300% increased damage when striking more than 2
        ...
        > Beast Cleave now causes your pets to strike nearby enemies for 70% of the
          damage dealt (was 55%).
        > Developers' notes: The new Venomous Abyss tier set bonus isn't quite as
          strong as we would like it to be, so we're increasing the effects of the
          4-piece set bonus.
    ...
    • Player versus Player
        > Beast Mastery
            + Dark Ranger
                - Developers' notes: Dark Ranger has been underperforming for Beast
                  Mastery, so we're adjusting their Black Arrow damage to increase their
                  performance.
                - Black Arrow damage increased by 30% in PvP combat.
            + Developers' notes: Beast Mastery's damage during burst windows is higher
              than we'd like in PvP, reducing some of the abilities that can contribute
    ...
    mageChangesPatch = [=[
• Developers' notes: For both Fire and Frost, these changes are intended to primarily
      improve performance in M+, with a smaller impact in raids.
    • Hero Talents
        > Spellslinger
            + Fixed an issue causing Splinters from Augury Abounds to sometimes strike
              crowd-controlled targets when other non-crowd controlled targets are
              available.
    • Arcane
        > Developers' notes: The Venomous Abyss set bonus is overperforming our target
          ...
          would be a greater impact than intended to Arcane's overall damage, so we
          are also making a small positive adjustment to Arcane's baseline.
        > All ability damage increased by 3%.
    ...
    • Fire
        ...
        > Resolved an issue where the 2-piece set bonus: Flamestrike did not correctly
          always grant Hot Streak when it is a guaranteed critical strike due to
          Pyroclasm.
    • Frost
        > Frozen Orb damage increased by 15%.
        > Comet Storm damage increased by 50%. Does not apply to PvP combat.
        ...
        > Developers' notes: We're primarily focused on Frost's performance in Mythic
          ...
          Barrier had a greater effect on Frost's overall survivability than intended.
          We like the symmetry of the three Improved Barrier talents having one
          additional effect, and Frost has historically had a slightly larger absorb
          than Arcane and Fire, so we're baking it into the baseline absorb amount
          rather than re-attaching it to Improved Ice Barrier. We're also making some
          targeted increases to Frost's area of effect damage.
    ...
    • Player versus Player
        > Developers' notes: Mages have been extending the duration of PvP matches with
          frequent access to strong defensive abilities, so we're reducing the
          effectiveness of their barriers and the cooldown of Ice Block. Fire damage is
          also being reduced to bring them in line with other specializations.
        > Improved Conjuration reduces the cooldown of Mirror Image by 15 sec in
          PvP combat.
        ...
        > Fire
            ...
            + Burnout now explodes for 50% of remaining Ignite damage in PvP combat
              (was 75%).
            + Pyroclasm now increases the damage of Pyroblast and Flamestrike by 180% in
              PvP combat (was 230%).
            ...
            + Developers' notes: Fire Mage's Venomous Abyss tier set bonus is particularly
              ...
              with the objective of increasing its usability. We're also decreasing
              Meteor's damage to reduce Fire Mage's burst capabilities.
            + Pyroblast damage increased by 10% in PvP combat.
            + Meteor damage decreased by 20% in PvP combat.
            + Comet Storm damage decreased by 20% in PvP combat.
...
• Brewmaster
    ...
    • Mistweaver
        ...
        > All healing done increased by 5%.
        > The Venomous Abyss 4-piece set bonus chance to activate has been increased to
          25% (was 20%).
...
• Holy
    ...
    • Protection
        ...
        > Fixed an issue where Glory of the Vanguard was not dealing full damage to
          its primary target.
        > Fixed an issue that caused Glory of the Vanguard to sometimes fail to deal
          damage to distant targets.
    ...
    • Retribution
        > Templar
            + Developers' notes: Templar has been underperforming compared to Herald of
              ...
              viable option against Herald of the Sun, for those who enjoy Templar's
              playstyle.
            + Hammer of Light damage increased by 50%. Does not apply to PvP combat.
            + Empyrean Hammer damage increased by 12%.
        > Developers' notes: We're increasing the damage of the Curse of Ula'tek
          4-piece set bonus Divine Arbiter significantly, to make sure its rotational
          ask is worth executing.
        > Class Set 4-piece Divine Arbiter main target damage increased by 150%.
        > Class Set 4-piece Divine Arbiter secondary target damage increased by 75%.
        > Fixed an issue where Paladins talented into Radiant Glory would not have
          Avenging Wrath be applied after casting Wake of Ashes while silenced.
    ...
    • Player versus Player
        > Holy
            ...
            + All healing reduced by 4% in PvP combat.
            + Developers' notes: Holy Paladin's throughput has been higher than we would
            ...
            + All healing decreased by 5% in PvP combat.
            + Judgment damage decreased by 30% in PvP combat.
            + Avenging Crusader now transfers 80% of damage done into healing in PvP
              combat (was 55%).
        > Protection
            + Developers' note: Protection Paladins have been extending the duration of
              the matches that they participate in with frequent access to group utility.
              We're reducing the effectiveness of Blessing of Sacrifice and Guardian of
              the Forgotten Queen to bring them in line.
            + Guardian of the Forgotten Queen duration reduced to 6 seconds.
            + Guardian of the Forgotten Queen cooldown increased to 4 minutes.
            + Guardian of the Forgotten Queen now has a 6 second internal cooldown.
            + Sacrifice of the Just reduces the cooldown of Blessing of Sacrifice by 30
        ...
        > Retribution
            + Templar
                - Developers' notes: We're bringing Templar's performance up also in PvP,
                  but we believe the gap to Herald of the Sun is less drastic compared
                  to PvE.
                - Hammer of Light damage increased by 20%.
            + Developers' notes: Retribution's personal durability has been higher than
              we would like considering their complete team defensive package, and
              Templar's damage has not been competitive with Herald of the Sun, so we're
              increasing some sources specific to its hero tree.
            + Shield of Vengeance absorption reduced by 25% in PvP combat.
            + Divine Protection now reduces damage taken by 20% in PvP combat (was 25%).
            + Templar: Seal of the Templar now increases the damage of Templar's Verdict
              by 35% (was 25%).
            ...
            + Developers' notes: Retribution had been contributing to longer PvP matches
              during Season 1 due to their frequent access to team utility. We're
              shifting some of that effectiveness into more consistent offensive power,
              and additionally giving Templar an increase to Hammer of Light damage so
              they are a solid offensive alternative to Herald of the Sun.
            + All damage increased by 8% in PvP combat.
            + Final Verdict damage increased by 15% in PvP combat.
            + Hammer of Light damage increased by 25% in PvP combat.
...
• Fixed an issue where Flash Heal could not be tracked on the Cooldown Manager
    ...
    • Discipline
        > Developers' notes: Discipline isn't able to dish out proper healing in
          dungeon environments due to how strong Atonement is in raids. We're
          reintroducing an Atonement healing bonus outside of raid environments and
          significantly increasing Atonement healing outside raid to help Discipline
          shine in dungeons.
        > Atonement healing is increased by 40% when not in a raid or battleground
          instance.
        > Penance mana cost reduced by 20%.
        > Developers' notes: We're reducing Discipline's damage done and offsetting
          ...
          increasing the damage of Entropic Rift to minimize the impact this will
          have on Voidweaver's dungeon viability and help maintain high damage as one
          of its strengths.
        > All damage reduced by 30%. Does not affect PvP combat.
        > Oracle: Entropic Rift damage increased by 20%.
        > Oracle: Atonement now transfers 46% of damage into healing (was 32%). Does
    ...
    • Holy
        ...
        > Fixed an issue where casting Benediction and queuing a Holy Word would
          consume the proc.
        > Developers' notes: We're increasing the healing throughput of Oracle so
          that it can serve as a competitive option against Archon. Furthermore, we
          are increasing the mana regeneration of Enlightenment to further help Holy
        ...
        > Preventive Measures now increases Prayer of Mending healing by 40% (was
          15%). Does not affect PvP combat.
    ...
    • Shadow
        ...
        > Shadeburst damage reduced by 5%. Does not apply to PvP combat.
    • Player versus Player
        > Developers' notes: We're increasing the effectiveness of Mindgames once
          more in this pass to solidify its usability. We'd like for it to be able
          to compete with other powerful PvP talent options in Priest's kit.
        > Mindgames direct damage and reversal increased by 50%.
        > Holy
            + Archon
                - Developers' notes: We feel Oracle Holy is in a good place, but Archon
                  has difficulties keeping up, so we're targeting buffs to its throughout and
                  offensive potential.
                - Halo damage and healing increased by 30% in PvP combat.
        ...
        > Shadow
            ...
            + Shadow Word: Death damage increased by 30% in PvP combat.
        > Developers' notes: Mindgames has fallen behind other spells and has been
          an underutilized talent for some time, so we're increasing its viability to
          offer all Priest specializations more PvP talent options.
        > Mindgames direct damage increased by 150%.
        > Mindgames healing and damage reversal increased by 150%.
        > Discipline
        ...
        > Holy
            + Developers' notes: Holy Priest is vastly overperforming due to a mixture
              ...
              specific healing increases to Prayer of Mending and Holy Word: Serenity.
              We're reducing these PvP increases to Prayer of Mending, Holy Word:
              Serenity, and Prompt Prognosis which are all powerful instant cast spells.
            + Enlightenment regenerates mana 10% faster in PvP combat (was 25%).
            + Prayer of Mending healing reduced by 25% in PvP combat.
            + Holy Word: Serenity healing reduced by 15% in PvP combat.
            + Oracle: Prompt Prognosis healing reduced by 25% in PvP combat.
    ...
    • Player versus Player
        > Assassination
            ...
            + Developers' notes: Burst from Assassination's Apex Talent is exceeding
              ...
              Fatebound Coins is higher than intended and is being reduced.
            + Kingsbane initial damage reduced by 12% in PvP combat.
            + Implacable (Rank 3) Physical and Nature damage reduced by 15% in
              PvP combat.
            + Fatebound: Fatebound Coin (Tails) damage reduced by 10% in PvP combat.
        > Outlaw
            + All damage increased by 5% in PvP combat.
            ...
            + Dispatch damage increased by 20% in PvP combat.
            + Between the Eyes damage increased by 12% in PvP combat.
        > Developers' notes: Rogues' defensive potential improves in coordinated
          play and as ratings increase, with the predictive effect of Preemptive
          Maneuver standing out as being too rewarding, so it's being brought down
        ...
        > Subtlety
            + Developers' notes: Subtlety's steady damage pressure is low, without
              which it can be difficult to create windows that capitalize on their burst
              potential. We're increasing Eviscerate damage moderately and Goremaw's
              Bite bleed damage significantly to increase the frequency of these
              windows.
            + Eviscerate damage increased by 10% in PvP combat.
            + Goremaw's Bite bleeding damage increased by 33% in PvP combat.
    ]=],
    shamanChangesPatch = [=[
• Corrected an issue where swapping between specs may incorrectly cause Lava
      Burst to show up as Primal Strike in your spellbook.
    • Spirit Walk in the Vaults of Atal'utek should now apply to pets.
    • Hero Talents
        > Farseer
    ...
    • Elemental
        ...
        > Resolved an issue causing Master of the Elements to not increase the damage
          of Earthquake.
        > Corrected an issue where the Venomous Abyss 4-piece set bonus Overcharge!
          buff was sometimes not consumed when casting a Maelstrom spending ability.
        > All damage dealt increased by 5%.
            + Developers' notes: We discovered and fixed a tricky bug that was active on
              ...
              was inflating their damage dealt, so alongside the bug fix, we're
              increasing their damage to compensate.
    • Enhancement
        > Fixed an issue where damage from Doom Winds could interrupt channeled
          effects, such as the Font of Venomous Rage trinket.
    ...
    • Player versus Player
        > Elemental
            + Developers' notes: We feel Elemental should shine more in their damage
              against their primary target and less in their cleave, so we're making some
              improvement to core spell damage and reducing the effect of the Voltaic
              Blaze and Purging Flames combo.
            + Lightning Bolt damage increased by 25% in PvP combat.
            + Lava Burst damage increased by 15% in PvP combat.
            + Voltaic Blaze instant damage reduced by 25% in PvP combat.
            + Purging Flames now causes Lava Bursts to fire at 25% effectiveness in PvP
            ...
            + Developers' notes: Elemental's Farseer hero talent tree is performing
              ...
              effects of each type to adjust: Natural Harmony's improvements for the
              Nature's Guardian effect are being diminished, while multiple key
              Stormbringer effects (including Tempest itself) are receiving buffs
              intended to improve overall damage and burst potential.
            + Farseer: Natural Harmony now reduces the cooldown of Nature's Guardian by
              10 seconds in PvP combat (was 15 seconds).
            + Stormbringer: Tempest damage increased by 20% in PvP combat.
        ...
        > Enhancement
            ...
            + Developers' notes: Enhancement is on the weaker side offensively, so
              ...
              healing capabilities slightly.
            + Healing Surge healing reduced by 20% in PvP combat.
            + Stromstrike damage increased by 15% in PvP combat.
            + Lava Lash damage increased by 15% in PvP combat.
        > Restoration
            + Developers' notes: Restoration Shaman is slightly too strong compared to
              other healers (barring Holy Priest). We're making some small adjustments to
              their mana and the Totemic hero talent tree to better balance their mana
              and throughput.
            + Mana regeneration is now reduced by 65% in PvP combat (was 60%).
            + Totemic: Splitstream now causes Healing Stream Totem to heal an additional
              ally at 15% effectiveness in PvP combat (was 30%).
            + Totemic: Earthsurge now causes allies affected by your Earthliving to
              receive 5% additional healing from you in PvP combat (was 15%).
    ]=],
    warlockChangesPatch = [=[
• Developers' notes: We're increasing the throughput of Affliction and Demonology by
      ...
      multi-target kit. Additionally, we're considerably increasing the damage of
      Warlock demons so that they have a larger contribution to overall throughput.
    ...
    • Demonology
        ...
        > Venomous Abyss 2-piece set bonus updated - Wild Imps now Implode at 350%
          effectiveness to their main target (was 250%) and 315% effectiveness to
          other targets (was 225%).
    • Destruction
        > Fixed an issue where the Font of Venomous Rage trinket channel could be
          immediately canceled if spell-queued after Cataclysm.
        > Fixed an issue where Mayhem would sometimes become untracked when
          refreshed while active.
        > Rain of Fire damage increased by 30%.
        > Fixed an issue where Conflagration of Chaos would not guarantee a
          Conflagrate or Shadowburn to critically strike.
    ...
    • Player versus Player
        ...
        > Destruction
            + Soul Fire damage reduced by 30% in PvP combat.
            + Developers' notes: Destruction is lacking in finishing power, so we're
              increasing the damage of their primary nuke spells to allow for more burst
              potential.
            + Chaos Bolt damage increased by 15% in PvP combat.
            + Shadowburn damage increased by 30% in PvP combat.
    ]=],
...
• Developers' notes: Warriors are in a good state overall, but we feel that
    ...
    • Developers' notes: Fury's 4-piece set bonus is currently overperforming, but
      Fury is in a good place overall and we don't want to disrupt that, so
      we're moving some of the value out of the 4-piece bonus and into Fury's
      baseline. Additionally, Slayer has been overperforming for both specs due
      to a bug causing Executioner to provide double value which was recently
      hotfixed. This fix has brought overall Arms performance down into our
      intended range, but we're happy with where Fury has been, so their
      baseline damage has been increased below to compensate for this fix as
      well as the set bonus change.
    • Arms, Fury
        > Slayer: Fixed a bug that was causing Executioner to have double the
          intended effect.
    • Arms
    ...
    • Fury
        ...
        > Venomous Abyss 4-piece set bonus updated - Bloodthirst damage increased by
          10%, and during Recklessness, Bloodthirst increases the critical strike
          bonus of Recklessness by 3%, up to 6% (was 5%, up to 10%).
    • Protection
        > Mountain Thane
            + Lightning Strike damage increased by 50%. Does not apply to PvP combat.
            + Ground Current damage increased by 50%. Does not apply to PvP combat.
        ...
        > Rend is now able to be tracked in the Cooldown Manager.
        > Fight Through the Flames reduces Magic damage by 8% (was 6%).
        > Mountain Thane: Fixed an issue that would sometimes disable the bonus
          Thunder Clap damage from Crashing Thunder.
    • Player versus Player
        > Developers' notes: Arms and Fury Warriors provide strong group defensive
          utility through the Safeguard PvP talent, but the frequency of damage
          reduction prevented enemy teams from having a window of time to strike.
        > Arms
            + Colossus
                - Developers' notes: We're increasing the effectiveness of Colossus for
                  Arms in PvP to increase hero talent viability with a focus on
                ...
                - Cut to the Bone now increases Rend and Deep Wounds damage by 30% in PvP
                  combat (was 15%).
            + Safeguard (PvP Talent) now increases the cooldown of Intervene by 20
              seconds.
            + Developers' notes: To compensate for the reduction in Fueled by Violence
