...
• Unholy
        > Resolved an issue with Blightfall doing less damage as more time passes since
          the plague was applied.
    • Blood
        > Developers' notes: San'layn is dealing quite a bit more damage in AoE than our
          intended target for tanks. We will be reducing their overall damage to reduce
          the disparity. However, we will be increasing Death Strike's damage and
          reducing its cleave effectiveness to buff Blood's single target which is a
          little on the lower end of tanks. In addition, we are making some Deathbringer
          specific targeted buffs to counter the overall aura nerf and be a small net
          positive buff to both their AoE and single target damage.
        > All ability and minion damage reduced by 6%.
        > Death Strike damage increased by 15%.
        > Deadly Reach now causes Death Strike now to deal 60% of its damage to 2 nearby
          enemies (was 75%).
        > Deathbringer
            + Exterminate damage increased by 25%.
            + Reaper's Mark damage increased by 20%.
    ...
    • Unholy
        > Developers' notes: We're looking to increase Unholy Death Knight's damage
          output in raid. In parallel, we're aiming to bring Blightfall build back to
          where it was prior to the bug fixes that made it no longer viable.
        > Scourging now causes your plagues to erupt at 65%/100% (was 50%/70%). Does not
          apply to PvP combat.
        > Blightfall deals 200% of the plague damage remaining (was 100%). Does not
          apply to PvP combat.
        > San'layn
            + Infliction of Sorrow causes Vampiric Strike to erupt plagues with 75%
              increased effectiveness (was 30%).
            + Thrill of Blood increases Dread Plague damage by 20% (was 10%).
            + Frenzied Bloodthirst now increases Death Coil and Death Strike damage by
              5% per stack.
    • Unholy
        > San'layn
            + Developers' notes: We would like to push for the San'layn hero talent tree
              to be a more viable option for Unholy Death Knights in PvP.
            + Inevitable now causes plagues to deal up to 60% increased damage based on
              the target's missing health (was 30%) in PvP combat.
            + Vampiric Strike damage increased by 100% in PvP combat.
    • Unholy
        > Resolved an issue causing Magus of the Dead to occasionally spawn at extreme
          vertical differences.
    • Blood
        > Resolved an issue causing Grip of the Dead from Death and Decay to permanently
          be active on targets.
    • Frost
        > Developers' notes: We're aiming to increase Frost Death Knight's performance
          in single target and two target cleave scenarios.
        > Howling Blast main target damage increased by 15%.
        > Obliterate damage increased by 15%.
        > Frost Strike damage increased by 20%.
        > Melee damage increased by 10%.
    • Unholy
        > Resolved an issue causing Mastery: Dreadblade and Foul Infections to not
          increase the critical strike chance of Plague Erupt effects.
    • Unholy
        > Resolved an issue causing Dread and Virulent Plague Erupt effects to not work
          as intended with the target damage modifiers and caster damage modifiers Foul
          Infections, Thrill of Blood, Incite Terror, Morbidity, Soul Reaper, Brittle,
          and the War debuff of Rune of the Apocalypse.
    ...
    • Unholy
        ...
        > Dark Simulacrum can now be tracked through the Cooldown Manager.
    • Blood
        > Deathbringer: Resolved an issue causing Echoing Fury to grnt Exterminate
          stacks on Reaper's Mark casts.
        > San'layn: Visceral Strength now grants 6% strength (was 10%).
    ...
    • Frost
        > All ability and auto-attack damage increased by 9%.
        > Venomous Abyss 2-piece set bonus updated – Now grants 1% attack speed per
          stack (was 2%), and now increases Icy Death Torrent damage by 2% per stack
          (was 4%).
    ]=],
    demonHunterChangesPatch = [=[
• Devourer
        > Developers' notes: These changes are intended to primarily benefit the raid
          and single target performance of Annihilator hero talent builds and improve
          Annihilator's viability in more content.
        > Collapsing Star damage to primary target increased by 25%. Does not apply to
          PvP combat.
        > Consume/Devour damage increased by 8%. Does not apply to PvP combat.
    • Havoc
        > Aldrachi Reaver
            + Developers' notes: Aldrachi Reaver has fallen well behind the alternative
              hero talent options for both specs it is available to. We are improving
              some of its core effects for both specs, and for Havoc specifically the
              soul fragment generation from Broken Spirit is increasing to give a small
              boost to Fury generation and hasten the cycle of Reaver's Glaive and
              its bonuses.
            + Art of the Glaive now increases the damage of enhanced strikes by 15% (was
              10%) and 30% (was 20%).
            + Reaver's Glaive damage increased by 25%.
            + Reaver's Mark now increases your damage to the target by 7% (was 6%).
            + Broken Spirit chance to shatter a Soul Fragment increased to 20%
              (was 15%).
    • Vengeance
        > Aldrachi Reaver
            + Developers' notes: Aldrachi Reaver has fallen well behind the alternative
              hero talent options for both specs it is available to. We are improving
              some of its core effects for both specs.
            + Art of the Glaive now increases the damage of enhanced strikes by 15% (was
              10%) and 30% (was 20%).
            + Reaver's Glaive damage increased by 25%.
            + Reaver's Mark now increases your damage to the target by 8% (was 7%).
    ...
    • Vengeance
        > Developers' notes: Vengeance is still performing below expectations
          defensively, so universal mitigation effects are getting a buff.
          Additionally, Fel Devastation's effectiveness as a recovery tool has fallen
          behind as maximum health pools go up, so its healing is being increased.
        > Demonic Wards now reduces damage taken by 15% (was 12%).
        > Void Reaver now causes Frailty to reduce damage taken by 6% (was 5%).
        > Fel Devastation healing increased by 25%.
    • Devourer
    ...
    • Fixed an issue that allowed Blur's recent PvP adjustments to affect PvE
      ...
      intended values.
    • Devourer
        > Fixed an issue that prevented the effect of the Devourer 2-piece set bonus
          (Soulburst) from displaying correctly.
    • Havoc
        > All damage increased by 3%.
    • Vengeance
        > Mastery: Fel Blood effectiveness increased by 24%.
    • Developers' notes: We feel the defensive kits of Devourer and Havoc are too
      powerful, so we are reducing some of their passive and active defenses to make
      them more viable targets for opponents.
    • Glimpse now reduces damage taken by 20% while active (was 25%).
    • Devourer
        > Void Ray damage increased by 33% in PvP combat.
        > Blur now reduces damage taken by 15% in PvP combat (was 25%).
    ...
    • Havoc
        > Blur now reduces damage taken by 15% in PvP combat (was 25%).
        > Desperate Instincts now reduces damage taken by 5% while below 35% health in
          PvP combat (was 10%).
    • Havoc
    ...
    • Devourer
        > Developers' notes: Devourer's 4-piece set bonus is performing significantly
          ...
          bonus reduction, we're increasing all ability damage. Additionally, Devourer
          has been overperforming, mostly in single target, so we are reducing the
          damage of Reap/Cull/Eradicate while increasing the AoE damage portion of
          Eradicate to reduce the impact of the change in AoE combat.
        > All ability damage increased by 14%. Does not affect PvP combat.
        > Reap/Cull/Eradicate damage reduced by 12%.
        > Eradicate's area-of-effect damage increased to 90% of base damage (was 85%).
        > Venomous Abyss 4-piece set bonus updated – Now generates 2 soul fragments (was
          8 soul fragments) and increases Reap damage by 10% (was 20%).
    • Devourer
        > Developers' notes: Devourer Demon Hunters are both very threatening and very
          defensible during Void Metamorphosis and Surrender to the Void has provided
          the opportunity to increase the duration of those windows too significantly,
          so its Fury generation effect is being reduced.
        > Surrender to the Void now increases Fury generated by 60% (was 100%).
    ]=],
    druidChangesPatch = [=[
• Hero Talents
        > Wildstalker
    ...
    • Feral
        > Wildstalker
            + Patient Custodian increases bleed damage by 10% (was 8%). Does not apply
              to PvP combat.
    • Restoration
        > All healing increased by 4%. Does not apply to PvP combat.
        > Fixed an issue where Photosynthesis could trigger from other players' heal
          over time effects.
    • Feral
        > Druid of the Claw
            + Ravage damage increased by 20% in PvP combat.
            + Dreadful Wound damage increased by 25% in PvP combat.
            + Exacerbating Wounds increases damage taken from your bleed effects by 10%
              in PvP combat (was 8%).
    • Restoration
        > Developers' notes: Restoration Druid's burst healing and instant crowd-control
          capabilities have limited counterplay for other players, so we're targeting
          these aspects to decrease their overall performance.
        > Call of Ohn'ahra increases the cooldown of Nature's Swiftness by 60 seconds
          (was 30 seconds).
        > Swiftmend healing reduced by 20% in PvP combat.
    • Guardian
        > Fixed an issue where Wild Guardian was incorrectly increasing Thrash and
    ...
    • Balance
        ...
        > Twin Moons' range is now increased by target combat reach, meaning it can
          spread to farther targets when attacking large enemies.
    • Feral
        > Apex Talent: Unseen Predator (Rank 1) now prefers targets that are not immune
          to damage or taking less than 5% physical damage.
    • Balance
        > Fixed an issue where Faerie Swarm was not a large debuff on raid frames.
    • Shred damage increased by 10%.
    • Balance
        > All ability damage increased by 4%. Does not affect PvP combat.
    • Feral
        > Developers' notes: Feral is performing below expectations, particularly in
          raid encounters, so we're providing both an overall lift as well as some
          specific buffs to single-target abilities.
        > All ability damage increased by 5%. Does not apply to PvP combat.
        > Auto-attack damage increased by 10%.
        > Ferocious Bite damage increased by 10%.
    • Restoration
    ...
    • Innervate grants 20% mana in PvP combat (was 25%).
    • Feral
        > Developers' notes: We're increasing Feral's general damage, especially for
          Druid of the Claw, and nudging down their defensiveness to speed up the pace
          of combat for Feral.
        > Ravage (Druid of the Claw) damage increased by 15% in PvP combat.
        > Survival Instincts reduces damage taken by 40% in PvP combat (was 50%).
    • Restoration
        > Developers' notes: We're increasing Restoration's overall healing while at the
          same time reducing the power of Swiftmend and some of their mana regeneration
          talents. The goal is to better balance Restoration's healing kit to not be so
          reliant on Swiftmend to top up allies.
        > Potent Enchantments increases the duration of Incarnation: Tree of Life by 4
          seconds in PvP combat (was 6 seconds).
        > Reforestation grants Incarnation: Tree of Life for 8 seconds in PvP combat
          (was 10 seconds).
        > Swiftmend healing reduced by 20% in PvP combat.
    ...
    • Restoration
        > Fixed an issue where Grove Guardians were not prioritizing healing the target
          of your Swiftmend or Wild Growth.
        > Fixed an issue where Everbloom could incorrectly heal 6 targets instead of the
          intended 5 targets.
    • Restoration
        > Developers' notes: These changes are intended to address Rejuvenation and Wild
          Growth feeling weak in season 2, particularly in dungeons. We're also
          increasing the power of the 4-piece class set to make sure it's an impactful
          and noticeable set bonus. These changes are accompanied by slight nerfs to
          their raid healing to keep them around the same power in raid while increasing
          their power in dungeons.
        > 4-piece class set bonus increases Genesis duration by 8 seconds (was
          4 seconds).
        > Rejuvenation and Germination healing increased by 15%. Does not apply to
          PvP combat.
        > Wild Growth healing increased by 10%.
        ...
        > Everbloom heals for 48% of Lifebloom's final heal (was 40%). Does not apply
          to PvP combat.
    • Feral
        > Developers' notes: Feral's sustained damage is lower than our intended target,
          so we're targeting their primary damage over time effects to improve this.
          We're also targeting a buff for Druid of the Claw which has fallen behind
          Wildstalker in viability.
        > Druid of the Claw: Ravage damage increased by 20% in PvP combat.
        > Rip damage increased by 15% in PvP combat.
        > Rake damage increased by 15% in PvP combat.
    • Restoration
    ...
    • Restoration
        > Fixed an issue where Rejuvenation could be removed early if the player gained
          or lost haste while it was active.
    • Restoration
        > Developers' notes: We're increasing Restoration Druid's healing and damage
          as both aspects are underperforming relative to other healers.
        > All healing increased by 4%. Does not affect PvP combat.
        > All damage increased by 20%. Does not affect PvP combat.
    • Restoration
        > Developers' notes: Restoration Druid received several changes in Curse of
          Ula'tek that improved its throughput beyond what we would like in PvP.
        > All healing reduced by 5% in PvP combat.
    ]=],
    evokerChangesPatch = [=[
• Augmentation
        ...
        > Blistering Scales damage increased by 100%.
    • Devastation
        > Developers' notes: Devastation's overall damage in M+ is slightly lower than
          we'd like, so we're broadly targeting AoE abilities for buffs. We're
          increasing Unbound Flame's damage to maintain its appeal as the focus of the
          Apex talents. And finally, we're increasing Shattering Star's damage so that
          players talenting for their tier set can feel confident they are making a
          competitive character building decision. We anticipate this package giving a
          larger buff to Flameshaper than to Scalecommander, as we're seeing
          Scalecommander outperform it in most content.
        > Pyre damage increased by 10%. Does not apply to PvP combat.
        > Unbound Flame damage increased by 25%. Does not apply to PvP combat.
        > Fire Breath damage increased by 5%. Does not apply to PvP combat.
        > Azure Strike damage increased by 50%. Does not apply to PvP combat.
    ...
    • Fixed an issue preventing Unravel from activating when Fire Breath was cast with
      Tip the Scales.
    • Fixed an issue where Unravel may not hit all targets struck by Fire Breath.
    • Fixed an issue where Unburdened Flight was causing Deep Breath to move the player
      forward during Hover.
    • Hero Talents
        > Chronowarden
            + Fixed an issue where Warp was still causing the player to become immune
              to snares while talented into Unburdened Flight.
    • Fixed an issue where staves were not being shown for Evokers on the PvP
      gear vendor.
    • Preservation
        > Fixed an issue where Rewind could fail to reverse damage taken on allies if
          the Evoker was affected by Cyclone.
    • Devastation
        > Developers' notes: The Devastation Flameshaper build is not being utilized
          much compared to Scalecommander. We're increasing the power of some
          Flameshaper focused spells to open up more options for them.
        > Disintegrate triggers Consume Flame at 200% effectiveness in PvP combat (was
          150%).
        > Enkindle damage increased to 30% in PvP combat (was 20%).
        > Expanded Lungs increases damage of Fire Breath's periodic by 40% in PvP combat
          (was 30%).
    • Preservation
        > Mana regeneration is now reduced by 35% in PvP combat (was 30%).
    • Flameshaper: Fixed an issue where Lifecinders incorrectly stated that it required
      Renewing Blaze.
    • Preservation
        > Fixed an issue where Emerald Communion would loop its visual even after the
          effect had ended.
    • Preservation
        > Developers' notes: We're further increasing some of the Preservation triage
          heals to help them keep up with other healers in dungeons.
    ...
    hunterChangesPatch = [=[
• Wing Clip now reduces movement speed by 40% in PvP combat.
    • Improved Snaring now increases the movement speed reduction of Wing Clip by 10%
      in PvP combat.
    • Marksmanship
        > Developers' notes: We're looking to increase the area damage capabilities of
          Marksmanship Hunters with these changes.
        > Trick Shots now causes Aimed Shot or Rapid Fire ricochets to hit for 75% of
          damage (was 60%).
        > Volley damage increased by 10%.
    • Survival
        > Developers' notes: We're increasing the damage that Wildfire Bomb deals to all
          targets, but reducing the bonus damage to the primary target. This should be
          a neutral change against a single target, but an increase to area damage when
          fighting more than one enemy.
        > Wildfire Bomb damage increased by 20%.
        > Wildfire Bomb now only hits the primary target for 50% additional damage (was
          80% additional).
    • Beast Mastery
        > Dark Ranger
            + Developers' notes: Dark Ranger has been underperforming for Beast Mastery,
              so we're adjusting their Black Arrow damage to increase their performance.
            + Black Arrow damage increased by 30% in PvP combat.
    • Survival
        > Developers' notes: Survival Hunter's burst window has been particularly
          powerful this season, so we are targeting reductions in that area to allow
          other players more time to react.
        > Takedown Hunter damage reduced by 10% in PvP combat.
        > Takedown Pet damage reduced by 15% in PvP combat.
        > Sentinel
            + Moonlight Chakram damage reduced by 15% in PvP combat.
    • Marksmanship
        > Fixed an issue where Aimed Shot was not properly playing its cast animation
          when using a gun or crossbow.
    • Survival
        > Corrected an issue where the initial damage of Wildfire Bomb would not happen
          if the Hunter was affected by crowd control effects while the bomb hit
          the target.
        > Corrected an issue where Strike As One would not deal damage with a Raptor
          Swipe that benefit from Tip of the Spear if Aspect of the Eagle is active.
    • Beast Mastery
        > All damage dealt by you and your pets increased by 7%.
        > Resolved an issue causing Wild Thrash to not take target bounding radius into
          account.
    • Survival
        > All damage dealt by you and your pet increased by 7%. This increase is only
          3% while engaged in PvP combat.
    • Developers' notes: Sentinel Hunters are slightly too strong during burst windows
      in PvP, so we're reducing the damage of Moonlight Chakram and increasing the
      throughput of rotational abilities to compensate.
    • Marksmanship
        > Sentinel: Moonlight Chakram damage reduced by 30% in PvP combat.
        > Rapid Fire damage increased by 15% in PvP combat.
        > Arcane Shot damage increased by 15% in PvP combat.
    ...
    • Survival
        > All damage dealt by you and your pets increased by 4%.
    • Beast Mastery
        > Developers' notes: Beast Mastery's damage during burst windows is higher than
          we'd like in PvP, reducing some of the abilities that can contribute to this
          situation.
        > Bloodshed damage reduced by 25% in PvP combat.
        > Bestial Wrath initial damage reduced by 10% in PvP combat.
        > Pack Leader: Stampede! damage reduced by 10% in PvP combat.
    ...
    • Beast Mastery
        > Developers' notes: The new Venomous Abyss tier set bonus isn't quite as strong
          ...
          set bonus.
        > Venomous Abyss 4-piece set bonus updated – Now causes Cobra Shot to benefit
          from Beast Cleave at 30% effectiveness per stack (was 20%) or strike your
          target for an additional 20% damage per stack (was 15%).
    • Beast Mastery
    ...
    mageChangesPatch = [=[
• Arcane
        > Chrono Shift (PvP Talent) now reduces movement speed by 30% in PvP combat (was
          50%).
    • Developers' notes: For both Fire and Frost, these changes are intended to
      primarily improve performance in M+, with a smaller impact in raids.
    • Fire
        > Meteor's damage over time increased by 100%. Does not apply to PvP combat.
        > Frostfire
            + Dualcasting Adept now increases Flamestrike damage by 15% (was 10%).
        > Sunfury
            + Burden of Power now increases Flamestrike damage by 6% (was 3%).
    • Frost
        ...
        > Glacial Assault icy comet damage increased by 50%.
    • Fire
        > Developers' notes: We feel Fire Mage burst damage continues to be too high
          even outside of Combustion, so we're further reducing the damage bonus from
          Pyroclasm to lessen its potential to lead to quick kills.
        > Pyroclasm now increases the damage of Pyroblast or Flamestrike by 160% in PvP
          combat (was 180%).
    • Hero Talents
        > Spellslinger
            + Fixed an issue causing Splinters from Augury Abounds to sometimes strike
              crowd-controlled targets when other non-crowd controlled targets
              are available.
    • Fire
        > All ability damage increased by 3%. Does not apply to PvP combat.
    • Frost
        > All ability damage increased by 6%.
    • Developers' notes: Mages have been extending the duration of PvP matches with
      frequent access to strong defensive abilities, so we're reducing the effectiveness
      of their barriers and the cooldown of Ice Block. Fire damage is also being
      reduced to bring them in line with other specializations.
    • Improved Conjuration reduces the cooldown of Mirror Image by 15 sec in PvP combat.
    • Winter's Protection reduces Ice Block cooldown by 15/30 sec in PvP combat. Tooltip
      in PvP will be updated in a later patch.
    • Arcane
        > Prismatic Barrier absorb reduced by 25% in PvP combat.
    • Fire
        > Blazing Barrier absorb reduced by 25% in PvP combat.
    ...
    • Frost
        > Ice Barrier absorb reduced by 25% in PvP combat.
    • Fire
        > Resolved an issue where the 2-piece set bonus: Flamestrike did not correctly
          always grant Hot Streak when it is a guaranteed critical strike due
          to Pyroclasm.
    • Frost
        > Developers' notes: We're primarily focused on Frost's performance in Mythic
          Keystone dungeons. The recent removal of the health increase from Improved
          Ice Barrier had a greater effect on Frost's overall survivability than
          intended. We like the symmetry of the three Improved Barrier talents having
          one additional effect, and Frost has historically had a slightly larger
          absorb than Arcane and Fire, so we're baking it into the baseline absorb
          amount rather than re-attaching it to Improved Ice Barrier. We're also making
          some targeted increases to Frost's area of effect damage.
        ...
        > Frostfire: Isothermic Core - Meteor damage increased by 25%.
    • Fire
        > Developers' notes: Fire Mage execute windows and hard cast Pyroblast damage
          have been higher than we would like, so we're reducing the effectiveness of
          Molten Fury and Pyroclasm in PvP.
        > Burnout now explodes for 50% of remaining Ignite damage in PvP combat (was
          75%).
        > Pyroclasm now increases the damage of Pyroblast and Flamestrike by 180% in PvP
          combat (was 230%).
        > Molten Fury now increases damage to targets below 35% health by 10% in PvP
          combat (was 15%).
    • Arcane
        > Developers' notes: The Venomous Abyss set bonus is overperforming our target
          tuning for set bonuses. However, the amount we need to reduce its value by
          would be a greater impact than intended to Arcane's overall damage, so we are
          also making a small positive adjustment to Arcane's baseline.
        > All ability damage increased by 3%.
        > Venomous Abyss 2-piece set bonus updated – Arcane Missiles damage bonus
          reduced to 5% (was 20%).
        > Venomous Abyss 4-piece set bonus updated – Cumulative Power damage bonus per
          stack reduced to 3% (was 5%).
    • Fire
        > Developers' notes: Fire Mage's Venomous Abyss tier set bonus is particularly
          difficult to take advantage of in PvP combat, so we're making a few tweaks
          with the objective of increasing its usability. We're also decreasing Meteor's
          damage to reduce Fire Mage's burst capabilities.
        > Pyroblast damage increased by 10% in PvP combat.
        > Meteor damage decreased by 20% in PvP combat.
        > Comet Storm damage decreased by 20% in PvP combat.
        > Venomous Abyss 4-piece set bonus updated – Now decreases the cast time of
          Pyroblast and Flamestrike by 30% (was 10%) and increases Pyroclasm's damage
          bonus by 5% (was 10%) in PvP combat.
    ]=],
    monkChangesPatch = [=[
• Windwalker
        > Fixed an issue that caused PvP adjustments to Windwalker's Celestial Conduit
          and Flurry Strikes to apply in PvE as well.
    • Mistweaver
        > All healing increased by 5%. Does not apply to PvP combat.
        > Vivify healing increased by 15%. Does not apply to PvP combat.
        > Sheilun's Gift healing increased by 15%. Does not apply to PvP combat.
    • Windwalker
        ...
        > Rising Sun Kick damage increased by 8%. Does not apply to PvP combat.
    • Windwalker
        > Developers' notes: We're decreasing the performance gap between Windwalker's
          hero talent trees as Shado-pan has been overperforming and Conduit of the
          Celestials has been underperforming.
        > Conduit of the Celestials
            + Celestial Conduit damage increased by 50% in PvP combat.
        > Shado-Pan
            + Flurry Strikes damage reduced by 15% in PvP combat.
    • Mistweaver
        > Developers' notes: We're looking to increase Mistweavers' healing capabilities
          while increasing their 4-piece set bonus value.
        > All healing done increased by 5%.
        > The Venomous Abyss 4-piece set bonus chance to activate has been increased
          to 25% (was 20%).
    • Windwalker
        > All ability damage increased by 4%. Does not affect PvP combat.
    • Mistweaver
        > Fixed an issue where Soothing Mist could rarely cause the incorrect aura to
          be canceled.
    • Brewmaster
        > Developers' note: We're adjusting the absorption of Celestial Brew and
          Celestial Infusion to improve its impact as a defensive option and to help
          address pain points players are experiencing in some encounters.
        > All damage increased by 3%.
        > Celestial Brew and Celestial Infusion absorb value increased by 20%.
    • Brewmaster
        > Fixed an issue where Hot Trub PvP talent was incorrectly counting as both a
          Disorient and an Incapacitate. It now counts as an Incapacitate only.
    • Windwalker
        > Rushing Wind Kick damage reduced by 20% in PvP combat.
        > Rising Sun Kick damage reduced by 10% in PvP combat.
        > Tigereye Brew now increases critical strike damage by 3/6% in PvP combat (was
          5/10%).
    • Mistweaver
    ...
    paladinChangesPatch = [=[
• Consecrated Ground now reduces movement speed by 20% in PvP combat (was 50%).
    • Protection
        > All ability damage increased by 6%. Does not apply to PvP combat.
    • Retribution
        > Templar
            + Developers' notes: Templar has been underperforming compared to Herald of
              the Sun this season. We're increasing its throughput to make it a more
              viable option against Herald of the Sun, for those who enjoy
              Templar's playstyle.
            + Hammer of Light damage increased by 50%. Does not apply to PvP combat.
            + Empyrean Hammer damage increased by 12%.
    • Retribution
        > Templar
            + Developers' notes: We're bringing Templar's performance up also in PvP,
              but we believe the gap to Herald of the Sun is less drastic compared to
              PvE.
            + Hammer of Light damage increased by 20%.
    • Protection
        > Fixed an issue where Consecration's first tick would not benefit from the
          Venomous Abyss tier set's increase to its critical strike chance.
    • Holy
        > Fixed an issue that caused Ringing of the Heavens to not function if cast as
          Lightsmith while targeting an enemy.
    • Protection
        > Fixed an issue where Glory of the Vanguard was not dealing full damage to its
          primary target.
    • Protection
        > Developers' notes: We're adjusting Protection Paladin damage to help them
          keep up with other tanks, especially in dungeons.
        > Blaze of Glory damage increased by 150%.
        > Consecration damage increased by 30%.
        > Divine Guidance damage increased by 30%.
    • Holy
        > Developer's notes: Holy Paladin throughput has increased with recent changes
          past our targets for them in PvP.
        > All healing reduced by 4% in PvP combat.
    • Protection
        > Developers' note: Protection Paladins have been extending the duration of the
          matches that they participate in with frequent access to group utility. We're
          reducing the effectiveness of Blessing of Sacrifice and Guardian of the
          Forgotten Queen to bring them in line.
        > Guardian of the Forgotten Queen duration reduced to 6 seconds.
        > Guardian of the Forgotten Queen cooldown increased to 4 minutes.
        > Guardian of the Forgotten Queen now has a 6 second internal cooldown.
        > Sacrifice of the Just reduces the cooldown of Blessing of Sacrifice by 30
          seconds in PvP combat (was 60 seconds).
    • Retribution
        > Developers' notes: Retribution's personal durability has been higher than we
          would like considering their complete team defensive package, and Templar's
          damage has not been competitive with Herald of the Sun, so we're increasing
          some sources specific to its hero tree.
        > Shield of Vengeance absorption reduced by 25% in PvP combat.
        > Divine Protection now reduces damage taken by 20% in PvP combat (was 25%).
        > Templar: Seal of the Templar now increases the damage of Templar's Verdict by
          35% (was 25%).
        > Templar: Hammer of Light's damage increased by 10% in PvP combat.
    • Protection
        > Fixed an issue where Blessed Hammer could not hit Ula'tek's Venomous Heart.
    • Protection
        > Fixed an issue where Avenger's Shield could sometimes fail to activate Glory
          of the Vanguard while Divine Resonance was active.
    • Retribution
        ...
        > Class Set 4-piece Divine Arbiter secondary target damage increased by 75%.
    • Holy
        > Developer's notes: Holy Paladin throughput has been higher than we would
          like, and Judgment has been too effective as an offensive tool. Avenging
          Crusader's effectiveness is being increased to offset the decrease to
          Judgment's damage.
        > All healing decreased by 5% in PvP combat.
        > Judgment damage decreased by 30% in PvP combat.
        > Avenging Crusader now transfers 80% of damage done into healing in PvP combat
          (was 55%).
    • Retribution
        > Developers' notes: Retribution had been contributing to longer PvP matches
          during Season 1 due to their frequent access to team utility. We're shifting
          some of that effectiveness into more consistent offensive power, and
          additionally giving Templar an increase to Hammer of Light damage so they are
          a solid offensive alternative to Herald of the Sun.
        > All damage increased by 8% in PvP combat.
        > Final Verdict damage increased by 15% in PvP combat.
        > Hammer of Light damage increased by 25% in PvP combat.
        > Sacrifice of the Just now reduces Blessing of Sacrifice's cooldown by 30
          seconds in PvP combat (was 60 seconds).
        > Unbreakable Spirit reduces the cooldown of affected spells by 20% in PvP
          combat (was 30%).
    • Retribution
        > Fixed an issue where Paladins talented into Radiant Glory would not have
          Avenging Wrath be applied after casting Wake of Ashes while silenced.
    ...
    priestChangesPatch = [=[
• Discipline
        > Developers' notes: Discipline isn't able to dish out proper healing in dungeon
          environments due to how strong Atonement is in raids. We're reintroducing an
          Atonement healing bonus outside of raid environments and significantly
          increasing Atonement healing outside raid to help Discipline shine
          in dungeons.
        > Atonement healing is increased by 40% when not in a raid or
          battleground instance.
        > Penance mana cost reduced by 20%.
    • Shadow
        > Developers' notes: We feel Shadow is lacking in single target damage, so these
          changes are intended to improve Shadow's damage against singular targets while
          remaining neutral in multi-target situations.
        > Mind Blast damage increased by 15%.
        > Void Blast damage increased by 15%.
        > Shadow Word: Death damage increased by 15%.
        > Shadow Word: Madness damage increased by 15%. Does not apply to PvP combat.
        > Mind Flay damage increased by 15%. Does not apply to PvP combat.
        > Mind Flay: Insanity damage increased by 15%. Does not apply to PvP combat.
        > Psychic Link now causes direct damage spells to inflict 20% of their damage
          to all other targets afflicted by Vampiric Touch (was 25%). Does not apply
          to PvP combat.
        > Shadeburst damage reduced by 5%. Does not apply to PvP combat.
    • Developers' notes: We're increasing the effectiveness of Mindgames once more in
      this pass to solidify its usability. We'd like for it to be able to compete with
      other powerful PvP talent options in Priest's kit.
    • Mindgames direct damage and reversal increased by 50%.
    • Holy
        > Archon
            + Developers' notes: We feel Oracle Holy is in a good place, but Archon has
              difficulties keeping up, so we're targeting buffs to its throughout and
              offensive potential.
            + Halo damage and healing increased by 30% in PvP combat.
            + Focused Outburst now reduces the cast time of Prayer of Healing by 40% in
              PvP combat (was 15%).
            + Realized Potential now increases Flash Heal healing by 20% in PvP combat
              (was 10%).
    • Discipline
        > Atonement healing is no longer increased by 40% in PvP combat.
    • Shadow
        > Developers' notes: We're increasing the damage of Shadow Word: Death
          significantly in addition to the Mind Blast changes above to allow for more
          opportunities to finish enemies off.
        > Shadow Word: Death damage increased by 30% in PvP combat.
    • Holy
        > Fixed an issue where Renewed Vigor from the Venomous Abyss 2-piece tier bonus
          could exceed 3 stacks.
    • Fixed an issue where Flash Heal could not be tracked on the Cooldown Manager for
      Discipline and Shadow specializations.
    • Holy
        > Fixed an issue with the Venomous Abyss 2-set bonus that caused Renew to not
          reliably grant Renewed Vigor.
    • Discipline
        > Shadow Mend mana cost reduced by 20%.
    • Developers' notes: Mindgames has fallen behind other spells and has been an
      underutilized talent for some time, so we're increasing its viability to offer
      all Priest specializations more PvP talent options.
    • Mindgames direct damage increased by 150%.
    • Mindgames healing and damage reversal increased by 150%.
    • Discipline
        > Flash Heal and Shadow Mend healing increased by 20% in PvP combat.
        > Atonement healing increased by 5% in PvP combat.
    • Holy
        > Developers' notes: Holy Priest is vastly overperforming due to a mixture of
          overall healing increases from the patch as well as some generous PvP
          specific healing increases to Prayer of Mending and Holy Word: Serenity.
          We're reducing these PvP increases to Prayer of Mending, Holy Word: Serenity,
          and Prompt Prognosis which are all powerful instant cast spells.
        > Enlightenment regenerates mana 10% faster in PvP combat (was 25%).
        > Prayer of Mending healing reduced by 25% in PvP combat.
        > Holy Word: Serenity healing reduced by 15% in PvP combat.
        > Oracle: Prompt Prognosis healing reduced by 25% in PvP combat.
    • Shadow
        ...
        > Shadow Word: Death damage increased by 15% in PvP combat.
    • Holy
        > Fixed an issue where Guardian Angel would not reduce the cooldown of Guardian
          Spirit when placed on an ally.
    • Holy
        > Fixed an issue where Divine Hymn would put Guardian Spirit on a 60-second
          cooldown with Guardian Angel talented.
    • Discipline
        > Developers' notes: We're reducing Discipline's damage done and offsetting
          this in Atonement to not affect their overall healing, as their damage has
          been overperforming compared to other healers. At the same time, we're
          increasing the damage of Entropic Rift to minimize the impact this will have
          on Voidweaver's dungeon viability and help maintain high damage as one of its
          strengths.
        > All damage reduced by 30%. Does not affect PvP combat.
        > Oracle: Entropic Rift damage increased by 20%.
        ...
        > Oracle: Void Shield reflects 10% of damage (was 15%).
    • Holy
        > Developers' notes: We're increasing the healing throughput of Oracle so that
          it can serve as a competitive option against Archon. Furthermore, we are
          increasing the mana regeneration of Enlightenment to further help Holy
          Priest's mana economy.
        > Enlightenment now regenerates mana 25% faster (was 10%).
...
• Subtlety
        > Trickster
            + Developers' notes: Trickster has performed well below Deathstalker for
              Subtlety this tier and is receiving damage boost to its core effects to
              make Trickster a more reasonable choice in a wider range of content.
            + Unseen Blade damage increased by 50%. Does not apply to PvP combat.
            + Coup de Grace damage increased by 30%. Does not apply to PvP combat.
    • Assassination
        > All damage reduced by 4% in PvP combat.
    ...
    • Assassination
        > Fixed an issue allowing Caustic Spatter to trigger from non-class Nature
          damage sources, such as trinkets.
    • Developers' notes: Rogues' defensive potential improves in coordinated play and as
      ratings increase, with the predictive effect of Preemptive Maneuver standing out
      as being too rewarding, so it's being brought down to be more appropriate.
    • Preemptive Maneuver now reduces damage taken by 25% while its effect is active
      (was 40%).
    • Assassination
        > All ability damage reduced by 4% in PvP combat.
    • Deathstalker: Fixed an issue where Deathstalker's Mark would be removed when
    ...
    • Assassination
        > All damage increased by 4%.
    • Subtlety
        > Developers' notes: Subtlety's 4-piece set bonus is overperforming
          expectations, so its effectiveness is being reduced. An overall buff to
          Subtlety's damage is being applied to compensate.
        > All damage increased by 6%.
        > The Venomous Abyss 4-set bonus has been updated – Effectiveness reduced to
          60% (was 100%).
        > Shadow Dance now cancels when swapping talents.
        > Shadow Dance can no longer be cancelled manually.
    ...
    shamanChangesPatch = [=[
• Restoration
        > Fixed an issue where Soothing Rain did not properly reduce the cast time of
          Healing Rain by 0.5 seconds.
    • Enhancement
        > Fixed an issue where damage from Doom Winds could interrupt channeled effects,
          such as the Font of Venomous Rage trinket.
        > Stormbringer: Fixed an issue where Crash Lightning could cause unintended
          targets to be hit by Windfury Weapon.
    • Enhancement
        > Corrected an issue where the Venomous Abyss 4-set bonus was not properly
          increasing the upfront damage of Crash Lightning.
    • Restoration
        > Totemic
            + Corrected an issue where Oversurge did not properly increase the healing
              done by Surging Totem or Overflowing Shores.
    • Hero Talents
        > Farseer
            + Fixed an issue that caused Natural Harmony to increase the healing of
              Nature's Guardian by 20% instead of its listed and intended 10%.
    • Elemental
        > Developers' notes: Elemental's Farseer hero talent tree is performing better
          than expected defensively, and its Stormbringer hero talent tree is performing
          below expectations offensively. As a result we're targeting key effects of
          each type to adjust: Natural Harmony's improvements for the Nature's Guardian
          effect are being diminished, while multiple key Stormbringer effects
          (including Tempest itself) are receiving buffs intended to improve overall
          damage and burst potential.
        > Farseer: Natural Harmony now reduces the cooldown of Nature's Guardian by 10
          seconds in PvP combat (was 15 seconds).
        > Stormbringer: Tempest damage increased by 20% in PvP combat.
        > Stormbringer: Natural Gift now increases Nature damage by 4% in PvP combat
          (was 2%).
        > Stormbringer: Stormcaller now increases Nature spell critical strike damage
          by 10% in PvP combat (was 5%).
    • Enhancement
        > Developers' notes: Enhancement is on the weaker side offensively, so we're
          increasing some of its sustained damage while also reducing its healing
          capabilities slightly.
        > Healing Surge healing reduced by 20% in PvP combat.
        > Stromstrike damage increased by15% in PvP combat.
        > Lava Lash damage increased by 15% in PvP combat.
    • Elemental
        > Farseer: Corrected an issue where Maelstrom Supremacy did not increase the
          healing of Healing Surge.
    • Elemental
        > Resolved an issue causing Master of the Elements to not increase the damage
          of Earthquake.
    • Restoration
        > Totemic
            + Corrected an issue where the Whirling Water effect was not
              properly working.
    • Elemental
        ...
        > All damage dealt increased by 5%.
            + Developers' notes: We discovered and fixed a tricky bug that was active
              on the PTR, that was increasing the amount of free Maelstrom spending
              abilities Elemental Shaman could get from the Venomous Abyss 4-piece set
              bonus. This was inflating their damage dealt, so alongside the bug fix,
              we're increasing their damage to compensate.
    • Enhancement
        > All damage increased by 5%.
    • Corrected an issue where swapping between specs may incorrectly cause Lava Burst
      to show up as Primal Strike in your spellbook.
    ]=],
    warlockChangesPatch = [=[
• Affliction
        > Agony damage increased by 40% in PvP combat.
    ...
    • Destruction
        > Fixed an issue where Mayhem would sometimes become untracked when refreshed
          while active.
    • Developers' notes: We're increasing the throughput of Affliction and Demonology
      by primarily focusing on their single-target tools with a secondary focus on
      their multi-target kit. Additionally, we're considerably increasing the damage
      of Warlock demons so that they have a larger contribution to overall throughput.
      This should also help a bit more with aggro concerns during solo play.
    • Imp, Voidwalker, Sayaad, and Felhunter damage increased by 350%.
    • Affliction
        > Unstable Affliction damage increased by 15%. Does not apply to PvP combat.
        > Hellcaller – Blackened Soul damage increased by 20%. Does not apply
          to PvP combat.
        > Wrath of Nathreza damage increased by 35%. Does not apply to PvP combat.
        > Shadow of Nathreza damage increased by 25%. Does not apply to PvP combat.
        > Agony damage increased by 20%. Does not apply to PvP combat.
    ...
    • Demonology
        ...
        > Wild Imp damage increased by 20%.
        > Summon Felguard damage increased by 20%.
        > Demons summoned by Dominion of Argus damage increased by 20%. Does not apply
          to PvP combat.
        > Call Dreadstalkers damage increased by 30%.
    • Destruction
        > Rain of Fire damage increased by 30%.
    • Affliction
        > Developers' notes: We're increasing Affliction's ability to maintain spread
          pressure by adjusting Agony's damage and making a small adjustment to
          Unstable Affliction's backlash damage to make dispelling all their damage
          over time effects more punishing.
        > Agony damage increased by 50% in PvP combat.
        > Unstable Affliction backlash damage increased by 20%.
    • Demonology
        > Developers' notes: We feel too much of Demonology's damage is focused on
          Wicked Reaping and Power Siphon, so we're reducing the power of these effects
          and increasing overall damage through our game-wide Demonology changes above.
        > Soul Harvester: Wicked Reaping damage reduced by 50% in PvP combat.
        > Soul Harvester: Necrolyte Teachings now causes Power Siphon to increase the
          damage of Demonbolt by an additional 10% in PvP combat (was 20%).
        > Power Siphon now increases the damage of your next 2 Demonbolts by 20% in
          PvP combat (was 30%).
    • Destruction
        > Developers' notes: Destruction is lacking in finishing power, so we're
          increasing the damage of their primary nuke spells to allow for more
    ...
    • Demonology
        > Burning Cleave (granted by Antoran Armaments) now strikes enemies in a
          circular area, rather than a cone. The tooltip for Burning Cleave will be
          updated in a future patch.
        > Developers' notes: We are increasing the throughput of the Venomous Abyss
          2-set bonus for Demonology so that its performance is closer to other
          specialization tier set bonuses.
        > Venomous Abyss 2-piece set bonus updated – Wild Imps now Implode at 350%
          ...
          targets (was 225%).
    • Destruction
        > Fixed an issue where Conflagration of Chaos would not guarantee a Conflagrate
          or Shadowburn to critically strike.
        > Fixed an issue where Shadowburn would not apply its debuff after dealing
          damage to a Havoc target.
    • Destruction
        > Fixed an issue where the tooltip of Shadowburn would not display the
          correct duration.
    • Fixed an issue where Warlock pets would continually learn Soul Leech.
    • Demonology
        > Soul Harvester: fixed an issue where Shadow Bolt and Hand of Gul'dan would
          be disabled in the cooldown manager.
    • Affliction
        > Fixed an issue where Seed of Corruption would not consume Shard Instability
          on cast.
    ]=],
    warriorChangesPatch = [=[
• Developers' notes: Warriors are in a good state overall, but we feel that Mountain
      Thane is a bit behind their partner hero specs on both Fury and Prot, so we're
      giving a small boost there to help Mountain Thane enjoyers.
    • Fury
        > Mountain Thane
            + Lightning Strike damage increased by 50%. Does not apply to PvP combat.
            + Ground Current damage increased by 50%. Does not apply to PvP combat.
    • Protection
        > Mountain Thane
            + Lightning Strike damage increased by 50%. Does not apply to PvP combat.
            + Ground Current damage increased by 50%. Does not apply to PvP combat.
    • Developers' notes: To compensate for the reduction in Fueled by Violence
      self-healing, we're increasing Arms' Hero Talents throughput by increasing
      Slayer's Strike and Demolish damage in PvP.
    • Arms
        > Colossus
            + Developers' notes: We're increasing the effectiveness of Colossus for Arms
              in PvP to increase hero talent viability with a focus on improving the
              effectiveness of your post-Demolish window.
            + Practiced Strikes increases the damage of Slam and Mortal Strike by 40% in
              PvP combat (was 25%).
            + Arterial Bleed now increases Rend and Deep Wounds damage by 5% per stack
              in PvP combat (was 3%).
            + Cut to the Bone now increases Rend and Deep Wounds damage by 30% in PvP
              combat (was 15%).
    • Arms
        > The Venomous Abyss 4-set Bonus – The Winding Up bonus Slam damage buff can
          now be tracked in the Cooldown Manager.
        > Rend is now able to be tracked in the Cooldown Manager.
    • Protection
        > The Venomous Abyss 2-set Bonus – The Vengeful Shield bonus Shield Slam damage
          buff can now be tracked in the Cooldown Manager.
        > Rend is now able to be tracked in the Cooldown Manager.
    • Bladestorm now displays as an important aura on nameplates.
    • Developers' notes: Arms and Fury Warriors provide strong group defensive utility
      through the Safeguard PvP talent, but the frequency of damage reduction prevented
      enemy teams from having a window of time to strike.
    • Arms
    ...
    • Protection
        > Fight Through the Flames reduces Magic damage by 8% (was 6%).
    • Developers' notes: Fury's 4-piece set bonus is currently overperforming, but
      Fury is in a good place overall and we don't want to disrupt that, so we're moving
      some of the value out of the 4-piece bonus and into Fury's baseline. Additionally,
      Slayer has been overperforming for both specs due to a bug causing Executioner to
      provide double value which was recently hotfixed. This fix has brought overall
      Arms performance down into our intended range, but we're happy with where Fury
      has been, so their baseline damage has been increased below to compensate for
      this fix as well as the set bonus change.
    • Fury
        > All damage increased by 6%.
        > Venomous Abyss 4-piece set bonus updated – Bloodthirst damage increased by
          10%, and during Recklessness, Bloodthirst increases the critical strike bonus
          of Recklessness by 3%, up to 6% (was 5%, up to 10%).
    • Protection
