...
CHARACTERS
    • EARTHEN
        > Developers' note: In Curse of Ula'tek, we are revisiting the amount of
          experience
          points gained when exploring zones. This will particularly impact the leveling
          speed
          for Earthen characters, who receive significantly more exploration experience
          via
          their Wide-Eyed Wonder racial ability. To compensate for the decrease in
          experience
          gains from exploring zones, we are increasing the benefits of Ingest Minerals
          for
          Earthen.
...
EVENTS
    • RITUAL SITES
        ...
        > The Tier 6 Advanced Ritual Studies quests will no longer offer a Nebulous
          Voidcore
          bonus roll reward. The quests remain available to complete for the relevant
          achievement.
    • VOID ASSAULTS
    ...
    • VAL AND NAIGTAL
        ...
        > The Mythic quest rewards from Knocking off the Top (Heroic) will also remain as
          Season
          1 rewards and can no longer be upgraded.

ITEMS
    • Class set vendor Kirana has relocated from near the March on Quel'danas raid
      entrance to
      near the Catalyst in Silvermoon and has expanded her stock to include Midnight
      Season 2
      class set armor in exchange for Slumbering Coil Curios.
    • THE CATALYST
    ...
    • RAID REWARDS
        > Raid Finder, Normal, and Heroic raid Great Vault rewards are now awarded at the
          first
          step of the next harder difficulty's upgrade track; for example, all Heroic raid
          vault
          rewards will be Myth 1/6.
        > Mythic raid Great Vault rewards are now awarded at Myth 6/6 apart from Very Rare
          items
          and loot from the penultimate and final bosses.
        > Mythic raid Very Rare items and loot from the penultimate and final bosses will
          be
          acquired at the equivalent of Myth 9 regardless of whether acquired directly
          from a
          boss drop or the Great Vault.
    • NEBULOUS VOIDCORES
        > Nebulous Voidcores acquired in Season 1 will be converted to gold upon the end
          of
          Season 1, and they may no longer be used in Season 1 content.
        ...
        > As in Season 1, items acquired using Nebulous Voidcores will continue to be
          equivalent
          to a Great Vault reward in terms of item level.
        > Orin Straylight has begun learning the basics of weaving Nebulous Voidcores from
          void
          energy and has relocated near the Catalyst in Silvermoon. He will be able to
          provide
          one additional Nebulous Voidcore per week starting the eighth week of Season 2.
    ...
    • Adjusted delve Coffer Key Shard amounts from multiple sources.
        > Developers' notes: We have tuned Coffer Key Shard acquisition to reflect the
          addition
          of more sources with the Curse of Ula'tek update. Our goal is to reward players
          who
          choose to spend their time engaging with new content in the Coiled Isles, while
          still
          providing players the ability to earn Coffer Key Shards from all sorts of
          outdoor
          features throughout Midnight. These adjustments are still ongoing and are a work
          in
          progress.
...
PLAYER VERSUS PVP
    • Players will no longer be affected by knockback effects while under the effects of
      Fear
      and Disorient crowd control.
    • Gladiator's Distinction (PvP Trinket Set Bonus) now increases primary stat by 15%
      (was
      12%) and Stamina by 5% (was 10%) for tank and damage dealer roles.
    ...
    • BATTLEGROUNDS
        > Developers' notes: We've observed player survivability in battlegrounds making
          combat
          less enjoyable, so we're making a change to reduce healing received which should
          allow
          for healers and off-healing abilities to be less powerful.
    ...
    • SOLO SHUFFLE AND BATTLEGROUND BLITZ
        > To reduce win trading and queue manipulation, now when a player misses a Solo
          Shuffle
          or Battleground Blitz queue, a 1-minute debuff prevents further queueing. The
          debuff
          stacks for consecutive missed queues within a window of time and is
          account-wide.
    • Spoils of War will grant 50% increased Conquest once Conquest has been uncapped for
      ...
      season (was 30%).
        > Developers' notes: We would like to speed up gearing for players who are
          participating
          late in the PvP season, so we are increasing Conquest gains from Spoils of War.
    • Developers' notes: In Curse of Ula'tek, we've decided to reduce the effectiveness of
      a
      large number of movement speed reductions in PvP. We have found in the past that
      when
      players have access to strong snares with a high uptime, there are less
      opportunities
      for enemies to use positioning and escape tactics. Our primary target has been
      strong
      snares that are auto applied during normal combat rotations, with some of the
      activated
      reductions retaining their strength. In general, we've reduced movement speed
      reductions
      'a tier' down, with 70% reduced to 50%, 50% to 30%, and so on.
    • DEATH KNIGHT
        ...
        > Unholy
            + Magus of the Dead Frostbolt movement slow reduced to 30% in PvP combat (was
              60%).
    • DEMON HUNTER
        > Hero Talents
            + Fel-Scarred
    ...
    • DRUID
        ...
        > Balance
            + Developers' notes: We are adding a new dispel protection passive for Balance
              Druids
              so they don't need to commit a PvP talent to protecting their Moonfire and
              Sunfire.
              This is similar to what has been done for other specializations like
              Elemental
              Shaman, and should increase their viability in arenas and battlegrounds.
            + New baseline passive, learned at level 42: Stellar Protection – If Moonfire
              and
              Sunfire are dispelled, Stellar Flare is applied to the target. Burns the
              target for
              36% Spell Power Astral damage, and then an additional 210% Spell Power
              damage over
              24 seconds. If dispelled, causes 212% Spell Power damage to the dispeller
              and blasts
              them upwards. Generates 12 Astral Power.
        ...
        > Restoration
            + Ancient of Lore (PvP Talent) has returned – Shapeshift into an Ancient of
              Lore,
              preventing all crowd control effects, reducing damage taken by 20%, and
              granting you
              access to Blossom Burst and Mass Blooming. Reduces movement speed.
              Blossoming Burst: Heals an ally for 910% of Spell power and applies 1
              missing heal
              over time effect. If all of them are present, Blossom Burst critically
              heals.
              Mass Blooming: Heals 5 allies for 585% of Spell power and applies 1 missing
              heal
              over time effect.
            ...
            + All healing reduced by 10% in PvP combat.
              Developers' notes: Restoration Druid is receiving several quality of life
              adjustments and buffs in this update. As a result, we're lowering some of
              the extra
              healing they were receiving in PvP combat.
    • EVOKER
        > Developers' notes: Unburdened Flight was frustrating for other players to deal
          with,
          particularly on capture the flag battlegrounds. With this new design, slowing an
          Evoker with Hover active will still have the effect of canceling out the
          Evoker's
          speed bonuses. The goal is to balance Evoker's kiting capabilities while still
          keeping
          them mobile and slippery.
        > Unburdened Flight now causes Hover to prevent movement speed from being reduced
          below
          100%, rather than granting immunity to movement-impairing effects.
    ...
    • HUNTER
        > Scatter Shot has returned as a PvP talent – A short-range shot that deals
          damage,
          removes all harmful damage over time effects, and incapacitates the target for 3
          seconds. Any damage caused will remove the effect. Turns off your attack when
          used.
    ...
    • MAGE
        ...
        > Arcane
            + Overpowered Barrier no longer grants Invisibility and immunity. Instead, it
              grants
              Time Warp for 6 seconds if the barrier is fully consumed.
        > Frost
    ...
    • PALADIN
        ...
        > Protection
            + Hero Talents
              Templar
              Divine Exaction causes Divine Toll to strike at 45% effectiveness in PvP
              combat.
        > Retribution
    ...
    • PRIEST
        > Discipline
            + Hero Talents
              Voidweaver
              Quickened Pulse causes Entropic Rift and Shadow Word: Pain to deal damage
              15% more
              often in PvP combat (was 25%).
              Expiation deals damage equal to 150% of the amount consumed (was 200%) in
              PvP
              combat.
        > Shadow
            + Mind Flay: Insanity movement slow reduced to 50% in PvP combat (was 70%).
            + Idol of C'Thun Mind Flay movement slow reduced to 20% in PvP combat (was
              30%).
    ...
    • WARLOCK
        ...
        > Bonds of Fel damage increased by 100%, and radius increased to 12 yards (was 8
          yards).
          Visual has been updated to better identify the boundaries for enemies.
        > Destruction
    ...
    • WARRIOR
        ...
        > Arms
            ...
            + Hero Talents
              Colossus
              Dominance of the Colossus reduces damage taken from enemies affected by
              Demolish
              by up to 10% in PvP combat.
...
USER INTERFACE AND ACCESSIBILITY
    ...
    • The World Map can now show map coordinates of the player and the cursor. Settings
      can be
      found under Gameplay > Interface.
    • Shift-clicking a map pin now also copies a slash command to your clipboard. The
      slash
      command (/mappin) can be shared outside the game and entered in chat to create the
      pin
      and open your map to it.
    ...
    • PING SYSTEM
        ...
        > Added the ability to ping player resources (such as health bars or health and
          mana
          bars for healers), displaying the information as a chat bubble.
        > Ping icons will now show on certain unit frames (target, focus, and raid) when
          that
          unit is pinged.
        > Ping System now has a new option to target the environment only, units only, or
          both.
        > Updated ping macros to support pinging spells or items. Added the following
          slash
          commands: /pingspell:1234 (or spell name) and /pingitem:1234 (or item name)
        > Adding the ability to use the [@cursor] target for ping macros. Using this will
          have
          the ping ignore all UI and units, and explicitly attempt to ping the environment
    ...
    • NAMEPLATES
        > New options added in Friendly Nameplates settings to show only the name, use
          class
          color for names, and hide realm name.
    ...
    • EDIT MODE
        ...
        > Raid and party frames now support the Frame Size setting that has been available
          for
          other unit frames. These frames can now be scaled up by 100%.
    ...
    • ADDONS
        > Added new APIs that allow addons to display filtered sets of auras in customized
          ways,
          without exposing the underlying aura information that could be used for
          automation.
        > New UI texture filenames will no longer be published to the
          ManifestInterfaceData DB.
          Existing filenames will remain available, and this change will not affect
          players.
          Addons will still be able to use these textures.
