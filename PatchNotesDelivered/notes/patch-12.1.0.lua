...
• Fixed an issue that allowed Blur's recent PvP adjustments to affect PvE situations.
    ...
    • Devourer
        ...
        > Blur now reduces damage taken by 15% in PvP combat (was 25%).
        > Armor of Souls now increases Armor by 65% (was 100%).
        > Developers' notes: Devourer's 4-piece set bonus is performing significantly above
          expectations, so we're reducing its power. To compensate for this set bonus
          reduction, we're increasing all ability damage. Additionally, Devourer has been
          overperforming, mostly in single target, so we are reducing the damage of
    ...
    • Havoc
        ...
        > All damage increased by 3%.
        > Blur now reduces damage taken by 15% in PvP combat (was 25%).
        > Desperate Instincts now reduces damage taken by 5% while below 35% health in PvP
          combat (was 10%).
...
• Shred damage increased by 10%.
    ...
    • Feral
        ...
        > Developers' notes: We're increasing Feral's general damage, especially for
          Druid of the Claw, and nudging down their defensiveness to speed up the pace of
          combat for Feral.
        > Ravage (Druid of the Claw) damage increased by 15% in PvP combat.
        > Survival Instincts reduces damage taken by 40% in PvP combat (was 50%).
...
• Developers' notes: Mages have been extending the duration of PvP matches with
    ...
    • Hero Talents
        > Spellslinger
            + Fixed an issue causing Splinters from Augury Abounds to sometimes strike
              crowd-controlled targets when other non-crowd controlled
              targets are available.
    • Arcane
        > Prismatic Barrier absorb reduced by 25% in PvP combat.
    ...
    • Fire
        ...
        > Resolved an issue where the 2-piece set bonus: Flamestrike did not correctly
          always grant Hot Streak when it is a guaranteed critical strike due to Pyroclasm.
        ...
        > Developers' notes: Fire Mage's Venomous Abyss tier set bonus is particularly
          ...
          the objective of increasing its usability. We're also decreasing Meteor's damage
          to reduce Fire Mage's burst capabilities.
        > Pyroblast damage increased by 10% in PvP combat.
        > Meteor damage decreased by 20% in PvP combat.
        > Comet Storm damage decreased by 20% in PvP combat.
...
• Brewmaster
    ...
    • Mistweaver
        ...
        > Developers' notes: Mistweaver has been underperforming so we are targeting
          increases to its casted healing and the Venomous Abyss 4-set bonus to improve its
          performance and maintain build diversity.
        > All healing increased by 8%. Does not affect PvP combat.
...
• Holy
    ...
    • Protection
        ...
        > Developers' note: Protection Paladins have been extending the duration of the
          ...
          reducing the effectiveness of Blessing of Sacrifice and Guardian of the Forgotten
          Queen to bring them in line.
        > Guardian of the Forgotten Queen duration reduced to 6 seconds.
        > Guardian of the Forgotten Queen cooldown increased to 4 minutes.
        > Guardian of the Forgotten Queen now has a 6 second internal cooldown.
...
• Fixed an issue where Flash Heal could not be tracked on the Cooldown Manager for
    ...
    • Shadow
        > Developers' notes: We feel Shadow is lacking in kill power, so we're increasing
          some of its primary sources of burst.
        > Shadow Word: Madness damage increased by 15% in PvP combat.
        > Void Volley damage increased by 15% in PvP combat.
        > Shadow Word: Death damage increased by 15% in PvP combat.
    ]=],
...
• Both versions of Thistle Tea can now be tracked in the Cooldown Manager.
    ...
    • Deathstalker: Fixed an issue where Deathstalker's Mark would be removed when a
      target becomes unattackable. Darkest Night will now be granted when Deathstalker's
    ...
    • Assassination
        ...
        > All damage increased by 4%.
    • Outlaw
        > Developers' notes: Outlaw's damage and kill pressure is lower than we'd expect, so
          we're putting more damage into core finishing moves.
        > Dispatch damage increased by 20% in PvP combat.
        > Between the Eyes damage increased by 12% in PvP combat.
    • Subtlety
...
• Corrected an issue where swapping between specs may incorrectly cause Lava Burst to
    ...
    • Elemental
        ...
        > All damage dealt increased by 5%.
            + Developers' notes: We discovered and fixed a tricky bug that was active on
              ...
              was inflating their damage dealt, so alongside the bug fix,
              we're increasing their damage to compensate.
    • Enhancement
    ...
    • Restoration
        ...
        > Totemic: Earthsurge now causes allies affected by your Earthliving to receive
          5% additional healing from you in PvP combat (was 15%).
        > Totemic: Corrected an issue where the Whirling Water effect was not
          properly working.
        ...
        > Storm Conduit now reduces the duration of interrupts on Lightning Bolt and
          Chain Lightning by 40% in PvP combat (was 65%).
...
• Developers' notes: We're increasing the throughput of Affliction and Demonology
      by primarily focusing on their single-target tools with a secondary focus on their
    ...
    • Fixed an issue where Warlock pets would continually learn Soul Leech.
    • Affliction
        > Hellcaller: Fixed an issue where Blackened Soul would not activate from Unstable
          Affliction applied via Fatal Echoes.
        > Unstable Affliction damage increased by 15%. Does not apply to PvP combat.
