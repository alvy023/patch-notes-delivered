...
• Unholy
    ...
    • Unholy
        ...
        > Resolved an issue causing Transfusion to not empower already summoned Lesser
          Ghouls.
    ...
    • Blood
        > Deathbringer
            + Resolved an issue causing Echoing Fury to grnt Exterminate stacks on
              Reaper's Mark casts.
        > San'layn
            + Visceral Strength now grants 6% strength (was 10%).
            + Transfusion increases Dancing Rune Weapon damage by 5% (was 10%).
...
• Devourer
    ...
    • Havoc
        > Aldrachi Reaver
            + Developers' notes: Aldrachi Reaver has fallen well behind the
              ...
              are improving some of its core effects for both specs, and for Havoc
              specifically the soul fragment generation from Broken Spirit is
              increasing to give a small boost to Fury generation and hasten the cycle
              of Reaver's Glaive and its bonuses.
            + Art of the Glaive now increases the damage of enhanced strikes by 15%
              (was 10%) and 30% (was 20%).
            + Reaver's Glaive damage increased by 25%.
            + Reaver's Mark now increases your damage to the target by 7% (was 6%).
    ...
    • Havoc
        > Aldrachi Reaver
            + Fixed an issue where Evasive Action was not granting an extra cast of
              Vengeful Retreat.
    • Devourer
...
• Hero Talents
    ...
    • Feral
        ...
        > Survival Instincts reduces damage taken by 40% in PvP combat (was 50%).
    • Restoration
        > Developers' notes: We're increasing Restoration's overall healing while at
          the same time reducing the power of Swiftmend and some of their mana
    ...
    • Restoration
        > Developers' notes: These changes are intended to address Rejuvenation and
          ...
          their raid healing to keep them around the same power in raid while
          increasing their power in dungeons.
        > 4-piece class set bonus increases Genesis duration by 8 seconds (was 4
          seconds).
        > Rejuvenation and Germination healing increased by 15%. Does not apply to PvP
          combat.
        > Wild Growth healing increased by 10%.
        > Nature's Bounty replicates 10% of Regrowth's healing (was 20%).
        > Everbloom heals 5 targets (was 6 targets).
    ...
    • Feral
        > Developers' notes: Feral's sustained damage is lower than our intended
          target, so we're targeting their primary damage over time effects to improve
          this. We're also targeting a buff for Druid of the Claw which has fallen
          behind Wildstalker in viability.
        > Druid of the Claw: Ravage damage increased by 20% in PvP combat.
        > Rip damage increased by 15% in PvP combat.
        > Rake damage increased by 15% in PvP combat.
    • Restoration
...
• Augmentation
        > Developers' notes: We're making some targeted adjustments to parts of
          Augmentation's kit that have lower representation in their breakdown than
          they should be relative to their intended strength or time spent performing
          them.
        > Eruption damage increased by 15%.
        > Fire Breath damage increased by 60%.
        > Upheaval damage increased by 40%.
    ...
    • Fixed an issue where staves were not being shown for Evokers on the PvP gear
      vendor.
    • Preservation
        > Fixed an issue where Rewind could fail to reverse damage taken on allies if
          the Evoker was affected by Cyclone.
...
• Wing Clip now reduces movement speed by 40% in PvP combat.
    ...
    • Survival
        > Developers' notes: We're increasing the damage that Wildfire Bomb deals to
          all targets, but reducing the bonus damage to the primary target. This
          should be a neutral change against a single target, but an increase to area
          damage when fighting more than one enemy.
        > Wildfire Bomb damage increased by 20%.
        > Wildfire Bomb now only hits the primary target for 50% additional damage
          (was 80% additional).
    • Beast Mastery
    ...
    • Beast Mastery
        > Developers' notes: Beast Mastery's damage during burst windows is higher
          than we'd like in PvP, reducing some of the abilities that can contribute to
          this situation.
        > Bloodshed damage reduced by 25% in PvP combat.
        > Bestial Wrath initial damage reduced by 10% in PvP combat.
        > Pack Leader: Stampede! damage reduced by 10% in PvP combat.
    ...
    • Survival
        > All damage dealt by you and your pets increased by 4%.
    • Developers' notes: Sentinel Hunters are slightly too strong during burst
      windows in PvP, so we're reducing the damage of Moonlight Chakram and increasing
      the throughput of rotational abilities to compensate.
    • Marksmanship
        > Sentinel: Moonlight Chakram damage reduced by 30% in PvP combat.
        > Rapid Fire damage increased by 15% in PvP combat.
        > Arcane Shot damage increased by 15% in PvP combat.
    ...
    • Beast Mastery
        > Corrected an issue where Dire Beast Kill Commands from the Wildspeaker
          Talent did not properly benefit from Killer Instinct, Alpha Predator,
          Specialized Arsenal, or Savagery.
    ]=],
    mageChangesPatch = [=[
• Arcane
        > Chrono Shift (PvP Talent) now reduces movement speed by 30% in PvP combat
          (was 50%).
    • Fire
    ...
    • Hero Talents
        > Spellslinger
            + Fixed an issue causing Splinters from Augury Abounds to sometimes
              strike crowd-controlled targets when other non-crowd controlled targets
              are available.
    • Fire
        > All ability damage increased by 3%. Does not apply to PvP combat.
    • Frost
    ...
    • Developers' notes: Mages have been extending the duration of PvP matches with
      ...
      effectiveness of their barriers and the cooldown of Ice Block. Fire damage is
      also being reduced to bring them in line with other specializations.
    • Improved Conjuration reduces the cooldown of Mirror Image by 15 sec in PvP
      combat.
    • Winter's Protection reduces Ice Block cooldown by 15/30 sec in PvP combat.
      Tooltip in PvP will be updated in a later patch.
    • Arcane
    ...
    • Fire
        ...
        > Molten Fury now increases damage to targets below 35% health by 10% in PvP
          combat (was 15%).
    • Arcane
        > Developers' notes: The Venomous Abyss set bonus is overperforming our
          target tuning for set bonuses. However, the amount we need to reduce its
          value by would be a greater impact than intended to Arcane's overall
          damage, so we are also making a small positive adjustment to Arcane's
          baseline.
        > All ability damage increased by 3%.
        > Venomous Abyss 2-piece set bonus updated – Arcane Missiles damage bonus
          reduced to 5% (was 20%).
        > Venomous Abyss 4-piece set bonus updated – Cumulative Power damage bonus
          per stack reduced to 3% (was 5%).
    ]=],
    monkChangesPatch = [=[
• Windwalker
...
• Consecrated Ground now reduces movement speed by 20% in PvP combat (was 50%).
    ...
    • Protection
        > Fixed an issue where Blessed Hammer could not hit Ula'tek's Venomous Heart.
    • Protection
        > Fixed an issue where Avenger's Shield could sometimes fail to activate
          Glory of the Vanguard while Divine Resonance was active.
    • Protection
        > All ability damage increased by 6%. Does not apply to PvP combat.
    • Retribution
        > Templar
            + Developers' notes: Templar has been underperforming compared to Herald
              of the Sun this season. We're increasing its throughput to make it a
              more viable option against Herald of the Sun, for those who enjoy
              Templar's playstyle.
            + Hammer of Light damage increased by 50%. Does not apply to PvP combat.
            + Empyrean Hammer damage increased by 12%.
    • Holy
    ...
    • Retribution
        > All ability damage increased by 6%. Does not affect PvP combat.
    • Holy
        > Developers' notes: Holy Paladin throughput has been higher than we would
    ...
    priestChangesPatch = [=[
• Developers' notes: We're increasing the effectiveness of Mindgames once more
      in this pass to solidify its usability. We'd like for it to be able to compete
      with other powerful PvP talent options in Priest's kit.
    • Mindgames direct damage and reversal increased by 50%.
    • Holy
        > Archon
            + Developers' notes: We feel Oracle Holy is in a good place, but Archon
              has difficulties keeping up, so we're targeting buffs to its throughout
              and offensive potential.
            + Halo damage and healing increased by 30% in PvP combat.
            + Focused Outburst now reduces the cast time of Prayer of Healing by 40%
              in PvP combat (was 15%).
            + Realized Potential now increases Flash Heal healing by 20% in PvP
              combat (was 10%).
    • Discipline
        > Atonement healing is no longer increased by 40% in PvP combat.
    • Shadow
        ...
        > Shadow Word: Death damage increased by 30% in PvP combat.
    • Holy
        > Fixed an issue where Renewed Vigor from the Venomous Abyss 2-piece tier
          bonus could exceed 3 stacks.
    • Fixed an issue where Flash Heal could not be tracked on the Cooldown Manager
      for Discipline and Shadow specializations.
    • Holy
    ...
    • Discipline
        > Developers' notes: Discipline could use some help, particularly
          Voidweaver, so we're increasing some of its absorption and Atonement
          healing capabilities to bring them on par with other healers.
        > Void Shield absorption increased by 15% in PvP combat.
        > Power Word: Shield absorption increased by 15% in PvP combat.
        > Atonement healing increased by 10% in PvP combat.
    • Holy
    ...
    • Holy
        > Corrected an issue where swapping from Shadow to Holy specializations
          could improperly cause Shadow Word: Pain to not turn into Holy Fire.
    ]=],
    rogueChangesPatch = [=[
• Assassination
        > All damage reduced by 4% in PvP combat.
    ...
    • Developers' notes: Rogues' defensive potential improves in coordinated play and
      as ratings increase, with the predictive effect of Preemptive Maneuver standing
      out as being too rewarding, so it's being brought down to be more appropriate.
    • Preemptive Maneuver now reduces damage taken by 25% while its effect is active
      (was 40%).
    • Assassination
        > All ability damage reduced by 4% in PvP combat.
    • Deathstalker: Fixed an issue where Deathstalker's Mark would be removed when a
      target becomes unattackable. Darkest Night will now be granted when
      Deathstalker's Mark is removed from an unattackable target.
    • Subtlety
        > Trickster
    ...
    • Assassination
        > Developers' notes: Burst from Assassination's Apex Talent is exceeding
          expectations and is getting toned down. Additionally, damage from Fatebound
          Coins is higher than intended and is being reduced.
        > Kingsbane initial damage reduced by 12% in PvP combat.
        > Implacable (Rank 3) Physical and Nature damage reduced by 15% in PvP
          combat.
        > Fatebound: Fatebound Coin (Tails) damage reduced by 10% in PvP combat.
    • Outlaw
        ...
        > Between the Eyes damage increased by 12% in PvP combat.
    • Subtlety
        > Developers' notes: Subtlety's steady damage pressure is low, without which
          it can be difficult to create windows that capitalize on their burst
          potential. We're increasing Eviscerate damage moderately and Goremaw's
          Bite bleed damage significantly to increase the frequency of these windows.
        > Eviscerate damage increased by 10% in PvP combat.
        > Goremaw's Bite bleeding damage increased by 33% in PvP combat.
    • Assassination
        > All damage increased by 4%.
...
• Elemental
    ...
    • Elemental
        ...
        > All damage dealt increased by 5%.
            + Developers' notes: We discovered and fixed a tricky bug that was
              active on the PTR, that was increasing the amount of free Maelstrom
              spending abilities Elemental Shaman could get from the Venomous Abyss
              4-piece set bonus. This was inflating their damage dealt, so alongside
              the bug fix, we're increasing their damage to compensate.
    • Enhancement
        > All damage increased by 5%.
    • Restoration
        > Developers' notes: We're making some targeted adjustments to primarily
          improve Farseer's viability as we begin season 2. We're also reducing the
          effectiveness of Storm Conduit which we feel has been too powerful under
          the right circumstances.
        > All healing increased by 4% in PvP combat.
        > Storm Conduit now reduces the cooldown of affected spells by 2 seconds
          (was 4 seconds).
        > Storm Conduit now reduces the duration of interrupts on Lightning Bolt and
          Chain Lightning by 40% (was 65%).
        > Farseer: Healing Wave, Healing Surge, and Chain Heal healing from
          Ancestors increased by 35% in PvP combat.
        > Farseer: Hydrobubble absorption increased by 35% in PvP combat.
...
• Affliction
    ...
    • Affliction
        > Unstable Affliction damage increased by 15%. Does not apply to PvP combat.
        > Hellcaller – Blackened Soul damage increased by 20%. Does not apply to PvP
          combat.
        > Wrath of Nathreza damage increased by 35%. Does not apply to PvP combat.
        > Shadow of Nathreza damage increased by 25%. Does not apply to PvP combat.
        > Agony damage increased by 20%. Does not apply to PvP combat.
    ...
    • Affliction
        > Developers' notes: We're increasing Affliction's ability to maintain
          spread pressure by adjusting Agony's damage and making a small adjustment
          to Unstable Affliction's backlash damage to make dispelling all their
          damage over time effects more punishing.
        > Agony damage increased by 50% in PvP combat.
        > Unstable Affliction backlash damage increased by 20%.
    • Demonology
        > Developers' notes: We feel too much of Demonology's damage is focused on
...
• Arms
    ...
    • Developers' notes: Warriors are in a good state overall, but we feel that
      Mountain Thane is a bit behind their partner hero specs on both Fury and Prot,
      so we're giving a small boost there to help Mountain Thane enjoyers.
    • Fury
        > Mountain Thane
            + Lightning Strike damage increased by 50%. Does not apply to PvP
              combat.
    ...
    • Developers' notes: Fury's 4-piece set bonus is currently overperforming, but
      Fury is in a good place overall and we don't want to disrupt that, so we're
      moving some of the value out of the 4-piece bonus and into Fury's baseline.
      Additionally, Slayer has been overperforming for both specs due to a bug
      causing Executioner to provide double value which was recently hotfixed. This
      fix has brought overall Arms performance down into our intended range, but
      we're happy with where Fury has been, so their baseline damage has been
      increased below to compensate for this fix as well as the set bonus change.
    • Fury
        > All damage increased by 6%.
