    ...
    • Blood
        ...
        > San'layn: Transfusion increases Dancing Rune Weapon damage by 5% (was 10%).
            + Developers' notes: The tooltip will be updated at a later date to reflect
              the new value.
    • Frost
        > Developers' notes: We're aiming to increase Frost Death Knight's performance in
          single target and two target cleave scenarios.
        ...
        > Venomous Abyss 2-piece set bonus updated – Now grants 1% attack speed per stack
          (was 2%), and now increases Icy Death Torrent damage by 2% per stack
          (was 4%).
    • Unholy
        ...
        > Resolved an issue causing Dread and Virulent Plague Erupt effects to not work as
          intended with the target damage modifiers and caster damage modifiers Foul
          Infections, Thrill of Blood, Incite Terror, Morbidity, Soul Reaper, Brittle, and
          the War debuff of Rune of the Apocalypse.
...
Demon Hunter
    • Fixed an issue that allowed Blur's recent PvP adjustments to affect PvE situations.
      Blur damage reduction outside of PvP is restored to previous intended values.
    • Developers' notes: We feel the defensive kits of Devourer and Havoc are too
      powerful, so we are reducing some of their passive and active defenses to make them
      more viable targets for opponents.
    ...
    • Devourer
        ...
        > Developers' notes: Devourer's 4-piece set bonus is performing significantly
          ...
          has been overperforming, mostly in single target, so we are reducing the damage
          of Reap/Cull/Eradicate while increasing the AoE damage portion of Eradicate to
        ...
        > Developers' notes: Devourer Demon Hunters are both very threatening and very
          defensible during Void Metamorphosis and Surrender to the Void has provided the
          opportunity to increase the duration of those windows too significantly, so its
          Fury generation effect is being reduced.
    ...
    • Vengeance
        > Developers' notes: Vengeance is still performing below expectations defensively,
          so universal mitigation effects are getting a buff. Additionally, Fel
          Devastation's effectiveness as a recovery tool has fallen behind as maximum
          health pools go up, so its healing is being increased.
...
Druid
    ...
    • Balance
        ...
        > Twin Moons' range is now increased by target combat reach, meaning it can spread
          to farther targets when attacking large enemies.
    ...
    • Feral
        > Apex Talent: Unseen Predator (Rank 1) now prefers targets that are not immune to
          damage or taking less than 5% physical damage.
        ...
        > Developers' notes: We're increasing Feral's general damage, especially for Druid
          of the Claw, and nudging down their defensiveness to speed up the pace of
          combat for Feral.
    ...
    • Restoration
        ...
        > Reforestation grants Incarnation: Tree of Life for 8 seconds in PvP combat (was
          10 seconds).
        > Swiftmend healing reduced by 20% in PvP combat.
        > Blossom Burst (Ancient of Lore PvP talent) costs 1.89% base mana (was free).
        > Blossom Burst (Ancient of Lore PvP talent) now prioritizes applying Rejuvenation
          over Lifebloom.
...
Evoker
    ...
    • Hero Talents
        > Chronowarden
            + Fixed an issue where Warp was still causing the player to become immune to
              snares while talented into Unburdened Flight.
        > Flameshaper
            + Fixed an issue where Lifecinders incorrectly stated that it required
              Renewing Blaze.
    • Augmentation
        > Developers' notes: Augmentation has been underplayed in PvP, especially arenas,
          for some time. We're increasing both their damage support capabilities and their
          personal damage to increase their viability.
    ...
    • Preservation
        > Fixed an issue where Stasis could be used in the starting room of arenas and
          battlegrounds to store spells for after the gates opened.
        > Fixed an issue where Rewind could fail to reverse damage taken on allies if the
          Evoker was affected by Cyclone.
...
Hunter
    ...
    • Developers' notes: Sentinel Hunters are slightly too strong during burst windows in
      PvP, so we're reducing the damage of Moonlight Chakram and increasing the
    ...
    • Beast Mastery
        ...
        > Developers' notes: Beast Mastery's damage during burst windows is higher than
          we'd like in PvP, reducing some of the abilities that can contribute to
          this situation.
        ...
        > Wild Thrash now deals 300% increased damage when striking more than 2 targets
          (was 200%).
        > Beast Cleave now causes your pets to strike nearby enemies for 70% of the damage
          dealt (was 55%).
        ...
        > Venomous Abyss 4-piece set bonus updated – Now causes Cobra Shot to benefit from
          Beast Cleave at 30% effectiveness per stack (was 20%) or strike your target for an
          additional 20% damage per stack (was 15%).
        > Corrected an issue where Dire Beast Kill Commands from the Wildspeaker Talent
          ...
          Arsenal, or Savagery.
    • Marksmanship
        > Fixed an issue where Aimed Shot was not properly playing its cast animation when
          using a gun or crossbow.
    ...
    • Survival
        > Corrected an issue where the initial damage of Wildfire Bomb would not happen if
          the Hunter was affected by crowd control effects while the bomb hit the target.
        > Corrected an issue where Strike As One would not deal damage with a Raptor Swipe
          that benefit from Tip of the Spear if Aspect of the Eagle is active.
        > All damage dealt by you and your pet increased by 7%. This increase is only 3%
          while engaged in PvP combat.
...
Mage
    • Developers' notes: Mages have been extending the duration of PvP matches with
      ...
      of their barriers and the cooldown of Ice Block. Fire damage is also being reduced
      to bring them in line with other specializations.
    • Improved Conjuration reduces the cooldown of Mirror Image by 15 sec in PvP combat.
    • Winter's Protection reduces Ice Block cooldown by 15/30 sec in PvP combat. Tooltip in
      PvP will be updated in a later patch.
    • Hero Talents
        > Spellslinger
    ...
    • Fire
        ...
        > Resolved an issue where the 2-piece set bonus: Flamestrike did not correctly
          ...
          to Pyroclasm.
        > Developers' notes: Fire Mage execute windows and hard cast Pyroblast damage have
          been higher than we would like, so we're reducing the effectiveness of Molten
          Fury and Pyroclasm in PvP.
        ...
        > Developers' notes: Fire Mage's Venomous Abyss tier set bonus is particularly
          difficult to take advantage of in PvP combat, so we're making a few tweaks with
          the objective of increasing its usability. We're also decreasing Meteor's
        ...
        > Venomous Abyss 4-piece set bonus updated – Now decreases the cast time of
          Pyroblast and Flamestrike by 30% (was 10%) and increases Pyroclasm's damage bonus
          by 5% (was 10%) in PvP combat.
    • Frost
        ...
        > Ice Barrier absorb amount increased to 35% of maximum health (was 30%). Does not
          apply to PvP combat.
...
Paladin
    • Holy
        ...
        > Developers' notes: Holy Paladin's throughput has been higher than we would like,
          and Judgment has been too effective as an offensive tool. Avenging Crusader's
          effectiveness is being increased to offset the decrease to Judgment's damage.
    ...
    • Protection
        ...
        > Developers' notes: We're adjusting Protection Paladin damage to help them keep
          up with other tanks, especially in dungeons.
        ...
        > Fixed an issue where Avenger's Shield could sometimes fail to activate Glory of
          the Vanguard while Divine Resonance was active.
        ...
        > Sacrifice of the Just reduces the cooldown of Blessing of Sacrifice by 30 seconds
          in PvP combat (was 60 seconds).
    • Retribution
        ...
        > Developers' notes: Retribution's personal durability has been higher than we
          ...
          damage has not been competitive with Herald of the Sun, so we're increasing some
          sources specific to its hero tree.
        ...
        > Templar: Seal of the Templar now increases the damage of Templar's Verdict by 35%
          (was 25%).
        ...
        > Developers' notes: Retribution had been contributing to longer PvP matches during
          Season 1 due to their frequent access to team utility. We're shifting some of
          that effectiveness into more consistent offensive power, and additionally giving
          Templar an increase to Hammer of Light damage so they are a solid offensive
        ...
        > Sacrifice of the Just now reduces Blessing of Sacrifice's cooldown by 30 seconds
          in PvP combat (was 60 seconds).
        > Unbreakable Spirit reduces the cooldown of affected spells by 20% in PvP combat
          (was 30%).
...
Priest
    ...
    • Developers' notes: Mindgames has fallen behind other spells and has been an
      underutilized talent for some time, so we're increasing its viability to offer all
      Priest specializations more PvP talent options.
    ...
    • Discipline
        ...
        > Developers' notes: Discipline could use some help, particularly Voidweaver, so
          we're increasing some of its absorption and Atonement healing capabilities to
          bring them on par with other healers.
        ...
        > Developers' notes: We're reducing Discipline's damage done and offsetting this
          ...
          overperforming compared to other healers. At the same time, we're increasing
          the damage of Entropic Rift to minimize the impact this will have on
          Voidweaver's dungeon viability and help maintain high damage as one of
          its strengths.
    ...
    • Holy
        ...
        > Developers' notes: Holy Priest is vastly overperforming due to a mixture of
          overall healing increases from the patch as well as some generous PvP specific
          healing increases to Prayer of Mending and Holy Word: Serenity. We're reducing
          these PvP increases to Prayer of Mending, Holy Word: Serenity, and Prompt
          Prognosis which are all powerful instant cast spells.
        ...
        > Words of the Wise now increases the healing of Holy Word: Serenity and Holy Word:
          Sanctify by 40% (was 10%). Does not affect PvP combat.
...
Rogue
    ...
    • Developers' notes: Rogues' defensive potential improves in coordinated play and as
      ratings increase, with the predictive effect of Preemptive Maneuver standing out as
      being too rewarding, so it's being brought down to be more appropriate.
    • Preemptive Maneuver now reduces damage taken by 25% while its effect is active
      (was 40%).
    • Hero Talents
        > Deathstalker
            + Fixed an issue where Deathstalker's Mark would be removed when a target
              becomes unattackable. Darkest Night will now be granted when Deathstalker's
              Mark is removed from an unattackable target.
    • Assassination
        > Fixed an issue allowing Caustic Spatter to trigger from non-class Nature damage
          sources, such as trinkets.
    ...
    • Outlaw
        > Developers' notes: Outlaw's damage and kill pressure is lower than we'd expect,
          so we're putting more damage into core finishing moves.
        > Dispatch damage increased by 20% in PvP combat.
        > Between the Eyes damage increased by 12% in PvP combat.
    • Subtlety
        > Developers' notes: Subtlety's steady damage pressure is low, without which it
          can be difficult to create windows that capitalize on their burst potential.
          We're increasing Eviscerate damage moderately and Goremaw's Bite bleed damage
          significantly to increase the frequency of these windows.
...
Shaman
    ...
    • Elemental
        > Developers' notes: Elemental's Farseer hero talent tree is performing better than
          expected defensively, and its Stormbringer hero talent tree is performing below
          expectations offensively. As a result we're targeting key effects of each type
          to adjust: Natural Harmony's improvements for the Nature's Guardian effect are
          being diminished, while multiple key Stormbringer effects (including Tempest
          itself) are receiving buffs intended to improve overall damage and
          burst potential.
        ...
        > Stormbringer: Natural Gift now increases Nature damage by 4% in PvP combat
          (was 2%).
        > Stormbringer: Stormcaller now increases Nature spell critical strike damage by
          10% in PvP combat (was 5%).
        > Farseer: Corrected an issue where Maelstrom Supremacy did not increase the
          healing of Healing Surge.
        > Developers' notes: Elemental is lacking the sustained pressure we expect, so
          we're targeting core damage sources to improve its viability.
    ...
    • Restoration
        ...
        > Developers' notes: Restoration Shaman is slightly too strong compared to other
          healers (barring Holy Priest). We're making some small adjustments to their
          mana and the Totemic hero talent tree to better balance their mana
          and throughput.
        > Mana regeneration is now reduced by 65% in PvP combat (was 60%).
        > Totemic: Splitstream now causes Healing Stream Totem to heal an additional ally
          at 15% effectiveness in PvP combat (was 30%).
        > Totemic: Earthsurge now causes allies affected by your Earthliving to receive 5%
          additional healing from you in PvP combat (was 15%).
        > Totemic: Corrected an issue where the Whirling Water effect was not
          properly working.
        > Developers' notes: We're making some targeted adjustments to primarily improve
          Farseer's viability as we begin season 2. We're also reducing the effectiveness
          of Storm Conduit which we feel has been too powerful under the
          right circumstances.
        > All healing increased by 4% in PvP combat.
        > Storm Conduit now reduces the cooldown of affected spells by 2 seconds (was
          4 seconds).
        > Storm Conduit now reduces the duration of interrupts on Lightning Bolt and Chain
          Lightning by 40% (was 65%).
        > Farseer: Healing Wave, Healing Surge, and Chain Heal healing from Ancestors
          increased by 35% in PvP combat.
...
Warlock
    ...
    • Hero Talents
        > Hellcaller
            + Fixed an issue where Blackened Soul could trigger from Unstable Affliction
              periodic damage.
            + Fixed an issue where Blackened Soul would not function with
              mouse-over casting.
    • Affliction
        ...
        > Developers' notes: We're increasing Affliction's ability to maintain spread
          pressure by adjusting Agony's damage and making a small adjustment to Unstable
          Affliction's backlash damage to make dispelling all their damage over time
          effects more punishing.
    ...
    • Demonology
        ...
        > Developers' notes: We feel too much of Demonology's damage is focused on Wicked
          Reaping and Power Siphon, so we're reducing the power of these effects and
          increasing overall damage through our game-wide Demonology changes above.
        ...
        > Power Siphon now increases the damage of your next 2 Demonbolts by 20% in PvP
          combat (was 30%).
...
Warrior
  ...
  • Arms, Fury
      > Slayer: Fixed a bug that was causing Executioner to have double the
        intended effect.
  • Arms
      > The Venomous Abyss 4-set Bonus – The Winding Up bonus Slam damage buff can now
  ...
  • Protection
      ...
      > Mountain Thane: Fixed an issue that would sometimes disable the bonus Thunder Clap
        damage from Crashing Thunder.
