    ...
    gameChangesHotfixes = {
        {
            ...
            text = [=[
Delves
    • Fixed issue where Valeera becomes unable to change talents and gain abilities after
      a faction change. Players experiencing this will need to enter a delve on the
      affected character, then leave the delve, and then log out to correct the issue.
            ]=],
        },
        {
...
• Blood
    > Developer's Note: San'layn is dealing quite a bit more damage in AoE than our
    ...
    > Deathbringer
        ...
        + Swift and Painful now increases Strength by 15% (was 10%).
• Frost
    > Developer's Note: Frost Death has been lacking in single target and two
      target cleave scenarios.
    > Frostreaper damage increased by 100%. Does not apply to PvP combat.
    > Obliterate damage increased by 10%. Does not apply to PvP combat.
• Unholy
    > Developer's Note: We're looking to increase Unholy Death Knight's damage
...
• PvP
    > Unholy
        + San'layn
            - Developer's Note: We would like to push for the San'layn hero talent
              tree to be a more viable option for Unholy Death Knights in PvP.
            - Inevitable now causes plagues to deal up to 60% increased damage
              based on the target's missing health (was 30%) in PvP combat.
            - Vampiric Strike damage increased by 100% in PvP combat.
• Frost
    > Developer's Note: We're aiming to increase Frost Death Knight's performance
      in single target and two target cleave scenarios.
    > Howling Blast main target damage increased by 15%.
    > Obliterate damage increased by 15%.
    > Frost Strike damage increased by 20%.
    > Melee damage increased by 10%.
• Developer's Note: Frost Death Knight has performed under our expectations at
  the beginning of Curse of Ula'tek, especially in the Venomous Abyss raid.
• Frost
    > All ability damage and melee damage increased by 6%.
    > Obliterate damage increased by 15%.
• Blood
    > San'layn
        ...
        + Transfusion increases Dancing Rune Weapon damage by 5% (was 10%).
            - Developer's Note: The tooltip will be updated at a later date to
...
• Devourer
    > Developer's Note: These changes are intended to primarily benefit the raid and
      single target performance of Annihilator hero talent builds and improve
...
• Havoc
    > Aldrachi Reaver
        + Developer's Note: Aldrachi Reaver has fallen well behind the alternative
          ...
          boost to Fury generation and hasten the cycle of Reaver's Glaive and its
          bonuses.
        + Art of the Glaive now increases the damage of enhanced strikes by 15%
          (was 10%) and 30% (was 20%).
        + Reaver's Glaive damage increased by 25%.
...
• Havoc
    > All damage increased by 4%. This does not affect PvP combat.
• Vengeance
    > Developer's Note: Vengeance is still performing below expectations
      defensively, so universal mitigation effects are getting a buff.
...
• PvP
    > Devourer
        + All ability damage increased by 5% in PvP combat.
    > Havoc
        + Rain from Above now deals damage equal to 6% of max health per bolt (was
          8%).
• PvP
    > Developer's Note: We feel the defensive kits of Devourer and Havoc are too
      powerful, so we are reducing some of their passive and active defenses to
      make them more viable targets for opponents.
    > Glimpse now reduces damage taken by 20% while active (was 25%).
    > Devourer
    ...
    > Havoc
        ...
        + Desperate Instincts now reduces damage taken by 5% while below 35%
          health in PvP combat (was 10%).
• Devourer
    > Developer's Note: Devourer's 4-piece set bonus is performing significantly
...
• PvP
    > Devourer
        + Developer's Note: Devourer Demon Hunters are both very threatening and
...
• Balance
    > All ability damage increased by 4%. Does not affect PvP combat.
• Feral
    > Developer's Note: Feral is performing below expectations, particularly in
...
• PvP
    > Innervate grants 20% mana in PvP combat (was 25%).
    > Feral
        + Developer's Note: We're increasing Feral's general damage, especially
          for Druid of the Claw, and nudging down their defensiveness to speed up
          the pace of combat for Feral.
        + Ravage (Druid of the Claw) damage increased by 15% in PvP combat.
        + Survival Instincts reduces damage taken by 40% in PvP combat (was 50%).
    > Restoration
        + Developer's Note: We're increasing Restoration's overall healing while
          at the same time reducing the power of Swiftmend and some of their mana
          regeneration talents. The goal is to better balance Restoration's
          healing kit to not be so reliant on Swiftmend to top up allies.
        + Potent Enchantments increases the duration of Incarnation: Tree of Life
          by 4 seconds in PvP combat (was 6 seconds).
        + Reforestation grants Incarnation: Tree of Life for 8 seconds in PvP
          combat (was 10 seconds).
        + Swiftmend healing reduced by 20% in PvP combat.
        + Blossom Burst (Ancient of Lore PvP talent) costs 1.89% base mana (was
          free).
        + Blossom Burst (Ancient of Lore PvP talent) now prioritizes applying
          Rejuvenation over Lifebloom.
        + Mass Blooming (Ancient of Lore PvP talent) costs 3.5% base mana (was
          free).
• Restoration
    > Developer's Note: These changes are intended to address Rejuvenation and
      Wild Growth feeling weak in season 2, particularly in dungeons. We're also
      increasing the power of the 4-piece class set to make sure it's an
      impactful and noticeable set bonus. These changes are accompanied by
      slight nerfs to their raid healing to keep them around the same power in
    ...
    > Nature's Bounty replicates 10% of Regrowth's healing (was 20%).
    > Everbloom heals 5 targets (was 6 targets).
    > Everbloom heals for 48% of Lifebloom's final heal (was 40%). Does not
      apply to PvP combat.
• PvP
    > Feral
        + Developer's Note: Feral's sustained damage is lower than our intended
          target, so we're targeting their primary damage over time effects to
          improve this. We're also targeting a buff for Druid of the Claw which
          has fallen behind Wildstalker in viability.
        + Druid of the Claw: Ravage damage increased by 20% in PvP combat.
        ...
        + Rake damage increased by 15% in PvP combat.
• Restoration
    > Developer's Note: We're increasing Restoration Druid's healing and damage
      as both aspects are underperforming relative to other healers.
    > All healing increased by 4%. Does not affect PvP combat.
    > All damage increased by 20%. Does not affect PvP combat.
• PvP
    > Restoration
        + Developer's Note: Restoration Druid received several changes in Curse
          of Ula'tek that improved its throughput beyond what we would like in
          PvP.
        + All healing reduced by 5% in PvP combat.
    ]=],
    evokerChangesPatch = [=[
• Augmentation
    > Developer's Note: We're making some targeted adjustments to parts of
      Augmentation's kit that have lower representation in their breakdown than
      they should be relative to their intended strength or time spent
      performing them.
    > Eruption damage increased by 15%.
    ...
    > Blistering Scales damage increased by 100%.
• Devastation
    > Developer's Note: Devastation's overall damage in M+ is slightly lower than
...
• PvP
    > Devastation
        + Developer's Note: The Devastation Flameshaper build is not being
          utilized much compared to Scalecommander. We're increasing the power
          of some Flameshaper focused spells to open up more options for them.
        + Disintegrate triggers Consume Flame at 200% effectiveness in PvP
          combat (was 150%).
        + Enkindle damage increased to 30% in PvP combat (was 20%).
        + Expanded Lungs increases damage of Fire Breath's periodic by 40% in
          PvP combat (was 30%).
    > Preservation
        + Mana regeneration is now reduced by 35% in PvP combat (was 30%).
• PvP
    > Augmentation
        + Developer's Note: Augmentation has been underplayed in PvP, especially
          arenas, for some time. We're increasing both their damage support
          capabilities and their personal damage to increase their viability.
        + Damage increased by 10% in PvP combat.
        + Ebon Might grants 10% primary stat in PvP combat (was 8%).
    ...
    hunterChangesPatch = [=[
• Marksmanship
    > Developer's Note: We're looking to increase the area damage capabilities of
      Marksmanship Hunters with these changes.
    > Trick Shots now causes Aimed Shot or Rapid Fire ricochets to hit for 75% of
      damage (was 60%).
    > Volley damage increased by 10%.
• Survival
    > Developer's Note: We're increasing the damage that Wildfire Bomb deals to
...
• Survival
    > All damage dealt by you and your pet increased by 7%. This increase is
      only 3% while engaged in PvP combat.
• PvP
    > Developer's Note: Sentinel Hunters are slightly too strong during burst
      windows in PvP, so we're reducing the damage of Moonlight Chakram and
      increasing the throughput of rotational abilities to compensate.
    > Marksmanship
        + Sentinel: Moonlight Chakram damage reduced by 30% in PvP combat.
    ...
    > Survival
        ...
        + Kill Command damage increased by 15% in PvP combat.
• Beast Mastery
    > Developer's Note: We're looking to increase Beast Mastery area damage and
      cleave capabilities.
    > Wild Thrash now deals 300% increased damage when striking more than 2
      targets (was 200%).
    > Beast Cleave now causes your pets to strike nearby enemies for 70% of the
...
• PvP
    > Beast Mastery
        + Developer's Note: Beast Mastery's damage during burst windows is
          higher than we'd like in PvP, reducing some of the abilities that can
          contribute to this situation.
        + Bloodshed damage reduced by 25% in PvP combat.
        + Bestial Wrath initial damage reduced by 10% in PvP combat.
        + Pack Leader: Stampede! damage reduced by 10% in PvP combat.
• Beast Mastery
    > Developer's Note: The new Venomous Abyss tier set bonus isn't quite as
      strong as we would like it to be, so we're increasing the effects of the
      4-piece set bonus.
    > Venomous Abyss 4-piece set bonus updated – Now causes Cobra Shot to
      benefit from Beast Cleave at 30% effectiveness per stack (was 20%) or
      strike your target for an additional 20% damage per stack (was 15%).
    ]=],
    mageChangesPatch = [=[
• Developer's Note: For both Fire and Frost, these changes are intended to
  primarily improve performance in M+, with a smaller impact in raids.
• Fire
...
• PvP
    > Fire
        + Developer's Note: We feel Fire Mage burst damage continues to be too
          high even outside of Combustion, so we're further reducing the damage
          bonus from Pyroclasm to lessen its potential to lead to quick kills.
        + Pyroclasm now increases the damage of Pyroblast or Flamestrike by 160%
          in PvP combat (was 180%).
• Fire
    > All ability damage increased by 3%. Does not apply to PvP combat.
• Frost
    > All ability damage increased by 6%.
• PvP
    > Developer's Note: Mages have been extending the duration of PvP matches
      with frequent access to strong defensive abilities, so we're reducing the
      effectiveness of their barriers and the cooldown of Ice Block. Fire damage
      is also being reduced to bring them in line with other specializations.
    ...
    > Frost
        + Ice Barrier absorb reduced by 25% in PvP combat.
• Frost
    > Developer's Note: We're primarily focused on Frost's performance in Mythic
      Keystone dungeons. The recent removal of the health increase from
      Improved Ice Barrier had a greater effect on Frost's overall survivability
      than intended. We like the symmetry of the three Improved Barrier talents
      having one additional effect, and Frost has historically had a slightly
      larger absorb than Arcane and Fire, so we're baking it into the baseline
      absorb amount rather than re-attaching it to Improved Ice Barrier. We're
      also making some targeted increases to Frost's area of effect damage.
    > Ice Barrier absorb amount increased to 35% of maximum health (was 30%).
      Does not apply to PvP combat.
    > Blizzard damage increased by 10%.
    > Frostbite Talent: Shatter damage to nearby enemies increased by 10%.
...
• PvP
    > Fire
        + Developer's Note: Fire Mage execute windows and hard cast Pyroblast
          damage have been higher than we would like, so we're reducing the
          effectiveness of Molten Fury and Pyroclasm in PvP.
        + Burnout now explodes for 50% of remaining Ignite damage in PvP combat
          (was 75%).
        + Pyroclasm now increases the damage of Pyroblast and Flamestrike by
          180% in PvP combat (was 230%).
        + Molten Fury now increases damage to targets below 35% health by 10%
          in PvP combat (was 15%).
• Arcane
    > Developer's Note: The Venomous Abyss set bonus is overperforming our
...
• PvP
    > Fire
        + Developer's Note: Fire Mage's Venomous Abyss tier set bonus is
          particularly difficult to take advantage of in PvP combat, so we're
          making a few tweaks with the objective of increasing its usability.
          We're also decreasing Meteor's damage to reduce Fire Mage's burst
          capabilities.
        + Pyroblast damage increased by 10% in PvP combat.
        + Meteor damage decreased by 20% in PvP combat.
        + Comet Storm damage decreased by 20% in PvP combat.
        + Venomous Abyss 4-piece set bonus updated – Now decreases the cast
          time of Pyroblast and Flamestrike by 30% (was 10%) and increases
          Pyroclasm's damage bonus by 5% (was 10%) in PvP combat.
    ]=],
    monkChangesPatch = [=[
• Mistweaver
    > All healing increased by 5%. Does not apply to PvP combat.
...
• Windwalker
    ...
    > Rising Sun Kick damage increased by 8%. Does not apply to PvP combat.
• PvP
    > Developer's Note: We're decreasing the performance gap between Windwalker's
    ...
    > Shado-Pan
        + Flurry Strikes damage reduced by 15% in PvP combat.
• Mistweaver
    > Developer's Note: We're looking to increase Mistweavers' healing
      capabilities while increasing their 4-piece set bonus value.
    > All healing done increased by 5%.
...
• PvP
    > Windwalker
        + Rushing Wind Kick damage reduced by 20% in PvP combat.
        + Rising Sun Kick damage reduced by 10% in PvP combat.
        + Tigereye Brew now increases critical strike damage by 3/6% in PvP
          combat (was 5/10%).
• Brewmaster
    > Developer's Note: We're adjusting the absorption of Celestial Brew and
      Celestial Infusion to improve its impact as a defensive option and to
      help address pain points players are experiencing in some encounters.
    > All damage increased by 3%.
    > Celestial Brew and Celestial Infusion absorb value increased by 20%.
• Mistweaver
    > Developer's Note: Mistweaver has been underperforming so we are targeting
      increases to its casted healing and the Venomous Abyss 4-set bonus to
      improve its performance and maintain build diversity.
    > All healing done increased by 8%.
    > Venomous Abyss 4-piece set bonus updated – Activation rate increased by
      33%.
    ]=],
    paladinChangesPatch = [=[
• Protection
...
• Retribution
    > Templar
        + Developer's Note: Templar has been underperforming compared to Herald
...
• PvP
    > Retribution
        + Templar
            - Developer's Note: We're bringing Templar's performance up also in
              PvP, but we believe the gap to Herald of the Sun is less drastic
              compared to PvE.
            - Hammer of Light damage increased by 20%.
• Protection
    > Developer's Note: We're adjusting Protection Paladin damage to help them
...
• PvP
    > Holy
        + Developer's Note: Holy Paladin throughput has increased with recent
          changes past our targets for them in PvP.
        + All healing reduced by 4% in PvP combat.
    > Protection
        + Developer's Note: Protection Paladins have been extending the
          duration of the matches that they participate in with frequent
          access to group utility. We're reducing the effectiveness of
          Blessing of Sacrifice and Guardian of the Forgotten Queen to bring
          them in line.
        + Guardian of the Forgotten Queen duration reduced to 6 seconds.
        + Guardian of the Forgotten Queen cooldown increased to 4 minutes.
        + Guardian of the Forgotten Queen now has a 6 second internal cooldown.
        + Sacrifice of the Just reduces the cooldown of Blessing of Sacrifice
          by 30 seconds in PvP combat (was 60 seconds).
    > Retribution
        + Developer's Note: Retribution's personal durability has been higher
          than we would like considering their complete team defensive
          package, and Templar's damage has not been competitive with Herald
          of the Sun, so we're increasing some sources specific to its hero
          tree.
        + Shield of Vengeance absorption reduced by 25% in PvP combat.
        + Divine Protection now reduces damage taken by 20% in PvP combat (was
          25%).
        + Templar: Seal of the Templar now increases the damage of Templar's
          Verdict by 35% (was 25%).
        + Templar: Hammer of Light's damage increased by 10% in PvP combat.
• Retribution
    > Developer's Note: We're increasing the damage of the Curse of Ula'tek
      4-piece set bonus Divine Arbiter significantly, to make sure its
      rotational ask is worth executing.
    > Class Set 4-piece Divine Arbiter main target damage increased by 150%.
    > Class Set 4-piece Divine Arbiter secondary target damage increased by
      75%.
• Retribution
    > All ability damage increased by 6%. Does not affect PvP combat.
• PvP
    > Holy
        + Developer's Note: Holy Paladin's throughput has been higher than we
          would like, and Judgment has been too effective as an offensive
          tool. Avenging Crusader's effectiveness is being increased to
          offset the decrease to Judgment's damage.
        + All healing decreased by 5% in PvP combat.
        + Judgment damage decreased by 30% in PvP combat.
        + Avenging Crusader now transfers 80% of damage done into healing in
          PvP combat (was 55%).
    > Retribution
        + Developer's Note: Retribution had been contributing to longer PvP
          matches during Season 1 due to their frequent access to team
          utility. We're shifting some of that effectiveness into more
          consistent offensive power, and additionally giving Templar an
          increase to Hammer of Light damage so they are a solid offensive
          alternative to Herald of the Sun.
        + All damage increased by 8% in PvP combat.
        + Final Verdict damage increased by 15% in PvP combat.
        + Hammer of Light damage increased by 25% in PvP combat.
        + Sacrifice of the Just now reduces Blessing of Sacrifice's cooldown
          by 30 seconds in PvP combat (was 60 seconds).
        + Unbreakable Spirit reduces the cooldown of affected spells by 20%
          in PvP combat (was 30%).
    ]=],
    priestChangesPatch = [=[
• Discipline
    > Developer's Note: Discipline isn't able to dish out proper healing in
      dungeon environments due to how strong Atonement is in raids. We're
      reintroducing an Atonement healing bonus outside of raid environments and
      significantly increasing Atonement healing outside raid to help
      Discipline shine in dungeons.
    ...
    > Penance mana cost reduced by 20%.
• Shadow
    > Developer's Note: We feel Shadow is lacking in single target damage, so
      these changes are intended to improve Shadow's damage against singular
      targets while remaining neutral in multi-target situations.
    > Mind Blast damage increased by 15%.
    > Void Blast damage increased by 15%.
    ...
    > Shadeburst damage reduced by 5%. Does not apply to PvP combat.
• PvP
    > Developer's Note: We're increasing the effectiveness of Mindgames once
    ...
    > Holy
        + Archon
            - Developer's Note: We feel Oracle Holy is in a good place, but
              Archon has difficulties keeping up, so we're targeting buffs to
              its throughout and offensive potential.
            - Halo damage and healing increased by 30% in PvP combat.
            - Focused Outburst now reduces the cast time of Prayer of Healing
              by 40% in PvP combat (was 15%).
            - Realized Potential now increases Flash Heal healing by 20% in
              PvP combat (was 10%).
    > Discipline
        + Atonement healing is no longer increased by 40% in PvP combat.
    > Shadow
        + Developer's Note: We're increasing the damage of Shadow Word: Death
          significantly in addition to the Mind Blast changes above to allow
          for more opportunities to finish enemies off.
        + Shadow Word: Death damage increased by 30% in PvP combat.
• Discipline
    > Shadow Mend mana cost reduced by 20%.
• PvP
    > Developer's Note: Mindgames has fallen behind other spells and has been an
      underutilized talent for some time, so we're increasing its viability to
      offer all Priest specializations more PvP talent options.
    > Mindgames direct damage increased by 150%.
    > Mindgames healing and damage reversal increased by 150%.
    > Discipline
        ...
        + Atonement healing increased by 5% in PvP combat.
    > Holy
        + Developer's Note: Holy Priest is vastly overperforming due to a
          mixture of overall healing increases from the patch as well as some
          generous PvP specific healing increases to Prayer of Mending and
          Holy Word: Serenity. We're reducing these PvP increases to Prayer of
          Mending, Holy Word: Serenity, and Prompt Prognosis which are all
          powerful instant cast spells.
        + Enlightenment regenerates mana 10% faster in PvP combat (was 25%).
        + Prayer of Mending healing reduced by 25% in PvP combat.
        + Holy Word: Serenity healing reduced by 15% in PvP combat.
        + Oracle: Prompt Prognosis healing reduced by 25% in PvP combat.
    > Shadow
        + Developer's Note: We feel Shadow is lacking in kill power, so we're
          increasing some of its primary sources of burst.
        + Shadow Word: Madness damage increased by 15% in PvP combat.
        + Void Volley damage increased by 15% in PvP combat.
        + Shadow Word: Death damage increased by 15% in PvP combat.
• Discipline
    > Developer's Note: We're reducing Discipline's damage done and offsetting
      this in Atonement to not affect their overall healing, as their damage
      has been overperforming compared to other healers. At the same time,
      we're increasing the damage of Entropic Rift to minimize the impact this
      will have on Voidweaver's dungeon viability and help maintain high
      damage as one of its strengths.
    > All damage reduced by 30%. Does not affect PvP combat.
    > Oracle: Entropic Rift damage increased by 20%.
    > Oracle: Atonement now transfers 46% of damage into healing (was 32%).
      Does not affect PvP combat.
    > Oracle: Void Shield reflects 10% of damage (was 15%).
• Holy
    > Developer's Note: We're increasing the healing throughput of Oracle so
      that it can serve as a competitive option against Archon. Furthermore,
      we are increasing the mana regeneration of Enlightenment to further
      help Holy Priest's mana economy.
    > Enlightenment now regenerates mana 25% faster (was 10%).
    > Words of the Wise now increases the healing of Holy Word: Serenity and
      Holy Word: Sanctify by 40% (was 10%). Does not affect PvP combat.
...
• Subtlety
    > Trickster
        + Developer's Note: Trickster has performed well below Deathstalker for
          Subtlety this tier and is receiving damage boost to its core effects
          to make Trickster a more reasonable choice in a wider range of
          content.
        + Unseen Blade damage increased by 50%. Does not apply to PvP combat.
        + Coup de Grace damage increased by 30%. Does not apply to PvP combat.
• PvP
...
• Assassination
    > All damage increased by 4%.
• Subtlety
    > Developer's Note: Subtlety's 4-piece set bonus is overperforming
      expectations, so its effectiveness is being reduced. An overall buff to
      Subtlety's damage is being applied to compensate.
    > All damage increased by 6%.
    > The Venomous Abyss 4-set bonus has been updated – Effectiveness reduced
      to 60% (was 100%).
    > Shadow Dance now cancels when swapping talents.
    > Shadow Dance can no longer be cancelled manually.
    > Deathstalker: Lingering Darkness now cancels when swapping talents.
    > Deathstalker: Lingering Darkness now cancels when a raid encounter
      starts.
    > Deathstalker: Lingering Darkness now cancels when an M+ dungeon starts.
• PvP
    > Developer's Note: Rogues' defensive potential improves in coordinated
...
• PvP
    > Assassination
        + Developer's Note: Burst from Assassination's Apex Talent is exceeding
          expectations and is getting toned down. Additionally, damage from
          Fatebound Coins is higher than intended and is being reduced.
        + Kingsbane initial damage reduced by 12% in PvP combat.
        + Implacable (Rank 3) Physical and Nature damage reduced by 15% in PvP
          combat.
        + Fatebound: Fatebound Coin (Tails) damage reduced by 10% in PvP
          combat.
    > Outlaw
        + Developer's Note: Outlaw's damage and kill pressure is lower than
          we'd expect, so we're putting more damage into core finishing moves.
        + Dispatch damage increased by 20% in PvP combat.
        + Between the Eyes damage increased by 12% in PvP combat.
    > Subtlety
        + Developer's Note: Subtlety's steady damage pressure is low, without
          which it can be difficult to create windows that capitalize on their
          burst potential. We're increasing Eviscerate damage moderately and
          Goremaw's Bite bleed damage significantly to increase the frequency
          of these windows.
        + Eviscerate damage increased by 10% in PvP combat.
        + Goremaw's Bite bleeding damage increased by 33% in PvP combat.
    ]=],
...
• PvP
    > Elemental
        + Developer's Note: We feel Elemental should shine more in their damage
          against their primary target and less in their cleave, so we're
          making some improvement to core spell damage and reducing the effect
          of the Voltaic Blaze and Purging Flames combo.
        + Lightning Bolt damage increased by 25% in PvP combat.
        + Lava Burst damage increased by 15% in PvP combat.
        + Voltaic Blaze instant damage reduced by 25% in PvP combat.
        + Purging Flames now causes Lava Bursts to fire at 25% effectiveness in
          PvP combat (was 40%).
    > Enhancement
        + All damage increased by 3% in PvP combat.
• PvP
    > Elemental
        + Developer's Note: Elemental is lacking the sustained pressure we
          expect, so we're targeting core damage sources to improve its
          viability.
        + Stormbringer: Tempest damage increased by 10% in PvP combat.
        + Lava Burst damage increased by 10% in PvP combat.
        + Earth Shock damage increased by 10% in PvP combat.
        + Earthquake damage increased by 10% in PvP combat.
    > Restoration
        + Developer's Note: Restoration Shaman is slightly too strong compared
          to other healers (barring Holy Priest). We're making some small
          adjustments to their mana and the Totemic hero talent tree to better
          balance their mana and throughput.
        + Mana regeneration is now reduced by 65% in PvP combat (was 60%).
        + Totemic: Splitstream now causes Healing Stream Totem to heal an
          additional ally at 15% effectiveness in PvP combat (was 30%).
        + Totemic: Earthsurge now causes allies affected by your Earthliving
          to receive 5% additional healing from you in PvP combat (was 15%).
• PvP
    > Restoration
        + Developer's Note: We're making some targeted adjustments to
          primarily improve Farseer's viability as we begin season 2. We're
          also reducing the effectiveness of Storm Conduit which we feel has
          been too powerful under the right circumstances.
        + All healing increased by 4% in PvP combat.
        + Storm Conduit now reduces the cooldown of affected spells by 2
          seconds (was 4 seconds).
        + Storm Conduit now reduces the duration of interrupts on Lightning
          Bolt and Chain Lightning by 40% (was 65%).
        + Farseer: Healing Wave, Healing Surge, and Chain Heal healing from
          Ancestors increased by 35% in PvP combat.
        + Farseer: Hydrobubble absorption increased by 35% in PvP combat.
• Elemental
    > Developer's Note: We discovered and fixed a tricky bug that was active on
      the PTR, that was increasing the amount of free Maelstrom spending
...
• PvP
    > Elemental
        + Developer's Note: Elemental's Farseer hero talent tree is performing
          better than expected defensively, and its Stormbringer hero talent
          tree is performing below expectations offensively. As a result we're
          targeting key effects of each type to adjust: Natural Harmony's
          improvements for the Nature's Guardian effect are being diminished,
          while multiple key Stormbringer effects (including Tempest itself)
          are receiving buffs intended to improve overall damage and burst
          potential.
        + Farseer: Natural Harmony now reduces the cooldown of Nature's
          Guardian by 10 seconds in PvP combat (was 15 seconds).
        + Stormbringer: Tempest damage increased by 20% in PvP combat.
        + Stormbringer: Natural Gift now increases Nature damage by 4% in PvP
          combat (was 2%).
        + Stormbringer: Stormcaller now increases Nature spell critical
          strike damage by 10% in PvP combat (was 5%).
    > Enhancement
        + Developer's Note: Enhancement is on the weaker side offensively, so
          we're increasing some of its sustained damage while also reducing
          its healing capabilities slightly.
        + Healing Surge healing reduced by 20% in PvP combat.
...
• PvP
    > Affliction
        + Developer's Note: We're increasing Affliction's ability to maintain
          spread pressure by adjusting Agony's damage and making a small
          adjustment to Unstable Affliction's backlash damage to make
          dispelling all their damage over time effects more punishing.
        + Agony damage increased by 50% in PvP combat.
        + Unstable Affliction backlash damage increased by 20%.
    > Demonology
        + Developer's Note: We feel too much of Demonology's damage is focused
          on Wicked Reaping and Power Siphon, so we're reducing the power of
          these effects and increasing overall damage through our game-wide
          Demonology changes above.
        + Soul Harvester: Wicked Reaping damage reduced by 50% in PvP combat.
        + Soul Harvester: Necrolyte Teachings now causes Power Siphon to
          increase the damage of Demonbolt by an additional 10% in PvP combat
          (was 20%).
        + Power Siphon now increases the damage of your next 2 Demonbolts by
          20% in PvP combat (was 30%).
    > Destruction
        + Developer's Note: Destruction is lacking in finishing power, so
          we're increasing the damage of their primary nuke spells to allow
          for more burst potential.
        + Chaos Bolt damage increased by 15% in PvP combat.
        + Shadowburn damage increased by 30% in PvP combat.
• Developer's Note: We're increasing the throughput of Affliction and
  Demonology by primarily focusing on their single-target tools with a
  secondary focus on their multi-target kit. Additionally, we're considerably
  increasing the damage of Warlock demons so that they have a larger
  contribution to overall throughput. This should also help a bit more with
...
• Imp, Voidwalker, Sayaad, and Felhunter damage increased by 350%.
• Affliction
    > Unstable Affliction damage increased by 15%. Does not apply to PvP
      combat.
    > Hellcaller – Blackened Soul damage increased by 20%. Does not apply to
      PvP combat.
    > Wrath of Nathreza damage increased by 35%. Does not apply to PvP combat.
    ...
    > Agony damage increased by 20%. Does not apply to PvP combat.
    > Corruption damage increased by 15%. Does not apply to PvP combat.
    > Hellcaller – Wither damage increased by 10%. Does not apply to PvP
      combat.
• Demonology
    > Shadow Bolt damage increased by 35%. Does not apply to PvP combat.
    > Demonbolt damage increased by 30%.
...
• Demonology
    > Burning Cleave (granted by Antoran Armaments) now strikes enemies in a
      circular area, rather than a cone. The tooltip for Burning Cleave will
      be updated in a future patch.
    > Developer's Note: We are increasing the throughput of the Venomous Abyss
...
• PvP
    ...
    warriorChangesPatch = [=[
• Developer's Note: Warriors are in a good state overall, but we feel that
  Mountain Thane is a bit behind their partner hero specs on both Fury and
  Prot, so we're giving a small boost there to help Mountain Thane enjoyers.
• Fury
    > Mountain Thane
        + Lightning Strike damage increased by 50%. Does not apply to PvP
          combat.
        + Ground Current damage increased by 50%. Does not apply to PvP
          combat.
• Protection
    > Mountain Thane
        + Lightning Strike damage increased by 50%. Does not apply to PvP
...
• PvP
    > Arms
        + Colossus
            - Developer's Note: We're increasing the effectiveness of Colossus
              for Arms in PvP to increase hero talent viability with a focus
              on improving the effectiveness of your post-Demolish window.
            - Practiced Strikes increases the damage of Slam and Mortal
              Strike by 40% in PvP combat (was 25%).
            - Arterial Bleed now increases Rend and Deep Wounds damage by 5%
              per stack in PvP combat (was 3%).
            - Cut to the Bone now increases Rend and Deep Wounds damage by
              30% in PvP combat (was 15%).
• PvP
    > Developer's Note: Arms and Fury Warriors provide strong group defensive
...
• PvP
    > Arms
        + Developer's Note: To compensate for the reduction in Fueled by
          Violence self-healing, we're increasing Arms' Hero Talents
          throughput by increasing Slayer's Strike and Demolish damage in
          PvP.
        + Colossus: Demolish damage increased by 15% in PvP combat.
        + Slayer: Slayer's Strike damage increased by 5% in PvP combat.
        + Fueled by Violence healing reduced by 15% in PvP combat.
• Developer's Note: Fury's 4-piece set bonus is currently overperforming, but
  ...
  causing Executioner to provide double value which was recently hotfixed.
  This fix has brought overall Arms performance down into our intended range,
  but we're happy with where Fury has been, so their baseline damage has been
  increased below to compensate for this fix as well as the set bonus change.
• Fury
    > All damage increased by 6%.
    > Venomous Abyss 4-piece set bonus updated – Bloodthirst damage increased
      by 10%, and during Recklessness, Bloodthirst increases the critical
      strike bonus of Recklessness by 3%, up to 6% (was 5%, up to 10%).
    ]=],
    addonChanges = {
        {
            date = "August 5, 2026",
