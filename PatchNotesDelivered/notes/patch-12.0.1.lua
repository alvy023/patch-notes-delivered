...
February 20, 2026
    ...
    Housing
        ...
        • Players who have earned promotional decor can find most of it now properly sold by the promotional decor resupply vendors: Tuuran
          in Stormwind and Gabbi in Orgrimmar.
...
February 19, 2026
    ...
    Classes
        ...
        • Evoker
            ...
            > Augmentation
                + Source of Magic, Blistering Scales, Reactive Hide, Timelessness, and Aspect's Favor can now be tracked in the
                  Cooldown Manager.
            > Devastation
                + Source of Magic can now be tracked in the Cooldown Manager.
            > Preservation
                + Fixed an issue where the instant healing portion of Dream Breath was not benefitting from Fulminous Roar and Expanded
                  Lungs when empowering beyond rank 1.
                ...
                + Fixed an issue where Flow State was not properly increasing the cooldown recharge rate of Fire Breath, Dream Breath,
                  and Verdant Embrace.
                + Source of Magic can now be tracked in the Cooldown Manager.
        • Hunter
        ...
        • Paladin
            ...
            > Protection
                + Lightsmith: Fixed an issue where Hammer and Anvil didn't activate from Hammer of Wrath when Sweeping Verdict was
                  talented.
            > Retribution
        ...
        • Shaman
            > Mana Spring now accumulates its mana restoration and grants it every few seconds instead of occurring immediately on each
              cast of Riptide, Lava Burst, or Stormstrike.
            > Fixed a bug causing Mana Spring to not scale up to level 90.
        • Warlock
            > Fixed an issue where Hand of Gul'dan and Shadow Bolt were not usable in the Cooldown Manager if the Warlock was not a
              Diabolist.
...
February 17, 2026
    ...
    Classes
        ...
        • Mage
            ...
            > Frost
                + Developers’ notes: We’re moving damage out of baseline Frost and into the Hero Talents to help give us more precise
                  control over each Hero Talent’s performance in different content. We’re also slightly reducing Frostfire’s area
                  damage.
        ...
        • Paladin
            > Lightsmith: Fixed an issue that caused Ringing of the Heavens to not properly apply Holy Armaments to a friendly target
            ...
            > Holy
                ...
                + Developers’ notes: These changes should result in a net neutral change for Judgment and Consecration, a slight buff
                  for Shield of the Righteous and Crusader Strike, and a larger buff for Holy Shock and Hammer of Wrath.
        • Priest
            > Discipline
        ...
        • Shaman
            ...
            > Elemental
                ...
                + Fixed an issue causing Master of the Elements to not increase the damage of Voltaic Blaze and the Flame Shocks it
                  applies.
            > Enhancement
                + Fixed an issue causing the base Voltaic Blaze spell to be in the Nature school instead of the Volcanic school.
            > Restoration
                ...
                + Fixed an issue causing Stormstream Totem to consume multiple charges of its effect when cast, instead of consuming one
                  at a time.
        • Warlock
            > Affliction
    ...
    Player versus Player
        ...
        • Shaman
            ...
            > Enhancement
                ...
                + Thorim’s Invocation now discharges Lightning spells at 35% effectiveness while Doom Winds or Ascendance is active in
                  PvP combat (was 50%).
...
February 12, 2026
    ...
    Classes
        • Resolved an issue that could cause players to unintentionally flag for PvP when casting spells such as Mage’s Ice Lance or
          Rogue’s Secret Technique.
