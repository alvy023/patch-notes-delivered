...
PatchNotesDelivered_Notes_1201 = {
    ...
    gameChangesHotfixes = [[
        ...
        Achievements
            ...
            • Players who have completed Cataclysmic Lumberjack may now properly harvest lumber while remaining mounted in Cataclysm zones.
        ...
        Classes
            ...
            • Demon Hunter
                > Devourer
                    + Fixed an issue causing Eradicate to become un-castable if it was gained during Metamorphosis and Metamorphosis expires.
            ...
            • Druid
                > Feral, Guardian, Restoration
                    + Fixed an issue where Nurturing Instinct, Circle of the Heavens, and Call of the Elder Druid were not affecting Wrath, Starfire, or Starsurge.
            • Hunter
            ...
            • Mage
                • Fixed an issue where Reverberate's additional cast was incorrectly generating Splinters, Arcane Salvo stacks, and Spellfire Spheres.
            ...
            • Rogue
                • Fixed an issue that caused Airborne Irritant to incorrectly apply its old AoE effect to Blind. The effect now matches the current and intended talent description.
                > Assassination
            ...
            • Shaman
                > Enhancement
                    ...
                    + Resolved an issue causing Arc Discharge to display a 20% increase to Chain Lightning damage increase, rather than the intended 40%.
        ...
        Events
            • Ethereal Energy objects should now be interactable when an Ethereal Tool is equipped even if the Ethereal Disruption event is not currently active.
            • The Deploy the Defenses user interface for Stormarion Citadel now displays as expected until the timer expires.
            • Abundance events are now available for all characters in a Warband, once one of them has completed opening tutorial questline.
            • Fixed an issue where the Abundance event in Voidstorm was not granting rewards for Abundant Harvests.
            • Jonas Everdawn in Silvermoon City will now offer "Saltheril's Haven" to invite players to Saltheril's Soiree once they have unlocked World Quests and reached level 90.

        Housing
            • Players on Midnight Epic Edition can now purchase additional copies of the eight Epic Edition decor items from Dennia Silvertongue in Silvermoon City.
        ...
        Player versus Player
            ...
            • Vicious Flask of Honor, Vicious Flask of Manifested Fury, Vicious Flask of the Wrecking Ball, and Vicious Flask of Classical Spirits no longer work above level 80.
            • Rogue
        ...
        Quests
            • Players who are progressing through The War Within recap at level 81+ can now enter The Rookery and complete "Calling the Stormriders".
            ...
            • Fixed an issue where abandoning “One by One”, “Intercepted”, or “Keys Are Optional” could permanently prevent Valeera from appearing, blocking progression on “The Crimson Rogue” questline.
            • Resolved an issue where Risen Witherbark did not provide credit for "The Crypt in the Mist."
            • Players above level 80 should now be able to access the scenario "A Light in the Dark" while on the quest of the same name.
            ...
            • Fixed an issue preventing glyph hunters in Eversong Woods from finding the Shining Span Skyriding glyph for “Eversong Woods Glyph Hunter”.
            • Fixed a bug where players were blocked from using the Discordant Tune on Snapdragons for "Put a Little Snap in Their Step".
            • Players who completed “Legends of the Haranir” in the current week and then pick up "Legendary Prosperity" will now have "Legendary Prosperity" automatically complete.
            • Players on the Zul'Aman campaign quest “Blade Shattered” will no longer receive credit for other players killing Mor'duun. You have to do it yourself.
