...
PatchNotesDelivered_Notes_1201 = {
    ...
    Items
        • The Sun Darter Hatchling check for Mind-Seeker progress will no longer reset.
            - Developers’ notes: We’re releasing this fix early to prevent additional players from encountering the issue. A follow-up
              change is planned for 12.0.5 that will detect if the Sun Darter Hatchling has been unlocked on your account.
