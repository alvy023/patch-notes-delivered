...
PatchNotesDelivered_Notes_1201 = {
    ...
    Classes
        ...
        • Priest
            ...
            > Holy
                + Corrected an issue where gaining Benediction while casting a Flash Heal could cause Flash Heal to incorrectly consume
                  the Benediction effects.
                + Fixed an issue causing the Single-Button Assistant and Assisted Highlight to continuously recommend Shadow Word: Pain
                  when Holy Fire was not talented.
                + Archon: Fixed an issue causing some of the benefits of Surge of Light to not function when Surge of Light was gained
                  while casting Flash Heal or Prayer of Healing and then canceling the cast.
            > Shadow
        ...
        • Windrunner Spire
            > Restless Heart
                ...
                + Developers’ notes: When considering the recent removal of Squall Leap’s stacking property, we are increasing the
                  base damage value of this ability to compensate. This change incentivizes continued interaction with Turbulent Arrows
                  to remove this affliction, while also capping the penalty for failing to do so.
        • The Voidspire
            > Vorasius
            ...
            > Crown of the Cosmos
                ...
                + Resolved an issue where Grasp of Emptiness would have its duration shortened by effects such as The Voodoo Shuffle.
                + Void Expulsion damage no longer scales with raid size.

    Items
        • Gloom-Spattered Dreadscale absorb aura is now removed upon entering instances or loading into a new zone. Using the trinket
          now overwrites any existing absorb aura, and its maximum value is limited.
        • Beacon of Lightblind Wrath - Fixed an issue preventing certain offensive healer abilities from activating the damage effect.
    ...
    Professions
        ...
        • Herbalism
            > Vengeful Lashers woken up by gathering wild herbs in Zul'Aman are now friendly with everyone except for the herbalist who
              woke them up.
        • Inscription
    ...
    Prey
        • Completing Prey hunts after your first 4 a week now awards 1000 Prey Journey progress until you reach Journey Rank 4, where
          the value will drop down to 50. This includes completing random hunts. The amount of Journey progress awarded by your first
          4 hunts on an account remains unchanged at 1000.
    ...
    Quests
        • Resolved an issue sometimes preventing completion of "Midnight: Saltheril's Soiree" if a guest had already been invited on
          another character. Affected players can visit Saltheril's Haven to receive credit for the objective automatically.
