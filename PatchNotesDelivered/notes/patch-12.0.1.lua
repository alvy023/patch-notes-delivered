...
PatchNotesDelivered_Notes_1201 = {
    ...
    Classes
        ...
        • Paladin
            > Retribution
                + Templar: Resolved an issue causing Hammer of Light to not benefit from Judgment with Undisputed Ruling when cast on a target without any Judgment stacks.
        • Warlock
            > Demonology
    ...
    Delves
        • Fixed an issue where damage-dealing Valeera was causing pets and guardians to be considered more valuable targets than the player(s).
    ...
    Dungeons and Raids
        ...
        • The Voidspire
            ...
            > Vaelgor & Ezzorak
                ...
                + Adjusted the warning visuals for Void Howl to better match the targeting radius in Raid Finder, Normal, and Heroic difficulties.
            > Lightblinded Vanguard
                + Fixed a bug where Avenger's Shield was targeting pets.
                + Resolved an issue where gaining an additional stack of Tyr's Wrath would refresh the absorb value to its maximum value for each stack.
            > Crown of the Cosmos
                + Resolved an issue where Void Expulsion could remain on the ground between phase transitions.

    Items and Rewards
        • Very rare raid items now drop at their intended item level in Normal and Raid Finder difficulties and preview at the correct item level in the Adventure Guide.
        • Gaze of the Alnseer - Fixed an issue where the internal cooldown could occasionally be unintentionally ignored.
        • Litany of Lightblind Wrath - Fixed a further issue preventing certain spells from triggering the damage effect such as Lavaburst.
        • Reduced gold awarded by Void-Touched Satchel of Cooperation.
        • Increased rewards awarded by Field Medic's Hazard Payout.
            - Developers’ notes: These two rewards have a similar purpose: an incentive to encourage players of a specific role to enter a queue and help balance roles that are in short supply, while reducing queue times. The contents of these bags were not equitable, so these changes bring them closer into balance.
