...
PatchNotesDelivered_Notes_1201 = {
    ...
    Classes
        • Player-cast long term raid buffs can no longer be canceled while the player is in combat. These buffs can still be canceled
          when outside combat and can always be applied regardless of combat state. The spells affected by this are: Mark of the
          Wild, Arcane Intellect, Battle Shout, Power Word: Fortitude, Skyfury, Source of Magic, Symbiotic Relationship, and
        ...
        • Druid
            > Balance
                + Elune's Chosen: Atmospheric Exposure is now properly applied by Full Moons cast by Orbit Breaker or Convoke the Spirits.
        • Hunter
            > Beast Mastery
            ...
            > Marksmanship
                ...
                + Fixed an issue causing some Spotter's Mark effects to not trigger if the Aimed Shot that consumes it killed its target.
            > Survival
    ...
    Delves
        ...
        • Collegiate Calamity
            > Hydrangea’s Exposing Bolt now causes a debuff of 1% per stack (was 5%) and can reach a maximum of 99 stacks (was a max of 20).
        • The Grudge Pit
    ...
    Player versus Player
        ...
        • Reduced Honor costs for Galactic Aspirant's Badge of Ferocity, Galactic Aspirant's Insignia of Alacrity, and Galactic Aspirant's Emblem.
        • Reduced Conquest costs for Galactic Gladiator’s Badge of Ferocity, Galactic Gladiator's Insignia of Alacrity, and Galactic Gladiator's Emblem.

    Professions
        • Thalassian Competitor's Chain Stompers now cost 4 Competitor's Heraldries to craft (was 5).
        • Fixed a bug where Thalassian Competitor's Medallion, Thalassian Competitor's Emblem, and Thalassian Competitor's Insignia were
          not part of the Gladiator's Distinction item set.
