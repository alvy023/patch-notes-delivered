...
PatchNotesDelivered_Notes_1201 = {
    ...
    gameChangesHotfixes = [[
        ...
        Classes
            ...
            • Paladin
                > Retribution
                    ...
                    > Herald of the Sun
                        - Resolved an issue causing Morning Star's increased damage effect on Dawnlight to stop functioning when the second
                          Dawnlight is applied to the same target.
        ...
        Dungeons
            ...
            • Timewalking
                > Fixed an issue where Timewalking dungeon items obtained while leveling required a higher character level than intended.
        ...
        Quests
            • Archmage Aethas Sunreaver has decided to make himself visible at the Bazaar in Silvermoon City for characters who had one of
              his quests shared and were unable to see him to complete it.
