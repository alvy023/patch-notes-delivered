...
PatchNotesDelivered_Notes_1201 = {
    ...
    With the release of the second pre‑expansion update, we’re rolling out additional class updates and a host of quality‑of‑life improvements—including user interface (UI) enhancements to Damage Meters, Boss Alerts, and more—as we make our final preparations for the launch of Midnight.
...
CLASSES
    ...
    DEATH KNIGHT
        Hero Talents
            • Deathbringer
                > Frost
                    ...
                    + Deathly Blows now increases the damage of Frost Strike and Frostbane by 15% (was 5%), and also has an additional effect – Reaper's Mark grants 3 stacks of Bonegrinder if it is known.
                    + Swift and Painful now makes Wave of Souls 100% more effective on the primary target, and now grants 8% increased Strength when no enemies are struck by Soul Rupture (was 5%).
            • Rider of the Apocalypse
                > Developers' notes: We're making an adjustment aimed at bringing Rider of the Apocalypse and Deathbringer closer in power.
                + All Horsemen damage reduced by 65%.
                + Hungering Thirst now increases the damage of diseases, Frost Strike, Frostbane, and Death Coil by 5%, and now also affects Necrotic Coil.
                > Frost
                    + Trollbane's Obliterate now correctly becomes Frost when consuming a Killing Machine with One-Handed weapons.
                    + Feast of Souls now increases the damage of Runic Power abilities by 10% when you have 2 or more active Horsemen (was 20%).
                > Unholy
            ...
            • San'layn
                > Unholy
                    ...
                    + Frenzied Bloodthirst now increases the damage of Death Coil and Epidemic by 3% per stack of Essence of the Blood Queen.
        ...
        • Unholy
            > Developers' notes: With these changes, we're focusing on the power distribution between abilities and the talents that empower them. Some abilities such as Army of the Dead lacked baseline power and relied heavily on other talents to make them feel impactful. Another example is the Apex Talents. While the first node provided a good amount of power, the rest of the nodes did not add much. With this power redistribution in mind, we are also aiming to resolve some rotational quality of life issues such as the permanent Outbreak override, button bloat during cooldowns, and some talents that are feeling like they should be baseline such as Rapid Variant and Necromancer's Cunning.
            > For Unholy Death Knight, especially San’layn, they have been overperforming in low-target scenarios. We’re reducing some throughput and easing the weight of its cooldown windows. We’re also taking this opportunity to address some imbalance between Raise Abomination and Gargoyle.
            > New Talent: Scythe of Decay – Festering Scythe casts a Death and Decay at the target location. Can only occur every 30 seconds. Reduced to 15 seconds with Death's Echo. Replaces Death and Decay.
            > Superstrain has been redesigned – Dread Plague deals damage to an additional nearby enemy at 75% effectiveness and has a chance to grant you 4 Runic Power.
            ...
            > Army of the Dead has been updated – Summons a legion of 8 empowered Lesser Ghouls that last for 15 seconds that are now 75% more effective than normal Lesser Ghouls (was 100%). Generates 40 additional Runic Power. Reduced to 4 Lesser Ghouls in PvP combat.
            ...
            > Fixed an issue that caused Festering Scythe's debuff effect to stop functioning when diseases get extended from any source.
    ...
    DEMON HUNTER
        Hero Talents
            ...
            • Void-Scarred
                > Devourer
                    + Flamebound has been updated – Hungering Slash critical strike damage bonus increased to 125% (was 50%). This does not affect PvP combat.
                    + The damage bonus of Metamorphosis-empowered versions of Voidblade, Hungering Slash, and The Hunt reduced to 20% (was 30%).
                ...
                > Devourer
                    + Developers' notes: We've been getting feedback that Collapsing Star's resource consumption happening at the start of its cast is too punishing, especially in uncoordinated groups. We still want proper planning and execution of Collapsing Star to be a meaningful part of maximizing Devourer Demon Hunter's damage, but we agree that there is too much tension surrounding an ability that should feel exciting and epic. As such, we're updating Collapsing Star to now only consume its stacks when the cast is completed. We're also adding an internal cooldown to Collapsing Star to prevent edge-cases where players may want to cast and cancel Collapsing Star repeatedly to extend their Void Metamorphosis duration. This cooldown will trigger when Collapsing Star begins its cast. Our goal with this change is to make Collapsing Star more forgiving when canceled due to forced movement or crowd control, while giving us some room to avoid abuse cases.
                    + Collapsing Star has been updated – No longer consumes the required Souls at the start of its cast. Now has a 5 second cooldown and triggers its cooldown at the start of its cast. Generates 50% less threat.
        ...
        Hero Talents
            • Keeper of the Grove
                > Balance
                    ...
                    + Fixed an issue that caused Sylvan Beckoning's Dryad to cast an incorrect, more powerful version of Starfall than intended.
                    + Fixed an issue for Durability of Nature causing the tooltip to display a value of 50% for the amount it increases treant health, when it is actually 100%.
                > Restoration
    ...
    EVOKER
        • Fire Breath’s total damage, instant and periodic, should now be consistent at all Empower ranks, with all combinations of Fire Breath-affecting talents.
        ...
        Hero Talents
            • Flameshaper
                > Devastation
                    ...
                    + Consume Flame now causes Pyre to consume 4 seconds of Fire Breath (was 10 seconds) and 1 second of Fire Breath from Disintegrate damage (was 1.5 seconds).
            • Scalecommander
                > Devastation
                    + Developers' notes: We're reducing the number of times Deep Breath is available through Wingleader for Scalecommander to lessen the amount of time spent airborne which can be difficult to play. We're offsetting the damage losses with buffs to other Scalecommander talents.
                    + Wingleader now causes Bombardments to reduce the cooldown of Deep Breath by 0.5 seconds (was 1 second), up to 1.5 seconds (was 3 seconds).
        ...
        • Augmentation
            ...
            > Sense Power and Prescience have been updated to correctly detect all major throughput cooldowns, and will no longer activate on tank or healer specializations.
    ...
    HUNTER
        • Developers' notes: Beast Mastery is continuing to overperform across all content, so we're bringing down their baseline power and apex talent damage and making smaller adjustments to individual hero talent trees.
        • Marksmanship is getting a small bump in AOE paired with a few buffs to underperforming spells like Kill Shot and Volley.
        • For Survival, we're buffing up Wildfire Bomb's single target damage bonus to ensure it isn't being forgotten about in Pack Leader's single target rotation and tamping down Sentinel since its already overperforming and poised to gain a significant boost from the Wildfire Bomb single target damage bonus.
        Hero Talents
            • Dark Ranger
                > Beast Mastery
                ...
                > Marksmanship
                    + Blighted Quiver has been updated – Trick Shots damage bonus increased to 10% (was 8%). Aspect of the Hydra damage bonus increased to 12% (was 10%).
    ...
    MONK
        Hero Talents
            • Master of Harmony
                > Brewmaster
                    + Meditative Focus now increases Blackout Combo's increase to Tiger Palm by an additional 100% (was 50%) and increases Press the Advantage's Nature damage by an additional 100% (was 50%).
                    + Way of a Thousand Strikes increases vitality stored by 60% (was 30%) and Path of Resurgence increases vitality stored by 50% (was 25%).
                    + Aspect of Harmony now generates vitality based on 25% of damage dealt and 12% of effective healing (was 15% and 7%, respectively).
        • Brewmaster
    ...
    PALADIN
        Hero Talents
            • Herald of the Sun
                > Retribution
                    + Developers' notes: We're focusing on rotational bloat during major cooldowns, tuning and Herald of the Sun updates. For Herald of the Sun we are aiming to make quality of life changes that have tuning implications such as the Sun's Avatar effect width and the way Dawnlight's are applied by Divine Storm. For Herald of the Sun's rotational clarity, we are making Hammer of Wrath the clear choice as the Holy Power builder to use during Avenging Wrath. We want to have Herald of the Sun be a viable option against Templar for those who enjoy its playstyle or are looking for a change of pace.
                    + Walk Into Light now has an additional effect – During Avenging Wrath, Hammer of Wrath casts Blade of Justice at 100% effectiveness.
    ...
    PRIEST
        Hero Talents
            ...
            • Voidweaver
                ...
                > Shadow
                    + Developers' notes: Shadow has been overperforming relative to other specializations, particular as Voidweaver. We're reducing the power of some of its talents to bring its power level more in line with other specializations and the Archon Hero Talent tree.
        ...
        • Holy
            > Developers' notes: Holy Priest has fallen behind other healers in output. We are increasing some controlled sources of healing with this change and including some reductions in power to Cosmic Ripple as well as reductions to the power of a couple Archon talents to better maintain Hero Talent balance and keep the healing experience consistent with more healing from directly casted spells.
        ...
        • Shadow
            ...
            > Spectral Horrors now causes Shadowy Apparitions to deal 50% increased damage to targets afflicted by Shadow Word: Madness (was 100%).
            ...
            > Fixed an issue causing the damage over time effect from Shadow Word: Madness to not properly account for damage modifiers when casting the ability while the debuff is already present.
    ...
    SHAMAN
        ...
        • Enhancement
            ...
            > Fixed an issue that caused Maelstrom Weapon spending abilities to incorrectly do damage as if they consumed 10 stacks of Maelstrom Weapon when Raging Maelstrom is talented without Overflowing Maelstrom.
        • Restoration
            > Developers' notes: We're aiming to add more interesting decisions to Restoration which has felt lacking in Midnight as well as addressing a core talent issue pushing gameplay towards a repetitive playstyle. To accomplish this, we're returning Tidal Waves to the talent tree, updating Ascendance with a different set of mechanics, and removing Whispering Waves. We feel this will be more exciting to play with and prevent current and future issues with Whispering Waves pushing gameplay too far towards an unfun playstyle. Thank you for your continued feedback!
            ...
            > Tidal Waves returned and has been updated – Each cast of Riptide grants 1 stack of Tidal Waves, reducing the cast time of your next Healing Wave or Chain Heal by 20%. Can accumulate up to 2 stacks.
...
DUNGEONS
    ...
    • Developers' notes: Pit of Saron, Seat of the Triumvirate, Skyreach, and Algeth’ar Academy Heroic and Mythic difficulties will unlock when Midnight Season 1 begins.
...
HOUSING
    ...
    • Fixed an issue where attempting to start the tutorial from Founder’s Point while on a Horde character wouldn’t send the character to Razorwind Shores.
    ...
    • Fixed an issue in Charter Neighborhoods where players could send invites to players who’ve already purchased a house in the Neighborhood.
    ...
    • Fixed an issue where the Endeavors UI could falsely display the “no active Endeavor” UI for a long time after an Endeavor was selected.
...
PLAYER VERSUS PLAYER
    ...
    DEMON HUNTER
        Hero Talents
            • Fel-Scarred
                > Focused Hatred now increases Demonsurge damage by 10% (was 50%) when damaging a single target, reducing by 2% (was 10%) per additional target in PvP combat.
                > Demonsurge damage reduced by 20% in PvP combat.
            • Devourer
                > Developers' notes: We're taking a pass on Devourer's damage profile in PvP with the goal of improving consistent damage and reducing the potential for one-shots. We'd like Void Metamorphosis to be a powerful cooldown, but are aiming for damage outside of the cooldown to be impactful.
    ...
    ROGUE
        • Subtlety
            > Secret Technique's Shadow Clone strikes now correctly have damage reduced by 23% in PvP combat, matching the reduction applied to the initial strike.
...
USER INTERFACE AND ACCESSIBILITY
    ...
    TRANSMOGRIFICATION
        ...
        • Venthyr Covenant members who have unlocked the Bewitched Wardrobe will receive a discount on outfit changes while participating in the Ember Court feature.
        • When choosing an icon for an outfit slot, the icons for items that are currently used in the appearance will appear at the start of the list.
        • The currency text will change to red and an error tooltip will appear over the "Save Outfit" button if not enough gold is available to save outfit changes.
        ...
        • Fixed an issue where some characters on different realms were failing to display their transmogrification outfit in the Character Select screen.
    NAMEPLATES
