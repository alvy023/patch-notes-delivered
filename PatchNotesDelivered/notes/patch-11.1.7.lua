...
PatchNotesDelivered_Notes_1117 = {
    ...
    June 6, 2025
        ...
        Dastardly Duos
            - Rewards have been moved to Wodin the Troll Servant. Each reward listed with Wodin will show the quest that’s required
              to obtain it and which week it will become available.
    ...
    May 27, 2025
        ...
        Classes
            • Evoker
                > Augmentation
                    - Nerub-ar Palace 2-piece class set increases Upheaval damage by 15% (was 30%) and Eruption damage by 15% per stack
                      (was 30%).
            ...
            • Hunter
                ...
                > Survival
                    - Fixed an issue causing Raptor Strike and Mongoose Bite to not deal damage when cast onto targets in breakable
                      crowd control.
                    - Flanking Strike will now correctly fail to cast and not go on cooldown if your pet is rooted or
                      crowd-controlled.
    ...
    May 6, 2025
        ...
        Classes
            ...
            • Monk
                ...
                - Fixed an issue that caused Unity Within to not automatically if no enemy targets are present when the channel ends
    ...
    April 30, 2025
        ...
        Classes
            ...
            • Rogue
                > Trickster
                    - Fixed an issue that prevented Blade Flurry and Nimble Flurry from dealing increased damage to targets with the
                      Fazed debuff applied.
                > Assassination
                ...
                > Subtlety
                    > Trickster
                        - Fixed an issue that could cause Nimble Flurry to strike below the maximum number of available targets when
                          fighting near dead enemies.
            • Shaman
                > Restoration
            ...
            • Warlock
                > Hellcaller
                    - Fixed an issue where Blackened Soul would not generate a stack if two Soul Shard spenders were cast in quick
                      succession.
