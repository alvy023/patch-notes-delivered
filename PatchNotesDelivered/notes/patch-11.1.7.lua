...
PatchNotesDelivered_Notes_1117 = {
    ...
    gameChangesHotfixes = [[
        ...
        May 22, 2025
            ...
            Horrific Visions
                - Fixed a bug where if you destroyed the Voidfire Deathcycle that Haymar the Devout is riding too fast it would fail to
                  go out of control and let you bring it out with you.
