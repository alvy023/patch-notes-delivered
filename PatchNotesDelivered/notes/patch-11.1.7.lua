        ...
        May 6, 2025
            ...
            Classes
                ...
                • Monk
                    ...
                    - Fixed an issue that caused Unity Within to not automatically if no enemy targets are present when the channel
            ...
            Items
                - When casting Reins of Anu'relos you will now be awarded the bonus items if you need them. If you have the item in your
                  inventory or already have the tracking quest completed, you will not be given that matching item. Each item is
                  checked separately.
