...
PatchNotesDelivered_Notes_1117 = {
    ...
    June 10, 2025
        ...
        Renown
            • Fixed an issue where players could become capped on Gallagio Loyalty Rewards reputation earlier than intended. For players
              who have killed a boss that would have rewarded reputation properly but didn't, defeating that boss on a separate
              character this week will yield the intended amount of reputation.

    June 6, 2025

        Dastardly Duos
            • Rewards have been moved to Wodin the Troll Servant. Each reward listed with Wodin will show the quest that’s required to
              obtain it and which week it will become available.
    ...
    June 3, 2025
        ...
        Horrific Visions
            ...
            • Performing a full clear now also grants the Incremental Progress achievement.
    ...
    May 27, 2025
        ...
        Classes
            • Evoker
                > Augmentation
                    - Nerub-ar Palace 2-piece class set increases Upheaval damage by 15% (was 30%) and Eruption damage by 15% per
                      stack (was 30%).
                    - Developers’ notes: With recent buffs to Augmentation’s personal damage, this older class set became stronger than
                      intended.
                > Preservation
            ...
            • Priest
                > Shadow
                    - Psychic Link now causes direct damage to inflict 35% of damage dealt to targets afflicted by Vampiric Touch (was
                      30%).
            ...
            • Shaman
                > Restoration
                    ...
                    - Farseer: Maelstrom Supremacy now increases the healing of Healing Wave, Healing Surge, Wellspring, Downpour, and
                      Chain Heal by 25% (was 15%). Not applied to PvP combat.
                    - Farseer: Offering from Beyond now reduces the cooldown of Riptide by 3 seconds (was 2 seconds). Not applied to
                      PvP combat.
            ...
            • Warlock
                > Destruction
                    ...
                    - Diabolist: Gloom of Nathreza now causes enemies marked by your Havoc to take 7% increased damage from your single
                      target spells (was 5%).
            • Warrior
                > Arms
    ...
    May 22, 2025
        ...
        Horrific Visions
            • Fixed a bug where if you destroyed the Voidfire Deathcycle that Haymar the Devout is riding too fast it would fail to go
              out of control and let you bring it out with you.
    ...
    May 8, 2025
            ...
            • Hunter
                > Survival
                    - Fixed an issue where Aspect of the Eagle variants of Raptor Strike and Mongoose Bite were dealing less damage
                      than intended.
                    - Fixed an issue where casting Coordinated Assault at greater than 30 yards away could grant Howl of the Pack Leader
                      twice.
        ...
        User Interface and Accessibility
            ...
            • Developers' notes: We have reinforced the measures taken to prevent players from obtaining information about their potential
              PvP opponents in advance of a battleground. This is applicable to all rated battlegrounds, unrated battlegrounds, rated
              brawls, and unrated brawls.
    ...
    May 6, 2025
        ...
        Classes
            ...
            • Monk
                ...
                > Fixed an issue that caused Unity Within to not automatically if no enemy targets are present when the channel ends for
                  Windwalker Monks.
            • Paladin
                > Protection
        ...
        Classes
            ...
            • Warlock
                ...
                > Demonology
                    ...
                    - Fixed an issue where Hand of Gul'dan would appear on the essential cooldown bar without Secrets of the Coven being
                      learned.
