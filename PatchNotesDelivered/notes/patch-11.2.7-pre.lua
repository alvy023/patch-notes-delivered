...
December 16, 2025
    ...
    Housing
        • The Lorewalking: The Elves of Quel'thalas achievement now properly, retroactively awards the Tome of Silvermoon Intrigue.
          Players who have already purchased additional copies of this decor from the Lali the Assistant will see them made available in a
          future patch.
    ...
    Quests
        ...
        • Players who abandoned the “Behind Enemy Lines” raid renown quests for Manaforge Omega will find them again available from
          Zo'turu.
...
December 10, 2025
    ...
    Housing
        ...
        • Players should now be correctly awarded the Drained Dark Heart of Galakrond for completing the achievement
          Worldsoul-Searching. Additional copies of this decor will become available for in-game purchase from a vendor with the release
...
December 5, 2025
    ...
    Dungeons
        • Sanguine Depths
            > Resolved a Timewalking issue that could cause General Kaal to fail to appear if the gauntlet event was progressed through
              too quickly.
        • Spires of Ascension
    ...
    Housing
        • The Battle for Azeroth achievement A Farewell to Arms now properly, retroactively rewards both the MOTHER's Titanic Brazier
          and N'Zoth's Captured Eye décor to players who have earned that achievement. Players who have already purchased additional
          copies of these décor from MOTHER in the Chamber of Heart will see them made available in a future patch.
