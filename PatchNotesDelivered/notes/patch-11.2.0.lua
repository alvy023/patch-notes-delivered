...
PatchNotesDelivered_Notes_1120 = {
    ...
    Achievements
        ● Addressed an issue where Keystone Hero: Tazavesh, the Veiled Market was not earned upon completing both Tazavesh: Streets of Wonder
          and Tazavesh: So'leah's Gambit in a +10 or higher within the time limit.
        ● Addressed an issue where the Keystone Hero achievement is not granted upon completion of a +10 or higher keystone in Halls of
          Atonement within the time limit.
    ...
    Items and Rewards
        ...
        ● Fixed an issue where armor converted with the Catalyst could be ineligible for Conqueror's Astral Varnish and Conqueror's Astral
          Lacquer.
        ● Disabled “The Fate of the Devoured” Warband background, to fix an error that could cause the game to crash. This will return
          after it is fixed.
        ● Great Vault rewards unlocked from defeating bosses in Manaforge Omega will scale in item-level based on the hardest boss killed
          that week per difficulty.
...
August 13, 2025
    ...
    deathKnightChangesPatch = [[
        DEATH KNIGHT
            ...
            • Secondly, plenty of time has passed since Castle Nathria and it's given us some time to reflect on our change to capping Anti-
              Magic Zone. In Ghosts of K'aresh, we are returning AMZ to a % magic damage reduction effect with no cap. We have increased the
              cooldown and reduced the duration and effectiveness downward from what it was prior to the Castle Nathria nerf which should 
              better align with our expected output for a DPS/Tank Damage Reduction cooldown. We hope that by adding this back as a 
              meaningful cooldown alongside their grips that Death Knight's will be able to carve out a spot for themselves in raid 
              compositions.
            ...
            • Hero Talents
                > Deathbringer
                    ...
                    + Developer’s notes: We found that relying on chance for Reaper’s Mark created too much variance in damage output, which 
                      made it feel inconsistent and unreliable.
            ...
            • Frost
                ...
                > New Talent: Frostbane - When you cast Arctic Assault, each foe struck has a chance to transform your next Frost Strike 
                  into Frostbane. The chance increases with the number of Razorice stacks on the target.
                    + Frostbane: Start a frozen onslaught that strikes twice, unleashing the chilling essence of winter, dealing Frost by 
                      5%, down to 40%.
                > Developer’s notes: We wanted to move away from tab-targeting Frost Strike gameplay as it is difficult to execute and 
                  track, and used this opportunity to design a new capstone talent.
    ...
    hunterChangesPatch = [[
        HUNTER
            ...
            • Survival
                ...
                > Born to Kill has been redesigned – Your chance to gain Deathblow is increased by 5% and Kill Shot’s damage is increased by
                  25%.
    ...
    mageChangesPatch = [[
        MAGE
            ...
            • Fire
                ...
                > Liberation of Undermine 2-set bonus has been updated – Chance to trigger reduced. Combustion effectiveness reduced to 100%
                  (was 200%).
        ...
        MONK
            ...
            • Brewmaster
                ...
                > New Talent: Celestial Infusion – A strong herbal brew that coalesces purified chi escaping your body into a celestial 
                  guard, absorbing 20% of incoming damage, up to 1134% attack power. Purifying Stagger damage increases absorption by up to 
                  200%.
    ...
    paladinChangesPatch = [[
        PALADIN
            ...
            • Hero Talents
                > Herald of the Sun
                    + Fixed an issue that caused Dawnlight's tooltip to display that it grants 6 stacks of Dawnlight instead of the intended
                      2.
                    + Holy
            ...
            • Holy
                ...
                > Beacon of Light now only transfers healing from direct healing and Light of Dawn. Healing transfer amount increased by 
                  10%.
    ...
    priestChangesPatch = [[
        PRIEST
            ...
            • Shadow
                ...
                > Holy Nova mana cost reduced by 87%.
                > Psychic Link now causes direct damage to inflict 40% of their damage on all other targets afflicted by Vampiric Touch (was
                  35%).
            ...
            • Demonology
                > Developers' notes: We are addressing two issues with the Demonology talent tree:
                    ...
                    + Second, we are making minor changes to Demonic Tyrant’s ramp and lowering the requirements for maximizing its 
                      requirements.
                > Master Summoner is no longer a PvP talent, has been redesigned, and is now available on the Demonology specialization tree
                    + Master Summoner: Increases Mastery by 4% and reduces the cast time of your Call Dreadstalkers, Summon Vilefiend, and 
                      Summon Demonic Tyrant by 25%.
                ...
                > Improved Demonic Tactics now increases your primary Felguard’s critical strike chance by 50% of your critical strike 
                  chance (was 30%).
                > Liberation of Undermine 2-set bonus has been updated – Now summons a Greater Dreadstalker at 180% effectiveness 
                  (was 265%).
                > Liberation of Undermine 4-set bonus has been updated – Now commands your active Dreadstalkers to Dreadbite at 10% (was 
                  20%) effectiveness. This damage is now increased by 5% per Soul Shard spent on Hand of Gul’dan (was 10%).
        ...
        WARRIOR
            ...
            • Hero Talents
                ...
                > Protection
                    ...
                    + New Talent: Spellbreaker – You have a 8% chance to disrupt magic damage dealt to you, reducing the damage it deals by 
                      50%.
