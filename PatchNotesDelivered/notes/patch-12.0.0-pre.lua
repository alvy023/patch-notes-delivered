...
PatchNotesDelivered_Notes_1200P = {
    ...
    User Interface
        • Many additional spells and abilities have been adjusted so that their spell visual density is decreased when either the Reduced
          or Essential Spell Density setting is selected.
...
December 16, 2025
    ...
    Brawler’s Guild
        ...
        • G.G. Engineering damage of Gnomish Death Ray decreased, health of Shield Generators decreased, and health of Bo Bobble and Max
          Megablast decreased.
    Classes
        • Rogue
    ...
    Housing
        • The Lorewalking: The Elves of Quel'thalas achievement now properly, retroactively awards the Tome of Silvermoon Intrigue.
          Players who have already purchased additional copies of this decor from the Lali the Assistant will see them made available
          in a future patch.
        • Thanks to recent alchemical breakthroughs from the Kirin Tor, crafting decor with Legion Alchemy (including the Arcan'dor Cutting
          Fountain) no longer requires the Dalaran Alchemy Station.
        • In a miracle of gnomish engineering, every Gnomeregan Recyli-Kiln (curiously obtained from Mechagon, not Gnomeregan) has suddenly
          started functioning properly as decor. It can be placed inside or outside of player houses and costs 5 decor placement points.
    Items
        • Fixed an issue where Ethereal Voidsplinters could not be obtained from Bountiful Delves, and their drop rate from most sources
          has been increased.
        • Fixed an issue where Sanctified Priory Wall could not be purchased from Fixer So'tho or Fixer So'kir.
    Legion Remix
        • Raid bosses on all difficulties now drop a full Minor Bronze Cache (contains 2500 Bronze) in place of their previous Bronze
          offerings.
        • Lost Legion Infernals now drop a Greater Bronze Cache (12500 Bronze) once per day, per account.
        • Infinite Research quests now also grant a Lesser Bronze Cache (4000 Bronze).
        • Legion Assaults now grant a Bronze Cache (7500 Bronze).
        • Emissary Quests now grant a Greater Bronze Cache (+8500 Bronze) (was a Lesser Bronze Cache).
        • World Bosses now drop a Lesser Bronze Cache (4000 Bronze).
        • Legion Assaults now cycle approximately 375% faster.
        • Lidamorrutu at the Infinite Bazaar now correctly engages in dialogue with the player as intended.
    Quests
...
December 10, 2025
    ...
    Housing
        ...
        • MOTHER's helpfulness knows no bounds. She now sells additional copies of the decor rewards from A Farewell to Arms, MOTHER's
          Titanic Brazier and N'Zoth's Captured Eye, for 10,000 Echoes of Ny'alotha each (a cost reduction of 90%).
...
December 5, 2025
    ...
    Dungeons
        • Sanguine Depths
            > Resolved a Timewalking issue that could cause General Kaal to fail to appear if the gauntlet event was progressed through too
              quickly.
        • Spires of Ascension
    ...
    Housing
        • The Battle for Azeroth achievement A Farewell to Arms now properly, retroactively rewards both the MOTHER's Titanic Brazier and
          N'Zoth's Captured Eye décor to players who have earned that achievement. Players who have already purchased additional copies
          of these décor from MOTHER in the Chamber of Heart will see them made available in a future patch.
        • Tocho and Lyssabel should no longer offer neighborhood renaming outside their respective neighborhoods, and players should no
          longer have the option to rename their neighborhood while in a public one.
        • Traveling Book Shop owners Lonalo and Solelo should now have books for sale more frequently, having learned the art of supply
          and demand.
