...
PatchNotesDelivered_Notes_1200P = {
    ...
    gameChangesHotfixes = [[
        ...
        Items
            • [With scheduled realm maintenance] The item-level of gear provided by the Level 80 Boost has been increased to 102 (was 
              iLvl 80).
            • Trading Post
                > [With scheduled realm maintenance] A new Trading Post activity has been added to January: "Legion Remix: Mix Up". The 
