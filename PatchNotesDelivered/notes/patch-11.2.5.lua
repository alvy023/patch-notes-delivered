...
PatchNotesDelivered_Notes_1125 = {
    ...
    WoW
        ...
        • Corrected an issue where a small number of Paladins, Death Knights, and Shamans were simultaneously benefiting from all three of their
          class's armor specialization bonuses.
