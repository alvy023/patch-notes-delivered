...
PatchNotesDelivered_Notes_1125 = {
    ...
    gameChangesHotfixes = [[
        November 14, 2025
            ...
            Legion Remix
                • Fixed issues preventing timerunners from earning the achievements Law and Order: Shaman, Law and Order: Monk, and Bringing 
                  Order to the Isles.
                • Fixed an issue causing Broken Shore world boss quests to not reward a Cache of Infinite Power.
                • Fixed an issue causing The Broken Shore achievement to sometimes not reward Fallen King's Corrupted Blades. Affected 
                  players will be rewarded Fallen King's Corrupted Blades on login.
                • Fixed an issue causing Druids to be unable to Dreamwalk during the Defense of Aviana.
                • Implemented fixes or workarounds for the following issues causing some timerunners to be unable to collect their hidden 
                  artifact appearances.
                    ...
                    > Several volumes of The Annals of Light and Shadow (Discipline Priest artifact) can now be found among the stacks of 
                      infinite chronoqueries near Pageturner Metros.
                    > Unholy Death Knights may now find a timewarped trap door leading from Acherus to Putricide's Secret Lab.
                    > Fixed an issue causing Unholy Death Knights (of all timelines) to be unable to summon a peculiar member of the Army of
                      the Dead.
