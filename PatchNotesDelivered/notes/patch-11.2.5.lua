...
PatchNotesDelivered_Notes_1125 = {
    ...
    Classes
        ...
        • Rogue
            > Fatebound
                + Fixed an issue that caused the damage bonus provided by Fatebound Coin (Heads) to be 8% lower than the displayed value.
...
September 24, 2025
    ...
    Dungeons and Raids
        • Manaforge Omega
            > Fixed an issue on Normal and Heroic difficulties that caused Salhadaar to respawn if the raid was soft-reset after killing him following the use of the raid skip.
    ...
    Quests
        • Fixed a bug that could prevent players from earning progress on "Emissary of War" after completing Halls of Atonement in Mythic Keystone difficulty.
    
    Reputation and Renown
        • Fixed an issue where some players could become unable to progress as far as others with Manaforge Vandals. Affected players may find that their reputation progress extends slightly into the next rank each week, but the maximum potential rank will not be affected.
...
September 12, 2025
    ...
    Dungeons and Raids
        ...
        • Manaforge Omega
            > Dimensius
                ...
                + Developers’ notes: The above changes are intended to relax coordination requirements in Raid Finder, as areas of Collective Gravity will be faster and easier to create and will more reliably protect players from Devour.
    ...
    Items
        ...
        • Conqueror's Astral Varnish and Conqueror's Astral Lacquer should now function properly when applied to War Mode gear that was converted to a Set item.
...
September 9, 2025
    ...
    Classes
        ...
        • Hunter
            ...
            > Marksmanship
                ...
                + Withering Fire will now fire at your primary target when it has no nearby enemies to apply Black Arrow's periodic effect to.
        • Monk
            > Mistweaver
    ...
    Delves
        ...
        • Nexus-Princess Ky'veza
            ...
            > Nexus Daggers now spawns 3 additional phantoms (was 4), and time between phantoms increased to 1 second (was 0.75 seconds) on [?] difficulty.
    ...
    Dungeons and Raids
        ...
        • Manaforge Omega
            > Fixed an issue where the teleport option to Central Operations became unavailable if players activated the raid skip after already unlocking this teleport location.
            > Forgeweaver Araz
                + Arcane Obliteration will now still cast even if the target dies early.
                + Arcane Siphon damage reduced in Mythic difficulty.
                + Arcane Harvest and Silencing Tempest targeting updated to de-prioritize targeting tanks and to reduce the possibility of targets being selected by both of these abilities at once.
            > Nexus-King Salhadaar
                + Stage One: Oath-Breakers
                    - Command: Besiege now activates 9 Fractal Images (was 12), and time between each activation increased to 1.375 seconds (was 1 second) on Mythic difficulty.
    ...
    Items and Rewards
        ...
        • The Manaforge Vandals raid Renown "Attuned to the Aether" effect at rank 6 is now limited to weapon enchantments only and also increases the power of Death Knight Runeforge effects by 10%. The effect tooltip will temporarily be incorrect, until it is updated with a future hotfix.
    ...
    Player versus Player
        ...
        • Evoker
            > Preservation
                + Chrono Flame’s maximum damage increased from the 4-piece class set reduced to 325% spell power in PvP combat (was 450% spell power).
        • Hunter
            > Survival
        ...
        • Mage
            > Arcane
                ...
                + Improved Touch of the Magi now causes Nether Flux to increase the damage of your next spell by an additional 10% (was 25%).
...
August 14, 2025
    ...
    Achievements
        • Addressed an issue where
          ...
          t was not earned upon completing both Tazavesh: Streets of Wonder and Tazavesh: So'leah's Gambit in a +10 or higher within the time limit.
