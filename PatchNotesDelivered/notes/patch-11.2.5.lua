...
PatchNotesDelivered_Notes_1125 = {
    ...
    gameChangesHotfixes = [[
        ...
        Dungeons and Raids
            • Manaforge Omega
                > Fixed an issue on Normal and Heroic difficulties that caused Salhadaar to respawn if the raid was soft-reset after killing him
                  following the use of the raid skip.
        ...
        Quests
            • Fixed a bug that could prevent players from earning progress on "Emissary of War" after completing Halls of Atonement in Mythic
              Keystone difficulty.

        Reputation and Renown
            • Fixed an issue where some players could become unable to progress as far as others with Manaforge Vandals. Affected players
              may find that their reputation progress extends slightly into the next rank each week, but the maximum potential rank will not
              be affected.
    ...
    September 12, 2025
        ...
        Player versus Player
            • Demon Hunter
                > Havoc
                    + Fixed an issue causing Consume Magic to generate a Lesser Soul Fragment that grants a damage buff when used on a demon
                      while talented for Blood Moon.
        ...
        Dungeons and Raids
            ...
            • Manaforge Omega
                ...
                > Forgeweaver Araz
                    ...
                    + Arcane Harvest and Silencing Tempest targeting updated to de-prioritize targeting tanks and to reduce the possibility
                      of targets being selected by both of these abilities at once.
    ...
    September 4, 2025
        ...
        Dungeons and Raids
            • Manaforge Omega
                > Fixed an issue with the raid skip that prevented the Manaforge Translocator located in The Shadow Docks from being clicked
                  after any boss encounter was engaged.
                > Nexus-King Salhadaar
                    ...
                    + Developer's notes: These adjustments are aimed at reducing difficulty for small group sizes, with the greatest
                      reductions applying to 10-player groups. These affect Raid Finder, Normal, and Heroic difficulties, with no change for
                      30-player groups or for Mythic.
                > Dimensius
                    ...
                    + When any player engages Dimensius in Raid Finder difficulty, all other players in the immediate vicinity are now also
                      transported to his location.
    ...
    August 26, 2025
        ...
        Characters
            • Players who Boost a character to level 80 will no longer need to log out and back in to start "Adventuring in Khaz Algar" and
        ...
        Classes
            ...
            • Paladin
                > Lightsmith: Fixed an issue causing the 4-piece Vows of the Lucent Battalion Masterwork's duration to not be refreshed after
                  reaching maximum stacks.
                > Holy
            ...
            • Priest
                ...
                > Archon: Resolved an issue causing additional Halos from Power Surge and Divine Halo to sometimes not deal damage to enemies
                  close to the Priest.
        ...
        Dungeons and Raids
            ...
            • Halls of Atonement
                > Addressed an issue where players were prevented from earning the
                  Keystone Hero
        ...
        Player versus Player
            • Resolved an issue where the Severed Threads Commendation from PvP weekly quests did not give reputation with the selected
              faction.
            • Monk
                > Resolved an issue that could cause Song of Chi-Ji's effect to be incorrectly removed by friendly player crowd-control
                  effects such as Cheap Shot.
    ...
    August 19, 2025
        ...
        Classes
            • Death Knight
                ...
                > Unholy
                    + Rider of the Apocalypse: Fixed an issue causing Chains of Ice from King Thoras Trollbane to sometimes fail to apply
                      Chains of Ice to large enemies.
            • Demon Hunter
                > Fel-Scarred: Fixed an issue that prevented demon soul fragments generated by 4-piece tier set from applying their effect
                  when consumed by casting Spirit Bomb.
            • Druid
                > Balance
                    + Keeper of the Grove: Fixed an issue with Ornaments of the Mother Eagle 4-piece causing damage dealt to absorb shields
                      to not count towards damage dealt while your dryad is active.
            • Mage
                > Fire
            ...
            • Priest
                > Shadow
                    + Fixed an issue causing Shadow Crash to not apply Shadow Word: Pain and Vampiric Touch to targets not in line of sight
                      of the Priest.
                    + Fixed an issue preventing the spell visuals for the Idol of C'Thun talent.
            • Rogue
                > Fatebound: Fixed an issue that could cause the 4-piece class set's skill cooldown reduction effects to apply twice under
                  certain conditions.
                > Assassination
                    + Fixed an issue that allowed Caustic Spatter to directly benefit from effects that provide damage bonus to all Rogue
                      damage abilities.
            • Shaman
                > Enhancement
        ...
        Player versus Player
            ...
            • Developers’ note: This is intended to slightly increase the time it takes to kill an enemy in PvP combat, to give players more
              time to react to incoming burst.
            • Death Knight
    ...
    August 15, 2025
        ...
        Items
            • Pyrite Infuser, Mjolnir Runestone, Wrathstone, Eye of the Broodmother, Living Flame, and Elemental Focus Stone effects decreased
              by 5%.

        Renown
            • Fixed an issue causing players to sometimes start from Rank 0 with the Manaforge Vandals instead of Rank 1. Affected players
              have been granted the missing Renown to allow them to reach Rank 2 this week.

    August 14, 2025

        Achievements
            • Addressed an issue where
              Keystone Hero: Tazavesh, the Veiled Marke
              t was not earned upon completing both Tazavesh: Streets of Wonder and Tazavesh: So'leah's Gambit in a +10 or higher within
              the time limit.
            • Addressed an issue where the
              Keystone Hero
              achievement is not granted upon completion of a +10 or higher keystone in Halls of Atonement within the time limit.
        ...
        Items and Rewards
            ...
            • Fixed an issue where armor converted with the Catalyst could be ineligible for Conqueror's Astral Varnish and Conqueror's
              Astral Lacquer.
            • Disabled “The Fate of the Devoured” Warband background, to fix an error that could cause the game to crash. This will return
              after it is fixed.
            ...
            • Developers’ notes: For example, defeating all eight bosses on Heroic difficulty would cause any items offered from earlier
              bosses to scale to 4/6 Hero as dropped from Nexus-King Salhadaar and Dimensius, the All-Devouring. If two Mythic raid bosses
              were also defeated to unlock one Mythic raid reward, that item would still be limited to 2/6 Myth, etc.
        ...
        Dungeons
            ...
            • Tazavesh, the Veiled Market
                ...
                > Addressed an issue where Zo'gron can skip his second Final Warning cast if the health threshold was reached during the first
                  cast.
    ...
    August 13, 2025
        ...
        Classes
            • Druid
                > Restoration
                    + Keeper the Grove: Fixed a bug causing Swiftmends enhanced by the Ornaments of the Mother Eagle 4-piece to not splash
                      healing to allies.
            • Hunter
                > Fixed an issue causing Precise Shots to not grant its global cooldown reduction effect if its consumption was spell-queued
                  after Aimed Shot.
            • Mage
            ...
            • Paladin
                > Protection
                    + Fixed an issue with Sanctuary and Undisputed Ruling where players could lose the benefits of Consecration if two or more
                      were active when the first expired.
            • Warlock
        ...
        Player versus Player
            • Conqueror's Astral Lacquer and Conqueror's Astral Varnish may now be purchased for Conquest to add Season 3 PvP item-level to
              Season 3 class set armor.
        ...
        Classes
            ...
            • Druid
                ...
                > Feral
                    ...
                    + Sabertooth causes Ferocious Bite to increase damage taken from your bleeds and other periodic effects by 6% per combo
                      point (was 5%).
                ...
                > Restoration
                    ...
                    + Wildstalker: Fixed a bug preventing Twin Sprouts from generating extra Bloodseeker Vines or Symbiotic Blooms from the
                      ones created by the Ornaments of the Mother Eagle 4-piece set bonus.
                    ...
                    + Developers’ notes: The bug involving Rampant Growth was generating a large number of unintended Symbiotic Blooms,
                      which consolidated a lot of Wildstalker’s healing power into the 4-piece and Clearcasting procs. We’ve added healing
                      power to counteract the healing loss from the bug fix.
            • Hunter
                > Beast Mastery
