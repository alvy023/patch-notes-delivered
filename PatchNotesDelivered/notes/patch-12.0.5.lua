    ...
    Player versus Player
        ...
        • Evoker
            > Preservation
                + Developers’ notes: Preservation has pulled ahead of the other healers
                  ...
                  capabilities and also the uptime on Nullifying Shroud to bring them in
                  line.
        ...
        • Shaman
            > Elemental
                + Developers’ notes: Elemental is often relying on Ascendance for kills due
                  ...
                  overall pressure while reducing reliance on cooldowns to score skills.
        ...
        May 15, 2026
            ...
            Achievements
                ...
                • Additionally fixed issues with the Champion of Pahk creature in Abyss Anglers that caused it to disappear before players 
                  could catch it.
            ...
            Dungeons and Raids
                • The Voidspire
                    > A teleport pad now appears in the Isle of Quel'Danas for raid groups that used the raid shortcut and have bosses 
                      to defeat.
        ...
        May 12, 2026
            ...
            Classes
                • Death Knight
                    > Blood
                        + Developers’ notes: We are looking at smoothing out the damage intake of Blood outside of their cooldown window by
                          increasing the consistency and uptime of their Apex Talent. To further help these windows of high damage intake we
                          are also increasing their Health and Death Strike healing.
                ...
                • Demon Hunter
                    > Vengeance
                        + Developers’ notes: Vengeance Demon Hunter’s baseline defenses are its most lacking, while cooldown availability 
                          and values are currently serving the spec well. As a result, we will be primarily targeting core values for Health
                          and damage reduction, with an additional smaller increase specifically to Armor.
                ...
                • Druid
                    > Guardian
                        ...
                        + Developers’ notes: These changes aim to bring this build closer to its expected output: high-damage relative to 
                          other tanks, but not abnormally so. Recent previous adjustments to Guardian have made the Elune’s Chosen build 
                          stronger than intended. With this tuning, we’re choosing to not break the Elune’s Chosen build or require the Apex
                          talent. We have further plans to update the Guardian Apex Talent in a future patch to give us more flexibility 
                          with it and alleviate some of the current pain points for Druids.
                • Hunter
                    > Marksmanship
                        + Corrected an issue where Explosive Shot applied from the Salvo talent did not properly grant Lock and Load from 
                          the Shrapnel Shot talent when applied.
                • Paladin
                    > Protection
                        + Developers’ notes: With these changes, we’re aiming to improve baseline durability for Protection Paladins by 
                          increasing passive effects which contribute to effective health. We’re also addressing on-demand survivability 
                          with adjustments to defensive cooldown coverage and strength.
                ...
                • Warrior
                    > Protection
                        + Developers’ notes: Protection melee damage mitigation is quite strong, but is a bit behind for magical attacks and
                          damage-over-time effects. These changes are aimed at strengthening those areas as well as making it easier to 
                          maintain healthy Ignore Pain values.
            ...
            Housing
                • Players who purchased the Roofus bundle can now buy additional copies of the decor in that bundle from promotional decor 
                  resupply vendors in Stormwind (Tuuran), Orgrimmar (Gabbi), and Silvermoon City (Dennia Silvertongue).
            ...
            Prey
                • Removed the once per week restriction on Preferential Killing which generates a hunt with custom parameters. Players may 
                  complete Custom Hunts as often as desired after reaching rank 10 in the Season 1 Prey Journey, but subsequent Custom Hunts
                  in a week give reduced rewards.
                • Increased Prey hunt progress gained from completing World Quests, defeating Ambushes, delivering Ripostes, and interacting
                  with Remnants of Anguish.
            ...
            Player versus Player
                • Significantly increased rating gains from completing 2v2, 3v3, and Solo Shuffle matches.
                    > Developers' notes: This adjustment is intended to meaningfully improve progression as the season continues to support 
                      healthier ladder movement. We'll continue to monitor rating distribution and make further adjustments if needed.
        ...
        May 5, 2026
            ...
            Classes
                • Death Knight
                    ...
                    > Unholy
                        + Developers’ notes: Unholy Death Knight is performing better than intended after recent bugfixes and 
                          the 12.0.5 changes.
                ...
                • Druid
                    > Guardian
                        + Wild Guardian now clears when entering Arena and Battlegrounds, and when starting a Mythic+ dungeon or a 
                          raid encounter.
                            - Developers’ notes: Guardian Druids have continued to overperform in single target contexts, while experiencing
                              difficulties with threat and sustained damage outside of cooldowns. With these changes, we’re aiming to reduce
                              burst potential and transfer some of that power into more reliable and consistent abilities to aid in 
                              generating and maintaining threat.
                ...
                • Evoker
                    > Augmentation
                        ...
                        + Fixed an issue where Inferno’s Blessing damage was not properly modified by the specialization baseline passive. 
                          Inferno’s Blessing’s spell damage coefficient has been adjusted to compensate, so its effective damage will only 
                          be changed per the above adjustment.
                        + Scalecommander: Fixed an issue where Bombardment damage was not properly modified by the specialization’s baseline
                          passives. Bombardment’s damage calculations have been adjusted to compensate.
                            - Developers’ notes: Effective damage will be unchanged for Devastation and only reduced by 5% for Augmentation 
                              with the above adjustment.
                • Hunter
                    > Pack Leader: Corrected an issue where Howl of the Pack Leader would not summon a Boar or a Bear if the Kill Command 
                      that would summon the Boar or Bear killed your target.
                    > Pack Leader: Corrected an issue where the Pack Leader Boar's charge would not grant any of the Hogstrider damage 
                      bonuses or deal area damage if your Boar's primary target died before the Boar reached it.
                    > Beast Mastery
                        + All damage dealt by you and your pets increased by 4%. Does not apply to PvP combat.
                        + Corrected an issue where the Piercing Fangs talent did not apply a critical damage bonus to the bonus pet summoned
                          from Nature's Ally.
                    > Marksmanship
                ...
                • Mage
                    > Frost
                        + Shatter damage to the primary target reduced by 6%.
                            - Developers’ notes: Bug fixes last week to Hand of Frost and Flurry provided a meaningful damage increase to 
                              Frost. This change is primarily intended to offset the boost from those fixes.
                • Monk
                    > Brewmaster
                ...
                • Priest
                    > Discipline
                        + Developers’ notes: Our goal here is to slightly rein in Atonement’s healing contribution in raid environments 
                          while keeping its effectiveness in smaller group content.
                        ...
                        + Atonement healing now decays more rapidly beyond 5 targets.
                            - Developers’ notes: For example, when healing 20 injured allies with Atonement, it would previously be reduced 
                              by 50%. With the new scaling, it will be reduced by 60%.
                    > Holy
                ...
                • Rogue
                    > Outlaw
                        ...
                        + Trickster: Additional stacks of Fazed granted by Cloud Cover no longer increase the magnitude of secondary 
                          effects, such as the damage reduction from the Smoke talent.
                    > Subtlety
                ...
                • Shaman
                    > Enhancement
                        + Developers’ notes: Enhancement Shaman has been underperforming in both Raid and M+ content. With these changes, 
                          we’re aiming to increase throughput and help Stormbringer catch up to Totemic. We’re also resolving a bug, which 
                          would have a negative impact on performance, so we’re watching the results carefully.
                        + All ability damage increased by 5%.
                        + Auto attack damage increased by 10%.
                        + Resolved an issue causing Thorim’s Invocation to cast Lightning Bolt, Chain Lightning and Tempest at with more 
                          effectiveness than intended when cast below 10 Maelstrom Weapon.
                ...
                • Warrior
                    > Developers’ notes: These tuning changes are aimed at improving Warrior performance overall as well as compensating for
                      damage lost due to the Deep Wounds bug fix last week. We will continue to monitor Warrior performance and make further
            ...
            Dungeons and Raids
                ...
                • March on Quel’Danas
                    ...
                    > Midnight Falls
                        ...
                        + Developers’ notes: The following adjustments are aimed at reducing difficulty for smaller groups, with the 
                          greatest reductions applying to 10-player groups. These affect Raid Finder, Normal, and Heroic difficulties.
            ...
            Player versus Player
                • Developers’ notes: The pace of PvP combat is a little too fast right now, resulting in quick kills from burst damage. 
                  We’re increasing player health in PvP combat to slow this down slightly and give players more time to react.
                ...
                • Druid
                    > Balance
                        + Developers’ notes: Overall, Balance Druid is performing reasonably well, with the notable exception of Starsurge 
                          feeling underwhelming. We’re increasing Starsurge damage to give Balance more opportunities to contribute 
                          single-target burst.
                ...
                • Hunter
                    ...
                    > Marksmanship
                        + Developers’ notes: We reduced Marksmanship damage in a recent hotfix, but those changes were too aggressive. 
                          We’re pulling back on some of the reductions to Black Arrow and overall damage to bring Marksmanship back up to a 
                          reasonable spot.
                        + Black Arrow damage increased by 11% in PvP combat.
                        + All damage increased by 5% in PvP combat.
                • Mage
                    > Arcane
                        + Developers’ notes: Arcane is behind the other Mage specializations, so we’re increasing the damage of some of 
                          their core spells. These are the more difficult spells to fully channel, so we’d like them to feel more rewarding 
                    ...
                    > Fire
                        + Developers’ notes: Fire, particularly Sunfury, is able to deal significant burst during their Combustion windows. 
                          We’d like to reduce that with that caveat that casting Fireball should still feel rewarding.
                        + Pyroblast damage reduced by 6% in PvP combat.
                        + Fireball damage increased by 80% in PvP combat.
                        + Sunfury: Codex of the Sunstriders now increases spell damage during Combustion by 1% for each Spellfire Sphere 
                          consumed in PvP combat (was 2%).
                    > Frost
                ...
                • Paladin
                    ...
                    > Protection
                        + Templar: Divine Exaction now causes Divine Toll to cast 2 additional times at 75% effectiveness in PvP 
                          combat (was 150%).
                • Priest
                    > Shadow
                        + Developers’ notes: Shadow’s consistent damage over time is quite effective, but their single target spells are 
                          lower than intended. We’re increasing Shadow Word: Madness and Mind Blast damage to help them contribute single 
                ...
                • Rogue
                    > Outlaw
                        + Developers’ notes: Outlaw’s damage ended up being quite high after recent adjustments, particularly 
                          Between the Eyes with patch 12.0.5. We’re reducing that along with some reductions to Cloud Cover for both PvE 
                          and PvP.
        ...
        April 30, 2026
            ...
            Classes
                • Shaman
                    > Corrected an issue where the Jet Stream talent would not remove snare effects from allies who enter your 
                      Wind Rush Totem's area.
                    > Restoration
                        + Corrected an issue where the initial healing from dropping a Stormstream Totem was not affected by 
                          Mastery: Deep Healing.
                        + Farseer: Corrected an issue where summoned Ancestors would not cast Chain Heal when dropping Stormstream Totem.
                        + Totemic: Corrected an issue where the effects of the Tidecaller's Guard shield imbuement would be lost upon dying 
                          and resurrecting.
            ...
            Items
                • Fixed a bug preventing players from purchasing the Cache of Void-Touched Weapons before unlocking the 
                  Void-Touched Sunfury Poleaxe from any item.
        ...
        April 24, 2026
            ...
            Achievements
                • Midnight Keystone Myth - Season One is now available to players who attained a Mythic+ Rating of at least 3400 during 
                  Midnight Season 1.
                ...
                • Death Knight
                    > Unholy
                        + Festering Scythe is now an aura on the player, resolving issues that occur when extending the duration of plagues.
                            - Developers’ notes: The underlying issue here was proving to be problematic for a number of reasons and we felt 
                        ...
                        + Disease Cloud is now cast by the Abomination, resolving issues such as it not interacting with pet 
                          scaling talents.
                • Demon Hunter
                    > Devourer
                        + Fixed an issue causing the Single-Button Assistant and Assisted Highlight to not recommend Collapsing Star outside
                          of melee range.
                    > Vengeance
                        + Fixed an issue that caused Metamorphosis to be put on cooldown when Last Resort's effect triggered.
                • Hunter
                    > Marksmanship
                        + Corrected an issue where Unbreakable Bond could give the damage reduction effect to the hunter rather than 
                          their pet.
                • Mage
                    > Frost
                        + Fixed an issue causing Hand of Frost (Rank 2) to not provide the correct percent chance increase per stack 
                          of Shatter.
                • Paladin
                    > Holy
            ...
            Housing
                • Decorative Dornogal Opals (small, medium and large) are now available for purchase from the Disguised Decor Duel Vendor 
                  in Silvermoon.
            ...
            Player versus Player
                • Hunter
                    > Marksmanship
                        ...
                        + All damage reduced by 10% in PvP combat.
                            - Developers’ notes: Several talent changes in 12.0.5 led to Marksmanship overperforming in PvP. These updates 
                              target changes to Black Arrow and their overall damage to account for the new interactions and reduce their 
                              effectiveness at both burst damage and overall pressure.
                • Mage
            ...
            Quests
                ...
                • Fixed an issue causing players to be unable to turn in Nebulous Voidcores to Decimus while on the quest 
