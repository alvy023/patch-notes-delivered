    ...
    PatchNotesDelivered_Text = {
        ...
        gameChangesHotfixes = [[
            ...
            May 9, 2025
                ...
                Dungeons and Raids
                    • Liberation of Undermine
                        - Lentil Sprocket now sends players to a slightly different location for the X-Treme transit One Armed Bandit shortcut
                          within the Gallagio.
            ...
            May 8, 2025
                ...
                Dungeons and Raids
                    • Liberation of Undermine
                        > Mug’zee
                            - Fixed an issue where placing Hot Mess on the stairs of the encounter would cause it to sometimes not reach the
                              arena floor.
            ...
            May 6, 2025
                ...
                Classes
                    • Demon Hunter
                        ...
                        > Havoc
                            - Fixed an issue that prevented A Fire Inside from dynamically updating the damage bonus granted to Immolation Aura
                              based on your current Mastery amount, like when activating a trinket that increases Mastery.
                    • Druid
                        > Guardian
                    ...
                    • Monk
                        ...
                        - Fixed an issue that caused physical damage modifiers to reduce the healing magical damage transfers through Ancient
                          Teachings.
                        - Fixed an issue that caused Aspect of Harmony to not apply to targets with a healing absorb present.
                        - Fixed an issue that caused Unity Within to not automatically trigger if no enemy targets are present when the channel
                          ends for Windwalker Monks.
                    • Paladin
                        > Protection
                ...
                Items
                    - When casting Reins of Anu'relos you will now be awarded the bonus items if you need them. If you have the item in your
                      inventory or already have the tracking quest completed, you will not be given that matching item. Each item is checked
                      separately.
            ...
            May 5, 2025
                ...
                Player versus Player
                    • Shaman
                        > Elemental
                            - Fixed an issue that caused Storm Conduit to not grant its interrupt protection or cooldown reduction on Tempest
                              casts.
            ...
            May 2, 2025
                ...
                Nightfall Event
                    - Increased all Flame’s Radiance reputation gains by 100%, including first time completion, Quest, and Weekly Quest
                      reputation rewards.
                    - Nightfall Item vendors now offer all Arathi Abbot’s, Arathi Cleric’s, Arathi Crusader’s, and Arathi Zealot’s weapons and
                      shields.

                Transmogrification
                    - Fixed an issue where the Mythic and Elite variants of the Shaman Liberation of Undermine class set gloves were missing
                      additional lightning visual effects.
            ...
            April 30, 2025
                ...
                Classes
                    • Priest
                        > Discipline
                            - Resolved an issue causing the Cooldown Manager to track the duration of Power Word: Shield on the Priest instead
                              of tracking its cooldown.
                        > Holy
                            - Fixed an issue causing Prayer of Healing to be able to be displayed on the Cooldown Manager when not talented.
                    • Rogue
                        - Trickster: Fixed an issue that prevented Blade Flurry and Nimble Flurry from dealing increased damage to targets with
                          the Fazed debuff applied.
                        > Assassination
                            - Kingsbane can no longer be parried.
                        > Outlaw
                            - Fixed an issue that could cause Blade Flurry to strike below the maximum number of available targets when fighting
                              near dead enemies.
                        ...
                        > Subtlety
                            - Trickster: Fixed an issue that could cause Nimble Flurry to strike below the maximum number of available targets
                              when fighting near dead enemies.
                    • Shaman
                        > Restoration
                            - Fixed an issue causing damage from Acid Rain to not generate threat or aggro enemies.
                    • Warlock
                        - Hellcaller: Fixed an issue where Blackened Soul would not generate a stack if two Soul Shard spenders were cast in
                          quick succession.
                ...
                Quests
                    - Resolved an issue preventing looting the quest object after another player looted it first in "Preserve the Legacy" from
                      the Fate of the Kirin Tor questline.
        ]],
        ...
        gameChangesPatch = [[
            THE WINDS OF MYSTERIOUS FORTUNE ARE IN YOUR FAVOR
                ...
                - This buff will also provide +200% major faction renown in Dragonflight zones and +100% select major faction renown in The War
                  Within zones.
                ...
                *Undermine factions are excluded from benefitting from this buff.
                ...
                - During this period, players below level 80 will also have a chance to gain Mysterious Satchels while looting creatures or as
                  a bonus reward from quests. These satchels contain a variety of fun and useful items that can grant temporary stat boosts or
                  visual alterations. These satchels can sometimes also include bonus gear appropriate to your level and specialization, and 2
                  hour 10% experience potions that stack with the 20% experience buff to a maximum of 30%.
                - Experience potions are a Warband-bound item and can be consumed during the event or saved until after the event is over to be
                  used on characters from level 10-79. Any stat potion effects or elemental potion effects will not work in Mythic+, Raids or
                  rated PvP content.

            DEFEND THE ARATHI IN THE NIGHTFALL SCENARIO

                - Players will take up arms beside a new faction, Flame’s Radiance, to defend the Arathi against the Sureki forces following
                  the defeat of Queen Ansurek. This faction consists of volunteer militia led veterans Thaed Pyremaker and Mylton Wyldbraun.
                  As you rise through the ranks, you will earn up to ten levels of Renown and unlock new rewards.
                - Alongside the Flame’s Radiance, players will be split between task forces within the Nightfall public scenario to clear the
                  battlefield and push back the Sureki. You’ll also be able to strike back against Sureki forces throughout Hallowfall and
                  Azj-Kahet to continue to earn Renown and rewards with additional quests and activities available between the scenarios.
                - Players can expect a variety of rewards for taking part in the scenario and quests including— new armor sets, a tabard that
                  will update visually as you progress through the ranks of the Flame’s Radiance, weapons, a new color variation of the
                  Delver’s Dirigible, and more. As your rank increases, you can also expect to earn buffs which will help you become stronger
                  while in Hallowfall and Azj-Kahet.
            ...
            NEW COOLDOWN MANAGER
                ...
                - Players can enable a new Cooldown Manager within their UI by opening the Game Menu (Escape), selecting Options, then opening
                  Advanced Options to see the new feature Enable Cooldown Manager: Toggle on to view important cooldowns and buffs in separate
                  customizable HUD elements for the selected specialization.
                - Cooldown abilities will show up automatically in the center of our screen and include a visual countdown of when your ability
                  is available to use again.
                - To customize the Cooldown Manager, open the Game Menu (Escape), select the Edit Mode to access the HUD Edit Mode, then select
                  Advanced Options. You can select “Cooldown Manager” from the options then adjust the Utility Cooldown Options bar, Essential
                  Cooldowns bar, Tracked Buffs bar, and Tracked Bars by clicking on them and adjusting their visual elements to your preference.

            HORRIFIC VISIONS REVISITED - Week of May 20

                - Return to N’Zoth’s corrupted versions of Stormwind and Orgrimmar, complete objectives, and take on the challenges within. As
                  you make your way through these encounters, you’ll need to maintain your sanity or ultimately fail.
                - You will be able to go it alone or create a party of allies to join you. Players who want to experience Horrific Visions
                  alone or need an additional helping hand in their party will also be able to invite a Construct of Soridormi companion to join
                  them. This follower will be able to Tank, DPS, or Heal and will not be affected by sanity.
                - For players looking for a bigger challenge, you’ll be able to activate higher difficulties of play for additional gear up to
                  Heroic difficulty items. Horrific Vision Masks are also returning including: Mask of Pain, Mask of Dark Imagination, Mask of
                  the Long Night, Mask of the Burned Bridge, and Mask of the Daredevil. Three additional new masks, Mask of Vengeance, Mask of
                  Multitudes, and the Mask of the Nemesis will also be available to discover and conquer!
                - A new currency to collect becomes available to spend at the vendor for new and previous rewards—Displaced Corrupted Mementos.
                  Players will be able to earn new and returning rewards in Horrific Visions such as mounts, toys, transmogs, weapon
            ...
            DASTARDLY DUOS - Week of June 3
                ...
                - Later in the patch cycle, players will be able to experience a new six-week event providing a variety of cosmetics, toys, and
                  even some dungeon items based on the bosses you encounter.
                - Vinnie Sweets, showrunner, and announcer, is promoting Dastardly Duos where players can step up to take on ‘animatronic’
                  versions of past bosses, gain powerups, and strive for higher and higher scores for bragging rights. You and your party will
                  fight two (or more) bosses at a time to rack up your highest score.
                - There will be three hubs for Dastardly Duos that players can visit. One in Stormwind, one in Orgrimmar, and one in Dornogal.
                  While Vinnie Sweets is running the show, you’ll need to speak with Xyggie Marou to queue for the fight in the Dastardly Dome.
                  A visit with Wodin, the Troll-Servant vendor, will also get you access over the weeks to some additional powerups or items
                  that can help you in the fight.
                - In week one, there will be four bosses available to fight and each week thereafter additional bosses will be added up to a
                  total of ten total bosses to face.
                - Earning specific achievements will also provide additional game effects from them within the Dastardly Duo.
                - Earn points for kills, damage done, and much more. Rack up a high score with your party for bragging rights and see how far
                  you can go!
            ...
            Reputation and Renown
                - Increased the reputation gains for Bilgewater Cartel, Blackwater Cartel, Steamwheedle Cartel, and the Venture Company from
                  rares, side gigs, weekly quests, and world quests by 100%.
                - The following reputations from Shadowlands have been converted to be warband-wide: The Ascended, The Undying Army, The Wild
                  Hunt, Court of Night, Court of Harvesters, The Avowed, Death's Advance, The Archivists' Codex, The Enlightened, Ve'nari.

            User Interface and Accessibility
                - Guilds can now be renamed with gold at the Guild Master NPCs in major cities.
                - Shopping cart functionality has been added to the Trading Post, allowing players to add multiple items into their shopping
                  cart before confirming a purchase.
